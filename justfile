...
# Generate extract's TypeSpec SQLite schema and Rust rows with sibling hafley-tsp.
gen:
    bash "{{repo}}/v6/tools/run-capped.sh" 60 node "{{repo}}/schema/2_gen.mjs"

# Check generated bytes, existing Rust field parity, SQLite DDL, and Rust compilation.
gen-check:
    bash "{{repo}}/v6/tools/run-capped.sh" 120 node --test "{{repo}}/schema/2_gen.test.mjs"
