...
Every program in `examples/`, with its first-line summary. Generated by examples/gen-reference.dl (scan + match_line over the corpus). Do not hand-edit.
...
| [`trace-diag-demo/trace-diag.dl`](../../examples/trace-diag-demo/trace-diag.dl) | examples/trace-diag-demo/trace-diag.dl |
