...
| `jsonp` | source | `jsonp(path, rev, "a.*.b", out)` | dotted path over json/yaml/toml (* = any key/element); the value is located; the string form of json | `dl examples --show flow-services.dl` |
