...
## 86. A defaulted read became one clause per presence combination
...
- **Entry**: `page_response` is 1 clause, 13 arms, and 10,110 bytes of insert SQL. Its three release `level_insert` readings were 1,427, 1,336, and 1,240 us over 5 calls, or 285, 267, and 248 us per call. Fold statements were 7,366 in all three count runs; release walls were 206,213, 197,657, and 201,435 us. The historical 7,113 statement and 152 ms targets were not reached on the merged transaction and recount runtime. `ghcache_ticklog_base.txt` stayed byte-identical. Generated TypeScript moved only for `coalesce_default_returns_when_source_retracts`, `coalesce_defaults_the_absent_row`, `coalesce_over_derived_source`, and `module_path_in_coalesce_wrapper`; the EDGE fixture stayed byte-identical. Three final runs each: conformance 445/0, plunit 1,084/0, RUST-GRADE 445 with 341 byte-clean, cargo 170/0, ghcache 14 ticks with `pr_transition_open_merged=1`, Rust goldens 6, ARCH 7/0.
