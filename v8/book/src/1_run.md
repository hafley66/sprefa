...
`v8/README.md:3-5`: the filesystem is the pipe and each `src/_<n>_name/` folder is one operator; the verbs `read` to `reify` run one folder each (`src/bin/dl8.rs:138-144`).
...
```dl7
; fixture: v8/fixtures/reconcile/0_timer.dl7
