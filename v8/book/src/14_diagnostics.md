...
|---|---|---|---|---|
| `0_unresolved_name.dl7` | `unresolved_name` | `oracle/check/cases/0_unresolved_name.dl7:2` | `src/_3_check/_2_resolve.rs:119` | `1_checker.pl:585` |
| `1_unsafe_head_var.dl7` | `unsafe_head_var` | `oracle/check/cases/1_unsafe_head_var.dl7:7-8` | `src/_3_check/_4_mode.rs:353` | `1_checker.pl:1070` |
| `2_unbound_negative.dl7` | `unbound_negative_goal` | `oracle/check/cases/2_unbound_negative.dl7:8` | `src/_3_check/_4_mode.rs:245-254` | `1_checker.pl:910, :918` |
| `3_negative_cons.dl7` | `negative_constructive_kernel_goal` | `oracle/check/cases/3_negative_cons.dl7:5` | `src/_3_check/_4_mode.rs:237` | `1_checker.pl:897` |
| `4_under_cons.dl7` | `underconstrained_kernel_goal` | `oracle/check/cases/4_under_cons.dl7:5` | `src/_3_check/_4_mode.rs:196` | `1_checker.pl:861` |
| `5_under_edge_ref.dl7` | `underconstrained_kernel_goal` | `oracle/check/cases/5_under_edge_ref.dl7:5` | `src/_3_check/_4_mode.rs:206` | `1_checker.pl:873` |
| `6_under_intern.dl7` | `underconstrained_kernel_goal` | `oracle/check/cases/6_under_intern.dl7:5` | `src/_3_check/_4_mode.rs:216` | `1_checker.pl:885` |
| `7_under_int_lt.dl7` | `underconstrained_kernel_goal` | `oracle/check/cases/7_under_int_lt.dl7:5` | `src/_3_check/_4_mode.rs:185` | `1_checker.pl:849` |
| `8_int_type_mismatch.dl7` | `kernel_argument_type_mismatch` | `oracle/check/cases/8_int_type_mismatch.dl7:9` | `src/_3_check/_4_mode.rs:144-153` | `1_checker.pl:927` |
...
| `undeclared_relation` | `src/_2_lower/_8_express.rs:171`, `:185` | [Macros](8_macros.md) |
| `expansion_cycle`, `expansion_round_limit` | `src/_1_macrotime/_4_expand.rs:161-177` | [Macros](8_macros.md) |
| `expression_arity_mismatch` | `src/_2_lower/_8_express.rs:370` | [Modules and application](9_modules.md) |
| `source_refreeze_limit_exhausted` | `src/_4_comptime/_5_finish.rs:111` | [Modules and application](9_modules.md) |
| `aggregate_outside_rule_head`, `invalid_fold_arity`, `fold_seed_not_ground` | `src/_2_lower/_8_express.rs:604-624` | [Aggregates and fold](7_aggregate.md) |
...
| `emit_sqlite_unsupported` | `src/_5_reify/_7_sqlite.rs:210-252` | [The SQLite emitter](13_sqlite.md) |

## Why

The checker is the port of v7 `1_checker.pl` (`v8/README.md:12`); each case was authored to reach one throw site, recorded in `oracle/check/status.json` `diagnostic_reasons.covered_by_authored_case`.
...
```dl7
; fixture: v8/oracle/check/cases/0_unresolved_name.dl7
...
```dl7
; fixture: v8/oracle/check/cases/1_unsafe_head_var.dl7
...
```dl7
; fixture: v8/oracle/check/cases/2_unbound_negative.dl7
...
```dl7
; fixture: v8/oracle/check/cases/3_negative_cons.dl7
...
```dl7
; fixture: v8/oracle/check/cases/4_under_cons.dl7
...
```dl7
; fixture: v8/oracle/check/cases/5_under_edge_ref.dl7
; diagnostic: underconstrained_kernel_goal
(: reader
   (* (: seen type)))
...
```dl7
; fixture: v8/oracle/check/cases/6_under_intern.dl7
; diagnostic: underconstrained_kernel_goal
(: reader
   (* (: seen type)))
...
```dl7
; fixture: v8/oracle/check/cases/7_under_int_lt.dl7
; diagnostic: underconstrained_kernel_goal
(: reader
   (* (: seen int)))
...
diagnostic diagnostic(check, none, underconstrained_kernel_goal(int_lt, [[0 1]]))
exit 1
```
...
```dl7
; fixture: v8/oracle/check/cases/10_aggregate_cycle.dl7
