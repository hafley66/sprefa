...
```dl7
; fixture: v8/fixtures/store/0_round_trip.dl7
...
```dl7
; fixture: v8/oracle/compile/sources/test/fixtures/16_interned_storage.dl7:40-47
...
[[":",590],["module",2],["nil",1],["node",158],["product",153],["sum",1]]
```

A field type nobody declared:

```dl7
; fixture: v8/oracle/compile/sources/test/fixtures/lexical_binding/2_missing_name.dl7
