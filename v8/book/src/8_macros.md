...
`v8/README.md:18-20`: `prelude/` and `macrotime/` are byte copies of `v7/prelude` and `v7/macrotime` at `f5018ad23`, so nothing under `v7/` is read at runtime.
...
```dl7
; fixture: v8/oracle/compile/sources/test/fixtures/15_standard_plus.dl7
(: Action
   (* (: value int)))
...
```dl7
; fixture: v8/macrotime/0_standard.dl7:68-102
...
```dl7
; fixture: v8/oracle/macrotime/expansion_cases.dl7
