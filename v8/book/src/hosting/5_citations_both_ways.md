...
(DanglingCite "hosting/0_the_seam.md" "v8/src/_9_runtime/_2_reconcile.rs" 9999)
(UnpagedTag "v8/src/_9_runtime/_3_executors/mod.rs" 44 "hosting/9_missing.md")
exit 0
```
...
|---|---|---|---|
| `source_line` | a file's line count per path | `extract` rows carry spans (`hafley-rs/crates/sprefa-extract/src/types.rs:357-364` `DocFact.owner: Span`) | no relation of line counts; `extract` payload is one text term (`v8/README.md:128`) |
