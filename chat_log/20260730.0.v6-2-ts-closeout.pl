...
verification(phase5_ingest_binary,
             passed(typecheck(1),
                    ...
                    explicit_skip(1),
                    release_records(82))).
verification(extraction_host_batching,
             passed(plunit(168),
                    lab(9),
                    runtime(4),
                    typecheck(1),
                    extraction_ticks(3),
                    response_statements(59),
                    callgraph_files(13),
                    callgraph_unclassified(0),
                    served_pass(7),
                    served_known_removed_surface_failure(1))).
verification(flow_parity_advance,
             passed(direct_total(2457),
                    direct_matched(2457),
                    node_type_v6(58),
                    node_type_matched(33),
                    param_type_matched(35),
                    flow_edge_v5(2772),
                    flow_edge_v6(3114),
                    flow_edge_matched(2654),
                    v5_only(118))).
blocker(flow_call_target_resolution,
        counts(v5_targets(200), v6_targets(168), matched(113), v5_only(87), v6_only(55))).
