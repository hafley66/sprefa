...
kernel_slot_label(Name, 0, left) :- integer_comparison(Name).
kernel_slot_label(Name, 1, right) :- integer_comparison(Name).
...
kernel_relation(Name, 2) :- integer_comparison(Name).
