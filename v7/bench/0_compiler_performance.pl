...
%
%   2_partial      traced (DL7_TRACE=collect) structural profile:
...
run_self_check(Mode) :-
    ...
    report_begin(
        '7_nearest_shadow.dl7(self-check)',
        'v7-compiler-perf/nearest-shadow-int-comparisons@2026-09-10', off),
...
fixture_profile(Path,
    ...
    !,
    Baseline = 'v7-compiler-perf/nearest-shadow-int-comparisons@2026-09-10',
