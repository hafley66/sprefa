...
dl8 is the `.dl7` language compiled and run by one Rust binary, `src/bin/dl8.rs`.
...
The org watcher in `fixtures/hosts/org.dl7` is the smallest program with the shape in the What diagram; [Demos](15_demos.md) runs it.
...
| the Rust port and its phases | `plans/v8/2026-09-13-v8-tour.md` section 1, `README.md` first table | `sed -n 7,16p README.md` |
