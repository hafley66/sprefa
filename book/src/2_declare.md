...
The primitive names are `int float bool str any type` (`src/_3_check/_5_kernel.rs:56-58`); `tsi.string` is a product of `@std/tsi`, `(: string (* ))` (`std/tsi.dl7:6`).
...
[[":",590],["module",2],["nil",1],["node",143],["product",138],["sum",1]]
```
...
| six primitive names | `src/_3_check/_5_kernel.rs:56-58` | `grep -n primitive_name src/_3_check/_5_kernel.rs` |
