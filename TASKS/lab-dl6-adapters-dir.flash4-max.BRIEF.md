# lab-dl6-adapters-dir (pass 1 of 2; a coordinator design review follows)

You are lane `lab-dl6-adapters-dir`. Coordinator is `sprefa-coordinator`.
Base sha 9e4b468157bb2a189960b8ec69daad10af372862. Branch `lab/dl6-adapters-dir`.
...
1. after the test fails pre-fix: `boop beep hail sprefa-coordinator --from lab-dl6-adapters-dir --body "pre-fix red: <error line>"`
