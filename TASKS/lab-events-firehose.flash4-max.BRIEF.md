# lab-events-firehose (pass 1 of 2; a coordinator design review follows)

You are lane `lab-events-firehose`. Coordinator is `sprefa-coordinator`.
Base sha 9e4b468157bb2a189960b8ec69daad10af372862. Branch `lab/events-firehose`.
...
1. after the arm compiles: `boop beep hail sprefa-coordinator --from lab-events-firehose --body "compiles: arm shape <one line>"`
