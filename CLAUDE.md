...
- [ ] **measures verdicts open**: docs/arch-measures-review.md — keep/kill per measure (blast top-10 duplicates fan_in on both corpora), std/measures.dl with top-K views, `dl q` verb wiring.
