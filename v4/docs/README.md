...
7. [V4 Rule Query Semantics](./v4-rule-query-semantics.md)
8. [V4 SQL Rule Query Plan](./v4-sql-rule-query-plan.md)
9. [V4 Terse Relational Query Sessions](./v4-terse-relational-query-sessions.md)
10. [V4 Durable Mounted Query Plan](./v4-durable-mounted-query-plan.md)
11. [V4 Effect Output Retraction Plan](./v4-effect-output-retraction-plan.md)
12. [V4 Runtime Batching](./v4-runtime-batching.md)
13. [V4 Primitive Examples Plan](./v4-primitive-examples-plan.md)
14. [V4 V3 Parity Gaps](./v4-v3-parity-gaps.md)
15. [V4 Next Slices](./v4-next-slices.md)
