...
## Size labels route to lane presets (user-set 2026-08-15)

| label | preset | harness |
|---|---|---|
| size:small | flash4 | boop opencode lane |
| size:med | pro4 | boop opencode lane |
| size:large | opus | native worktree agent, coordinator-reviewed |
