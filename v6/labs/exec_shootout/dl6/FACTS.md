...
Node v24.15.0 · darwin/arm64 · 2026-08-06T18:12:20.979Z

## Contract numbers

| case | edges | derived | checksum | load ms | fixpoint ms | rows/sec | peak RSS |
|---|---|---|---|---|---|---|---|
| `grid_10000` | 3,960 | 1,069,200 | `9d7239568960d6a8` | 23 | 2853 | 374,763 | 725 MB |
...
|---|---|---|---|---|
| 2822.7 | 99.2% | 1 | 0 | `BATCH x8: DELETE "__support_next_reachable" \| INSERT "__support_next_reachable" \| UPDATE "reachable" \| INSERT "__delta_reachable" \| DELETE "reachable"` |
| 7.8 | 0.3% | 1 | 0 | `DELETE FROM "__frontier_edge"; INSERT INTO "__frontier_edge" ("_phase", "_sequence", "source", "target") SELECT "_phase", "_sequence", "source", "targ` |
| 7.5 | 0.3% | 1 | 3,960 | `INSERT OR IGNORE INTO "edge" ("source", "target") SELECT json_extract(value, '?'), json_extract(value, '?') FROM json_each(?) RETURNING "source", "tar` |
| 6.8 | 0.2% | 1 | 0 | `BATCH x2: INSERT "__delta_edge" \| INSERT "__frontier_edge"` |
