...
// Specialized calls: [args-atom_arg,args-decl_a_column,args-enum_field,args-expr,args-typed_col(decl_b_column_type(_19608)),args-typed_col(host_col_type(_19594)),sep-atom_arg,sep-decl_a_column,sep-enum_field,sep-expr,sep-int_lit,sep-rel_atom_term,sep-typed_col(decl_b_column_type(_19660)),sep-typed_col(host_col_type(_19646))]
// Unbound args/sep calls: [args-A,sep-A]
// Generated rule bodies: [capture_key,enum_variants,member_access,object_pattern,path]
const PREC = {
  bind: 1,
  compare: 2,
  add: 3,
