...
// Specialized calls: [args-atom_arg,args-decl_a_column,args-enum_field,args-expr,args-typed_col(decl_b_column_type(_20442)),args-typed_col(host_col_type(_20428)),sep-atom_arg,sep-decl_a_column,sep-enum_field,sep-expr,sep-int_lit,sep-rel_atom_term,sep-typed_col(decl_b_column_type(_20494)),sep-typed_col(host_col_type(_20480))]
// Unbound args/sep calls: [args-A,sep-A]
// Generated rule bodies: [bind_declaration,capture_key,declaration_parameter,enum_variants,match_arm,match_statement,member_access,object_pattern,path,relation_modifier]
// Shapes the emitter cannot build: []
const PREC = {
  bind: 1,
  compare: 2,
  add: 3,
