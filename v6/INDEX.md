...
| [prolog/compile/SYNTAX.md](prolog/compile/SYNTAX.md) | 159 | SYNTAX.md -- phase D parser surface (parse_dl.pl / print_dl.pl) |
...
45:## Construct table
84:### Core grammar and input aliases
120:## Round-trip design note (why decl lines are exact, not fallback-merged)
135:## Grades (from `scripts/roundtrip.sh`, regenerate to reproduce)
150:## What `dl_view/*.dl` is
```
