...
| [plans/2026-07-24-v6-dl-mvp-slice.md](plans/2026-07-24-v6-dl-mvp-slice.md) | 608 | v6 dl MVP slice — ast-grep -> diags -> LSP, http-fronted (2026-07-24) |
...
74:## Status ledger
107:## Recon facts (observed, not guessed)
153:## Boundary
172:## Epics
174:### M0 · package scaffold `v6/dl/`
224:### M1 · grammar (Langium) -> ast.ts bridge
313:### M2 · schema + tick runtime
397:### M3 · ingest: extract -> spine -> EDB
445:### M4 · host rels: sh executor + builtin sg + extract
498:### M5 · diag + v5 LSP front
564:### M6 · http front
595:## Frontier (deferred, with the evidence that will resolve each)
```
