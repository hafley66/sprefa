...
| [plans/2026-07-24-v6-dl-mvp-slice.md](plans/2026-07-24-v6-dl-mvp-slice.md) | 530 | v6 dl MVP slice — ast-grep -> diags -> LSP, http-fronted (2026-07-24) |
...
74:## Recon facts (observed, not guessed)
120:## Boundary
139:## Epics
141:### M0 · package scaffold `v6/dl/`
182:### M1 · grammar (Langium) -> ast.ts bridge
255:### M2 · schema + tick runtime
334:### M3 · ingest: extract -> spine -> EDB
382:### M4 · host rels: sh executor + builtin sg + extract
435:### M5 · diag + v5 LSP front
486:### M6 · http front
517:## Frontier (deferred, with the evidence that will resolve each)
```
