# lab-branches-cadence-pro4 (pass 1 of 2; a coordinator design review follows) [pro4 arm: identical brief, second model; suffix every PR title with " (pro4)"]

You are lane `lab-branches-cadence-pro4`. Coordinator is `sprefa-coordinator`.
Base sha 9e4b468157bb2a189960b8ec69daad10af372862. Branch `lab/branches-cadence-pro4`.
...
1. after step 2 resolves (idiom found or STOP): `boop beep hail sprefa-coordinator --from lab-branches-cadence-pro4 --body "optional-key idiom: <what>"`
