# lab-tick-verb-remeasure-pro4 (pass 1 of 2; a coordinator design review follows) [pro4 arm: identical brief, second model; suffix every PR title with " (pro4)"]

You are lane `lab-tick-verb-remeasure-pro4`. Coordinator is `sprefa-coordinator`.
Base sha 9e4b468157bb2a189960b8ec69daad10af372862. Branch `lab/tick-verb-remeasure-pro4`.
...
1. after the first ghcache run: `boop beep hail sprefa-coordinator --from lab-tick-verb-remeasure-pro4 --body "run1 ghcache: stmts=<n> wall=<ms> sqlite=<us>"`
