...
function readSnapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    hook_window: selectRows(seam, `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", "since" FROM "hook_window"`, relColumns.hook_window!),
    lint_count: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count" FROM "lint_count"`, relColumns.lint_count!),
    ratchet: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "allowed" FROM "ratchet"`, relColumns.ratchet!),
    turn_diag: selectRows(seam, `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", CASE WHEN json_valid("path") AND json_type("path") = 'object' THEN json_extract("path", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("path", '$.args')) || ')' ELSE "path" END AS "path", "line", CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "opened_at" FROM "turn_diag"`, relColumns.turn_diag!),
    unratcheted_lint: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count" FROM "unratcheted_lint"`, relColumns.unratcheted_lint!),
    violation: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count", "allowed" FROM "violation"`, relColumns.violation!),
  });
}
