...
export const demandedRels: readonly string[] = ["diag_history/4", "diagnostic/4", "file_line/3", "hook_window/2", "lint_count/2", "ratchet/2", "turn_diag/5", "unratcheted_lint/2", "violation/3"];
...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "lint_count" ("code" TEXT NOT NULL, "count" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("code", "count")) WITHOUT ROWID`,
  `CREATE TABLE "ratchet" ("code" TEXT NOT NULL, "allowed" INTEGER NOT NULL, PRIMARY KEY ("code")) WITHOUT ROWID`,
  `CREATE TABLE "turn_diag" ("turn" TEXT NOT NULL, "path" TEXT NOT NULL, "line" INTEGER NOT NULL, "code" TEXT NOT NULL, "opened_at" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("turn", "path", "line", "code", "opened_at")) WITHOUT ROWID`,
  `CREATE TABLE "unratcheted_lint" ("code" TEXT NOT NULL, "count" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("code", "count")) WITHOUT ROWID`,
  ...
  `CREATE TEMP TABLE "__support_next_turn_diag" ("turn" TEXT NOT NULL, "path" TEXT NOT NULL, "line" INTEGER NOT NULL, "code" TEXT NOT NULL, "opened_at" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("turn", "path", "line", "code", "opened_at")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__support_next_unratcheted_lint" ("code" TEXT NOT NULL, "count" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("code", "count")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__support_next_violation" ("code" TEXT NOT NULL, "count" INTEGER NOT NULL, "allowed" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("code", "count", "allowed")) WITHOUT ROWID`,
...
const boot: readonly IBootStatement[] = [
  ...
  { sql: `DELETE FROM "turn_diag"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "turn_diag" ("turn", "path", "line", "code", "opened_at") SELECT b0."turn", b1."path", b1."line", b1."code", b2."opened_at" FROM "hook_window" b0, "diagnostic" b1, "diag_history" b2 WHERE b2."path" = b1."path" AND b2."line" = b1."line" AND b2."code" = b1."code" AND (b2."opened_at" > b0."since")`, params: [] },
  { sql: `DELETE FROM "lint_count"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "lint_count" ("code", "count") SELECT b0."code", count(*) FROM "diagnostic" b0 GROUP BY b0."code" HAVING count(*) > 0`, params: [] },
  { sql: `DELETE FROM "unratcheted_lint"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "unratcheted_lint" ("code", "count") SELECT b0."code", b0."count" FROM "lint_count" b0 WHERE NOT EXISTS (SELECT 1 FROM "ratchet" n0 WHERE n0."code" = b0."code")`, params: [] },
  { sql: `DELETE FROM "violation"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "violation" ("code", "count", "allowed") SELECT b0."code", b0."count", b1."allowed" FROM "lint_count" b0, "ratchet" b1 WHERE b1."code" = b0."code" AND (b0."count" > b1."allowed")`, params: [] },
];
...
INSERT OR IGNORE INTO "violation" ("code", "count", "allowed") SELECT b0."code", b0."count", b1."allowed" FROM "lint_count" b0, "ratchet" b1 WHERE b1."code" = b0."code" AND (b0."count" > b1."allowed")`, supportSql: [`DELETE FROM "__support_next_violation"`, `INSERT INTO "__support_next_violation" ("code", "count", "allowed", "__support_count") SELECT "code", "count", "allowed", sum("__support_count") FROM (SELECT b0."code" AS "code", b0."count" AS "count", b1."allowed" AS "allowed", count(*) AS "__support_count" FROM "lint_count" b0, "ratchet" b1 WHERE b1."code" = b0."code" AND (b0."count" > b1."allowed") GROUP BY b0."code", b0."count", b1."allowed") GROUP BY "code", "count", "allowed"`, `UPDATE "violation" AS h SET "__support_count" = "__support_count" - ("__support_count" - COALESCE((SELECT n."__support_count" FROM "__support_next_violation" n WHERE n."code" = h."code" AND n."count" = h."count" AND n."allowed" = h."allowed"), 0))`, `DELETE FROM "violation" WHERE "__support_count" <= 0 RETURNING "code", "count", "allowed"`, `INSERT INTO "violation" ("code", "count", "allowed", "__support_count") SELECT "code", "count", "allowed", n."__support_count" FROM "__support_next_violation" n WHERE NOT EXISTS (SELECT 1 FROM "violation" h WHERE n."code" = h."code" AND n."count" = h."count" AND n."allowed" = h."allowed") RETURNING "code", "count", "allowed"`], aggregateSql: null },
];
