...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    hit: select_rows(seam, `SELECT CASE WHEN json_valid("owner") AND json_type("owner") = 'object' AND json_type("owner", '$.fn') = 'text' AND json_type("owner", '$.args') = 'array' THEN json_extract("owner", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("owner", '$.args')), '') || ')' ELSE "owner" END AS "owner", (SELECT d."__rendered" FROM "__ref_span" d WHERE d."__id" = "at") AS "at" FROM "hit"`, rel_columns.hit!, rel_column_types.hit!),
