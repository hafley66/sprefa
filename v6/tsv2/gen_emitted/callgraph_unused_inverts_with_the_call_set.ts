...
INSERT OR IGNORE INTO "def" ("path", "name", "kind") SELECT b0."path", b0."name", b0."kind" FROM "node_fact" b0 WHERE b0."record" = 'node'`, supportSql: [`DELETE FROM "__support_next_def"`, `INSERT INTO "__support_next_def" ("path", "name", "kind", "__refcount") SELECT "path", "name", "kind", sum("__refcount") FROM (SELECT b0."path" AS "path", b0."name" AS "name", b0."kind" AS "kind", count(*) AS "__refcount" FROM "node_fact" b0 WHERE b0."record" = 'node' GROUP BY b0."path", b0."name", b0."kind") GROUP BY "path", "name", "kind"`, `UPDATE "def" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_def" n WHERE n."path" = h."path" AND n."name" = h."name" AND n."kind" = h."kind"), 0))`, `INSERT INTO "__delta_def" ("_sign", "_sequence", "path", "name", "kind") SELECT -1, row_number() OVER () - 1, "path", "name", "kind" FROM "def" WHERE "__refcount" <= 0`, `DELETE FROM "def" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_def" ("_sign", "_sequence", "path", "name", "kind") SELECT 1, row_number() OVER () - 1, n."path", n."name", n."kind" FROM "__support_next_def" n WHERE NOT EXISTS (SELECT 1 FROM "def" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."kind" = h."kind")`, `INSERT INTO "__frontier_def" ("_phase", "_sequence", "path", "name", "kind") SELECT ?, row_number() OVER () - 1, n."path", n."name", n."kind" FROM "__support_next_def" n WHERE NOT EXISTS (SELECT 1 FROM "def" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."kind" = h."kind")`, `INSERT INTO "__next_frontier_def" ("_phase", "_sequence", "path", "name", "kind") SELECT ?, row_number() OVER () - 1, n."path", n."name", n."kind" FROM "__support_next_def" n WHERE NOT EXISTS (SELECT 1 FROM "def" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."kind" = h."kind")`, `INSERT INTO "def" ("path", "name", "kind", "__refcount") SELECT n."path", n."name", n."kind", n."__refcount" FROM "__support_next_def" n WHERE NOT EXISTS (SELECT 1 FROM "def" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."kind" = h."kind")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "unused" ("name") SELECT b0."name" FROM "def" b0 WHERE NOT EXISTS (SELECT 1 FROM "call" n0 WHERE n0."callee" = b0."name")`, supportSql: [`DELETE FROM "__support_next_unused"`, `INSERT INTO "__support_next_unused" ("name", "__refcount") SELECT "name", sum("__refcount") FROM (SELECT b0."name" AS "name", count(*) AS "__refcount" FROM "def" b0 WHERE NOT EXISTS (SELECT 1 FROM "call" n0 WHERE n0."callee" = b0."name") GROUP BY b0."name") GROUP BY "name"`, `UPDATE "unused" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_unused" n WHERE n."name" = h."name"), 0))`, `INSERT INTO "__delta_unused" ("_sign", "_sequence", "name") SELECT -1, row_number() OVER () - 1, "name" FROM "unused" WHERE "__refcount" <= 0`, `DELETE FROM "unused" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_unused" ("_sign", "_sequence", "name") SELECT 1, row_number() OVER () - 1, n."name" FROM "__support_next_unused" n WHERE NOT EXISTS (SELECT 1 FROM "unused" h WHERE n."name" = h."name")`, `INSERT INTO "__frontier_unused" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_unused" n WHERE NOT EXISTS (SELECT 1 FROM "unused" h WHERE n."name" = h."name")`, `INSERT INTO "__next_frontier_unused" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_unused" n WHERE NOT EXISTS (SELECT 1 FROM "unused" h WHERE n."name" = h."name")`, `INSERT INTO "unused" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_unused" n WHERE NOT EXISTS (SELECT 1 FROM "unused" h WHERE n."name" = h."name")`], aggregateSql: null },
];
