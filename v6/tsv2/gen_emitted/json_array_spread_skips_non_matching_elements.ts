...
INSERT OR IGNORE INTO "numbered" ("number") SELECT json_extract(j0.value, '$."number"') FROM "resp" b0, json_each(b0."body") j0 WHERE json_type(b0."body", '$') = 'array' AND j0.type = 'object' AND json_extract(j0.value, '$."number"') IS NOT NULL`, supportSql: [`DELETE FROM "__support_next_numbered"`, `INSERT INTO "__support_next_numbered" ("number", "__refcount") SELECT "number", sum("__refcount") FROM (SELECT json_extract(j0.value, '$."number"') AS "number", count(*) AS "__refcount" FROM "resp" b0, json_each(b0."body") j0 WHERE json_type(b0."body", '$') = 'array' AND j0.type = 'object' AND json_extract(j0.value, '$."number"') IS NOT NULL GROUP BY json_extract(j0.value, '$."number"')) GROUP BY "number"`, `UPDATE "numbered" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_numbered" n WHERE n."number" = h."number"), 0))`, `INSERT INTO "__delta_numbered" ("_sign", "_sequence", "number") SELECT -1, row_number() OVER () - 1, "number" FROM "numbered" WHERE "__refcount" <= 0`, `DELETE FROM "numbered" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_numbered" ("_sign", "_sequence", "number") SELECT 1, row_number() OVER () - 1, n."number" FROM "__support_next_numbered" n WHERE NOT EXISTS (SELECT 1 FROM "numbered" h WHERE n."number" = h."number")`, `INSERT INTO "__frontier_numbered" ("_phase", "_sequence", "number") SELECT ?, row_number() OVER () - 1, n."number" FROM "__support_next_numbered" n WHERE NOT EXISTS (SELECT 1 FROM "numbered" h WHERE n."number" = h."number")`, `INSERT INTO "__next_frontier_numbered" ("_phase", "_sequence", "number") SELECT ?, row_number() OVER () - 1, n."number" FROM "__support_next_numbered" n WHERE NOT EXISTS (SELECT 1 FROM "numbered" h WHERE n."number" = h."number")`, `INSERT INTO "numbered" ("number", "__refcount") SELECT n."number", n."__refcount" FROM "__support_next_numbered" n WHERE NOT EXISTS (SELECT 1 FROM "numbered" h WHERE n."number" = h."number")`], aggregateSql: null },
];
