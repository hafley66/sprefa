...
export const demandedRels: readonly string[] = ["scaled/1", "source/1"];
...
const boot: readonly IBootStatement[] = [
  { sql: `INSERT OR IGNORE INTO "source" ("count") VALUES (?)`, params: [4] },
  { sql: `DELETE FROM "scaled"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "scaled" ("value") SELECT b0."count" FROM "source" b0`, params: [] },
];
