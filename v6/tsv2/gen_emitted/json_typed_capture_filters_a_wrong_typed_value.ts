...
const ddl: readonly string[] = [
  ...
  `CREATE INDEX "__next_frontier_counted_phase" ON "__next_frontier_counted" ("_phase")`,
...
INSERT OR IGNORE INTO "counted" ("repo", "stars") SELECT json_extract(b0."payload", '$."repo"'), json_extract(b0."payload", '$."stars"') FROM "event" b0 WHERE json_type(b0."payload", '$') = 'object' AND json_type(b0."payload", '$."repo"') = 'text' AND json_type(b0."payload", '$."stars"') = 'integer'`, supportSql: [`DELETE FROM "__support_next_counted"`, `INSERT INTO "__support_next_counted" ("repo", "stars", "__refcount") SELECT "repo", "stars", sum("__refcount") FROM (SELECT json_extract(b0."payload", '$."repo"') AS "repo", json_extract(b0."payload", '$."stars"') AS "stars", count(*) AS "__refcount" FROM "event" b0 WHERE json_type(b0."payload", '$') = 'object' AND json_type(b0."payload", '$."repo"') = 'text' AND json_type(b0."payload", '$."stars"') = 'integer' GROUP BY json_extract(b0."payload", '$."repo"'), json_extract(b0."payload", '$."stars"')) GROUP BY "repo", "stars"`, `UPDATE "counted" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_counted" n WHERE n."repo" = h."repo" AND n."stars" = h."stars"), 0))`, `INSERT INTO "__delta_counted" ("_sign", "_sequence", "repo", "stars") SELECT -1, row_number() OVER () - 1, "repo", "stars" FROM "counted" WHERE "__refcount" <= 0`, `DELETE FROM "counted" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_counted" ("_sign", "_sequence", "repo", "stars") SELECT 1, row_number() OVER () - 1, n."repo", n."stars" FROM "__support_next_counted" n WHERE NOT EXISTS (SELECT 1 FROM "counted" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`, `INSERT INTO "__frontier_counted" ("_phase", "_sequence", "repo", "stars") SELECT ?, row_number() OVER () - 1, n."repo", n."stars" FROM "__support_next_counted" n WHERE NOT EXISTS (SELECT 1 FROM "counted" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`, `INSERT INTO "__next_frontier_counted" ("_phase", "_sequence", "repo", "stars") SELECT ?, row_number() OVER () - 1, n."repo", n."stars" FROM "__support_next_counted" n WHERE NOT EXISTS (SELECT 1 FROM "counted" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`, `INSERT INTO "counted" ("repo", "stars", "__refcount") SELECT n."repo", n."stars", n."__refcount" FROM "__support_next_counted" n WHERE NOT EXISTS (SELECT 1 FROM "counted" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`], aggregateSql: null },
];
