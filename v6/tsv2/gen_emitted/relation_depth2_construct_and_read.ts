...
INSERT OR IGNORE INTO "span" ("file", "start", "end") SELECT b1."__id", b0."start", b0."end" FROM "raw" b0, "file" b1, "__ref_repo" b2, "__ref_fpath" b3 WHERE b2."__id" = b1."repo" AND b2."name" = b0."repo_name" AND b3."__id" = b1."at" AND b3."name" = b0."path_name"`, supportSql: [`DELETE FROM "__support_next_span"`, `INSERT INTO "__support_next_span" ("file", "start", "end", "__refcount") SELECT "file", "start", "end", sum("__refcount") FROM (SELECT b1."__id" AS "file", b0."start" AS "start", b0."end" AS "end", count(*) AS "__refcount" FROM "raw" b0, "file" b1, "__ref_repo" b2, "__ref_fpath" b3 WHERE b2."__id" = b1."repo" AND b2."name" = b0."repo_name" AND b3."__id" = b1."at" AND b3."name" = b0."path_name" GROUP BY b1."__id", b0."start", b0."end") GROUP BY "file", "start", "end"`, `UPDATE "span" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_span" n WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end"), 0))`, `INSERT INTO "__delta_span" ("_sign", "_sequence", "file", "start", "end") SELECT -1, row_number() OVER () - 1, "file", "start", "end" FROM "span" WHERE "__refcount" <= 0`, `DELETE FROM "span" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_span" ("_sign", "_sequence", "file", "start", "end") SELECT 1, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__frontier_span" ("_phase", "_sequence", "file", "start", "end") SELECT ?, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__next_frontier_span" ("_phase", "_sequence", "file", "start", "end") SELECT ?, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "span" ("file", "start", "end", "__refcount") SELECT n."file", n."start", n."end", n."__refcount" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`], aggregateSql: null },
  { headRel: "coord", ruleId: "relation_depth2_construct_and_read:coord/3#1", headDeltaTableName: "__delta_coord", headColumns: ["path_name", "start", "end"], insertSql: `INSERT OR IGNORE INTO "coord" ("path_name", "start", "end") SELECT DISTINCT b0."name", d0."start", d0."end" FROM "__frontier_span" d0, "__ref_fpath" b0, "__ref_file" b1 WHERE d0."_phase" >= 0 AND b1."__id" = d0."file" AND b1."at" = b0."__id" RETURNING "path_name", "start", "end"`, selectSql: `SELECT "path_name", "start", "end" FROM "coord"`, recomputeSql: `DELETE FROM "coord";
INSERT OR IGNORE INTO "coord" ("path_name", "start", "end") SELECT b1."name", b0."start", b0."end" FROM "span" b0, "__ref_fpath" b1, "__ref_file" b2 WHERE b2."__id" = b0."file" AND b2."at" = b1."__id"`, supportSql: [`DELETE FROM "__support_next_coord"`, `INSERT INTO "__support_next_coord" ("path_name", "start", "end", "__refcount") SELECT "path_name", "start", "end", sum("__refcount") FROM (SELECT b1."name" AS "path_name", b0."start" AS "start", b0."end" AS "end", count(*) AS "__refcount" FROM "span" b0, "__ref_fpath" b1, "__ref_file" b2 WHERE b2."__id" = b0."file" AND b2."at" = b1."__id" GROUP BY b1."name", b0."start", b0."end") GROUP BY "path_name", "start", "end"`, `UPDATE "coord" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_coord" n WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end"), 0))`, `INSERT INTO "__delta_coord" ("_sign", "_sequence", "path_name", "start", "end") SELECT -1, row_number() OVER () - 1, "path_name", "start", "end" FROM "coord" WHERE "__refcount" <= 0`, `DELETE FROM "coord" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_coord" ("_sign", "_sequence", "path_name", "start", "end") SELECT 1, row_number() OVER () - 1, n."path_name", n."start", n."end" FROM "__support_next_coord" n WHERE NOT EXISTS (SELECT 1 FROM "coord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__frontier_coord" ("_phase", "_sequence", "path_name", "start", "end") SELECT ?, row_number() OVER () - 1, n."path_name", n."start", n."end" FROM "__support_next_coord" n WHERE NOT EXISTS (SELECT 1 FROM "coord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__next_frontier_coord" ("_phase", "_sequence", "path_name", "start", "end") SELECT ?, row_number() OVER () - 1, n."path_name", n."start", n."end" FROM "__support_next_coord" n WHERE NOT EXISTS (SELECT 1 FROM "coord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "coord" ("path_name", "start", "end", "__refcount") SELECT n."path_name", n."start", n."end", n."__refcount" FROM "__support_next_coord" n WHERE NOT EXISTS (SELECT 1 FROM "coord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`], aggregateSql: null },
];
