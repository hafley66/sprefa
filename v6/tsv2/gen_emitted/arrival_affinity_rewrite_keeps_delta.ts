...
const boot: readonly IBootStatement[] = [
  ...
  { sql: `INSERT OR IGNORE INTO "probe_out" ("probe_value") SELECT b0."probe_value" FROM "probe_in" b0`, params: [] },
];
