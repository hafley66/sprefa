...
INSERT OR IGNORE INTO "probe_out" ("probe_value") SELECT b0."probe_value" FROM "probe_in" b0`, supportSql: [`DELETE FROM "__support_next_probe_out"`, `INSERT INTO "__support_next_probe_out" ("probe_value", "__refcount") SELECT "probe_value", sum("__refcount") FROM (SELECT b0."probe_value" AS "probe_value", count(*) AS "__refcount" FROM "probe_in" b0 GROUP BY b0."probe_value") GROUP BY "probe_value"`, `UPDATE "probe_out" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_probe_out" n WHERE n."probe_value" = h."probe_value"), 0))`, `INSERT INTO "__delta_probe_out" ("_sign", "_sequence", "probe_value") SELECT -1, row_number() OVER () - 1, "probe_value" FROM "probe_out" WHERE "__refcount" <= 0`, `DELETE FROM "probe_out" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_probe_out" ("_sign", "_sequence", "probe_value") SELECT 1, row_number() OVER () - 1, n."probe_value" FROM "__support_next_probe_out" n WHERE NOT EXISTS (SELECT 1 FROM "probe_out" h WHERE n."probe_value" = h."probe_value")`, `INSERT INTO "__frontier_probe_out" ("_phase", "_sequence", "probe_value") SELECT ?, row_number() OVER () - 1, n."probe_value" FROM "__support_next_probe_out" n WHERE NOT EXISTS (SELECT 1 FROM "probe_out" h WHERE n."probe_value" = h."probe_value")`, `INSERT INTO "__next_frontier_probe_out" ("_phase", "_sequence", "probe_value") SELECT ?, row_number() OVER () - 1, n."probe_value" FROM "__support_next_probe_out" n WHERE NOT EXISTS (SELECT 1 FROM "probe_out" h WHERE n."probe_value" = h."probe_value")`, `INSERT INTO "probe_out" ("probe_value", "__refcount") SELECT n."probe_value", n."__refcount" FROM "__support_next_probe_out" n WHERE NOT EXISTS (SELECT 1 FROM "probe_out" h WHERE n."probe_value" = h."probe_value")`], aggregateSql: null },
];
