...
INSERT OR IGNORE INTO "fpath" ("name") SELECT b0."path_name" FROM "raw" b0`, supportSql: [`DELETE FROM "__support_next_fpath"`, `INSERT INTO "__support_next_fpath" ("name", "__refcount") SELECT "name", sum("__refcount") FROM (SELECT b0."path_name" AS "name", count(*) AS "__refcount" FROM "raw" b0 GROUP BY b0."path_name") GROUP BY "name"`, `UPDATE "fpath" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_fpath" n WHERE n."name" = h."name"), 0))`, `INSERT INTO "__delta_fpath" ("_sign", "_sequence", "name") SELECT -1, row_number() OVER () - 1, "name" FROM "fpath" WHERE "__refcount" <= 0`, `DELETE FROM "fpath" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_fpath" ("_sign", "_sequence", "name") SELECT 1, row_number() OVER () - 1, n."name" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`, `INSERT INTO "__frontier_fpath" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`, `INSERT INTO "__next_frontier_fpath" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`, `INSERT INTO "fpath" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`], aggregateSql: null },
  { headRel: "repo", ruleId: "relation_depth2_chained_decode:repo/1#1", headDeltaTableName: "__delta_repo", headColumns: ["name"], insertSql: `INSERT OR IGNORE INTO "repo" ("name") SELECT DISTINCT d0."repo_name" FROM "__frontier_raw" d0 WHERE d0."_phase" >= 0 RETURNING "name"`, selectSql: `SELECT "name" FROM "repo"`, recomputeSql: `DELETE FROM "repo";
