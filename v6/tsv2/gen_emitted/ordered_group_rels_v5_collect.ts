...
export const demandedRels: readonly string[] = ["group_rels/2", "rel_catalog/4"];
...
const ddl: readonly string[] = [
  `CREATE TABLE "group_rels" ("group_name" TEXT NOT NULL, "col2" TEXT NOT NULL CHECK (json_valid("col2")), "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("group_name", "col2")) WITHOUT ROWID`,
...
const boot: readonly IBootStatement[] = [
  ...
  { sql: `DELETE FROM "group_rels"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "group_rels" ("group_name", "col2") SELECT b0."group_name", json_group_array(b0."relation_name" ORDER BY b0."relation_name") FROM "rel_catalog" b0 GROUP BY b0."group_name" HAVING count(*) > 0`, params: [] },
];
