...
INSERT OR IGNORE INTO "touched" ("path") SELECT b0."path" FROM "finding" b0`, supportSql: [`DELETE FROM "__support_next_touched"`, `INSERT INTO "__support_next_touched" ("path", "__refcount") SELECT "path", sum("__refcount") FROM (SELECT b0."path" AS "path", count(*) AS "__refcount" FROM "finding" b0 GROUP BY b0."path") GROUP BY "path"`, `UPDATE "touched" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_touched" n WHERE n."path" = h."path"), 0)`, `INSERT INTO "__delta_touched" ("_sign", "_sequence", "path") SELECT -1, row_number() OVER () - 1, "path" FROM "touched" WHERE "__refcount" <= 0`, `DELETE FROM "touched" WHERE "__refcount" <= 0`, `DELETE FROM "__new_touched"`, `INSERT INTO "__new_touched" ("path", "__refcount") SELECT n."path", n."__refcount" FROM "__support_next_touched" n LEFT JOIN "touched" h ON n."path" = h."path" WHERE h."path" IS NULL`, `INSERT INTO "__delta_touched" ("_sign", "_sequence", "path") SELECT 1, "rowid" - 1, "path" FROM "__new_touched"`, `INSERT INTO "__frontier_touched" ("_phase", "_sequence", "path") SELECT ?, "rowid" - 1, "path" FROM "__new_touched"`, `INSERT INTO "__next_frontier_touched" ("_phase", "_sequence", "path") SELECT ?, "rowid" - 1, "path" FROM "__new_touched"`, `INSERT OR IGNORE INTO "touched" ("path", "__refcount") SELECT n."path", n."__refcount" FROM "__support_next_touched" n`], aggregateSql: null },
];
