...
const ddl: readonly string[] = [
  `CREATE TABLE "audit_trail" ("value" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TABLE "audited" ("value" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TABLE "reading" ("sensor" TEXT NOT NULL, "value" INTEGER NOT NULL, PRIMARY KEY ("sensor", "value")) WITHOUT ROWID`,
  `CREATE TABLE "watched" ("sensor" TEXT NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("sensor")) WITHOUT ROWID`,
  ...
  `CREATE TEMP TABLE "__support_next_audited" ("value" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__support_next_audit_trail" ("value" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__support_next_watched" ("sensor" TEXT NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("sensor")) WITHOUT ROWID`,
];
...
INSERT OR IGNORE INTO "audited" ("value") SELECT b0."value" FROM "reading" b0`, supportSql: [`DELETE FROM "__support_next_audited"`, `INSERT INTO "__support_next_audited" ("value", "__support_count") SELECT "value", sum("__support_count") FROM (SELECT b0."value" AS "value", count(*) AS "__support_count" FROM "reading" b0 GROUP BY b0."value") GROUP BY "value"`, `UPDATE "audited" AS h SET "__support_count" = "__support_count" - ("__support_count" - COALESCE((SELECT n."__support_count" FROM "__support_next_audited" n WHERE n."value" = h."value"), 0))`, `DELETE FROM "audited" WHERE "__support_count" <= 0 RETURNING "value"`, `INSERT INTO "audited" ("value", "__support_count") SELECT "value", n."__support_count" FROM "__support_next_audited" n WHERE NOT EXISTS (SELECT 1 FROM "audited" h WHERE n."value" = h."value") RETURNING "value"`], aggregateSql: null },
...
INSERT OR IGNORE INTO "audit_trail" ("value") SELECT b0."value" FROM "audited" b0`, supportSql: [`DELETE FROM "__support_next_audit_trail"`, `INSERT INTO "__support_next_audit_trail" ("value", "__support_count") SELECT "value", sum("__support_count") FROM (SELECT b0."value" AS "value", count(*) AS "__support_count" FROM "audited" b0 GROUP BY b0."value") GROUP BY "value"`, `UPDATE "audit_trail" AS h SET "__support_count" = "__support_count" - ("__support_count" - COALESCE((SELECT n."__support_count" FROM "__support_next_audit_trail" n WHERE n."value" = h."value"), 0))`, `DELETE FROM "audit_trail" WHERE "__support_count" <= 0 RETURNING "value"`, `INSERT INTO "audit_trail" ("value", "__support_count") SELECT "value", n."__support_count" FROM "__support_next_audit_trail" n WHERE NOT EXISTS (SELECT 1 FROM "audit_trail" h WHERE n."value" = h."value") RETURNING "value"`], aggregateSql: null },
...
INSERT OR IGNORE INTO "watched" ("sensor") SELECT b0."sensor" FROM "reading" b0`, supportSql: [`DELETE FROM "__support_next_watched"`, `INSERT INTO "__support_next_watched" ("sensor", "__support_count") SELECT "sensor", sum("__support_count") FROM (SELECT b0."sensor" AS "sensor", count(*) AS "__support_count" FROM "reading" b0 GROUP BY b0."sensor") GROUP BY "sensor"`, `UPDATE "watched" AS h SET "__support_count" = "__support_count" - ("__support_count" - COALESCE((SELECT n."__support_count" FROM "__support_next_watched" n WHERE n."sensor" = h."sensor"), 0))`, `DELETE FROM "watched" WHERE "__support_count" <= 0 RETURNING "sensor"`, `INSERT INTO "watched" ("sensor", "__support_count") SELECT "sensor", n."__support_count" FROM "__support_next_watched" n WHERE NOT EXISTS (SELECT 1 FROM "watched" h WHERE n."sensor" = h."sensor") RETURNING "sensor"`], aggregateSql: null },
];
