...
INSERT OR IGNORE INTO "audited" ("value") SELECT b0."value" FROM "reading" b0`, supportSql: [`DELETE FROM "__support_next_audited"`, `INSERT INTO "__support_next_audited" ("value", "__refcount") SELECT "value", sum("__refcount") FROM (SELECT b0."value" AS "value", count(*) AS "__refcount" FROM "reading" b0 GROUP BY b0."value") GROUP BY "value"`, `UPDATE "audited" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_audited" n WHERE n."value" = h."value"), 0))`, `INSERT INTO "__delta_audited" ("_sign", "_sequence", "value") SELECT -1, row_number() OVER () - 1, "value" FROM "audited" WHERE "__refcount" <= 0`, `DELETE FROM "audited" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_audited" ("_sign", "_sequence", "value") SELECT 1, row_number() OVER () - 1, n."value" FROM "__support_next_audited" n WHERE NOT EXISTS (SELECT 1 FROM "audited" h WHERE n."value" = h."value")`, `INSERT INTO "__frontier_audited" ("_phase", "_sequence", "value") SELECT ?, row_number() OVER () - 1, n."value" FROM "__support_next_audited" n WHERE NOT EXISTS (SELECT 1 FROM "audited" h WHERE n."value" = h."value")`, `INSERT INTO "__next_frontier_audited" ("_phase", "_sequence", "value") SELECT ?, row_number() OVER () - 1, n."value" FROM "__support_next_audited" n WHERE NOT EXISTS (SELECT 1 FROM "audited" h WHERE n."value" = h."value")`, `INSERT INTO "audited" ("value", "__refcount") SELECT n."value", n."__refcount" FROM "__support_next_audited" n WHERE NOT EXISTS (SELECT 1 FROM "audited" h WHERE n."value" = h."value")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "audit_trail" ("value") SELECT b0."value" FROM "audited" b0`, supportSql: [`DELETE FROM "__support_next_audit_trail"`, `INSERT INTO "__support_next_audit_trail" ("value", "__refcount") SELECT "value", sum("__refcount") FROM (SELECT b0."value" AS "value", count(*) AS "__refcount" FROM "audited" b0 GROUP BY b0."value") GROUP BY "value"`, `UPDATE "audit_trail" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_audit_trail" n WHERE n."value" = h."value"), 0))`, `INSERT INTO "__delta_audit_trail" ("_sign", "_sequence", "value") SELECT -1, row_number() OVER () - 1, "value" FROM "audit_trail" WHERE "__refcount" <= 0`, `DELETE FROM "audit_trail" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_audit_trail" ("_sign", "_sequence", "value") SELECT 1, row_number() OVER () - 1, n."value" FROM "__support_next_audit_trail" n WHERE NOT EXISTS (SELECT 1 FROM "audit_trail" h WHERE n."value" = h."value")`, `INSERT INTO "__frontier_audit_trail" ("_phase", "_sequence", "value") SELECT ?, row_number() OVER () - 1, n."value" FROM "__support_next_audit_trail" n WHERE NOT EXISTS (SELECT 1 FROM "audit_trail" h WHERE n."value" = h."value")`, `INSERT INTO "__next_frontier_audit_trail" ("_phase", "_sequence", "value") SELECT ?, row_number() OVER () - 1, n."value" FROM "__support_next_audit_trail" n WHERE NOT EXISTS (SELECT 1 FROM "audit_trail" h WHERE n."value" = h."value")`, `INSERT INTO "audit_trail" ("value", "__refcount") SELECT n."value", n."__refcount" FROM "__support_next_audit_trail" n WHERE NOT EXISTS (SELECT 1 FROM "audit_trail" h WHERE n."value" = h."value")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "watched" ("sensor") SELECT b0."sensor" FROM "reading" b0`, supportSql: [`DELETE FROM "__support_next_watched"`, `INSERT INTO "__support_next_watched" ("sensor", "__refcount") SELECT "sensor", sum("__refcount") FROM (SELECT b0."sensor" AS "sensor", count(*) AS "__refcount" FROM "reading" b0 GROUP BY b0."sensor") GROUP BY "sensor"`, `UPDATE "watched" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_watched" n WHERE n."sensor" = h."sensor"), 0))`, `INSERT INTO "__delta_watched" ("_sign", "_sequence", "sensor") SELECT -1, row_number() OVER () - 1, "sensor" FROM "watched" WHERE "__refcount" <= 0`, `DELETE FROM "watched" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_watched" ("_sign", "_sequence", "sensor") SELECT 1, row_number() OVER () - 1, n."sensor" FROM "__support_next_watched" n WHERE NOT EXISTS (SELECT 1 FROM "watched" h WHERE n."sensor" = h."sensor")`, `INSERT INTO "__frontier_watched" ("_phase", "_sequence", "sensor") SELECT ?, row_number() OVER () - 1, n."sensor" FROM "__support_next_watched" n WHERE NOT EXISTS (SELECT 1 FROM "watched" h WHERE n."sensor" = h."sensor")`, `INSERT INTO "__next_frontier_watched" ("_phase", "_sequence", "sensor") SELECT ?, row_number() OVER () - 1, n."sensor" FROM "__support_next_watched" n WHERE NOT EXISTS (SELECT 1 FROM "watched" h WHERE n."sensor" = h."sensor")`, `INSERT INTO "watched" ("sensor", "__refcount") SELECT n."sensor", n."__refcount" FROM "__support_next_watched" n WHERE NOT EXISTS (SELECT 1 FROM "watched" h WHERE n."sensor" = h."sensor")`], aggregateSql: null },
];
