...
INSERT OR IGNORE INTO "enabled_name" ("name") SELECT b0."name" FROM "flag" b0 WHERE (b0."enabled" = 1)`, supportSql: [`DELETE FROM "__support_next_enabled_name"`, `INSERT INTO "__support_next_enabled_name" ("name", "__refcount") SELECT "name", sum("__refcount") FROM (SELECT b0."name" AS "name", count(*) AS "__refcount" FROM "flag" b0 WHERE (b0."enabled" = 1) GROUP BY b0."name") GROUP BY "name"`, `UPDATE "enabled_name" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_enabled_name" n WHERE n."name" = h."name"), 0))`, `INSERT INTO "__delta_enabled_name" ("_sign", "_sequence", "name") SELECT -1, row_number() OVER () - 1, "name" FROM "enabled_name" WHERE "__refcount" <= 0`, `DELETE FROM "enabled_name" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_enabled_name" ("_sign", "_sequence", "name") SELECT 1, row_number() OVER () - 1, n."name" FROM "__support_next_enabled_name" n WHERE NOT EXISTS (SELECT 1 FROM "enabled_name" h WHERE n."name" = h."name")`, `INSERT INTO "__frontier_enabled_name" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_enabled_name" n WHERE NOT EXISTS (SELECT 1 FROM "enabled_name" h WHERE n."name" = h."name")`, `INSERT INTO "__next_frontier_enabled_name" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_enabled_name" n WHERE NOT EXISTS (SELECT 1 FROM "enabled_name" h WHERE n."name" = h."name")`, `INSERT INTO "enabled_name" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_enabled_name" n WHERE NOT EXISTS (SELECT 1 FROM "enabled_name" h WHERE n."name" = h."name")`], aggregateSql: null },
];
