...
INSERT OR IGNORE INTO "flow_edge" ("from", "to") SELECT b0."arg", b2."param" FROM "df_arg" b0, "resolved_call_edge" b1, "df_param" b2 WHERE b1."caller_path" = b0."caller_path" AND b1."call_start" = b0."call_start" AND b1."call_end" = b0."call_end" AND b2."callee_path" = b1."callee_path" AND b2."pos" = b0."pos"`, supportSql: [`DELETE FROM "__support_next_flow_edge"`, `INSERT INTO "__support_next_flow_edge" ("from", "to", "__refcount") SELECT "from", "to", sum("__refcount") FROM (SELECT b0."arg" AS "from", b2."param" AS "to", count(*) AS "__refcount" FROM "df_arg" b0, "resolved_call_edge" b1, "df_param" b2 WHERE b1."caller_path" = b0."caller_path" AND b1."call_start" = b0."call_start" AND b1."call_end" = b0."call_end" AND b2."callee_path" = b1."callee_path" AND b2."pos" = b0."pos" GROUP BY b0."arg", b2."param") GROUP BY "from", "to"`, `UPDATE "flow_edge" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_flow_edge" n WHERE n."from" = h."from" AND n."to" = h."to"), 0))`, `INSERT INTO "__delta_flow_edge" ("_sign", "_sequence", "from", "to") SELECT -1, row_number() OVER () - 1, "from", "to" FROM "flow_edge" WHERE "__refcount" <= 0`, `DELETE FROM "flow_edge" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_flow_edge" ("_sign", "_sequence", "from", "to") SELECT 1, row_number() OVER () - 1, n."from", n."to" FROM "__support_next_flow_edge" n WHERE NOT EXISTS (SELECT 1 FROM "flow_edge" h WHERE n."from" = h."from" AND n."to" = h."to")`, `INSERT INTO "__frontier_flow_edge" ("_phase", "_sequence", "from", "to") SELECT ?, row_number() OVER () - 1, n."from", n."to" FROM "__support_next_flow_edge" n WHERE NOT EXISTS (SELECT 1 FROM "flow_edge" h WHERE n."from" = h."from" AND n."to" = h."to")`, `INSERT INTO "__next_frontier_flow_edge" ("_phase", "_sequence", "from", "to") SELECT ?, row_number() OVER () - 1, n."from", n."to" FROM "__support_next_flow_edge" n WHERE NOT EXISTS (SELECT 1 FROM "flow_edge" h WHERE n."from" = h."from" AND n."to" = h."to")`, `INSERT INTO "flow_edge" ("from", "to", "__refcount") SELECT n."from", n."to", n."__refcount" FROM "__support_next_flow_edge" n WHERE NOT EXISTS (SELECT 1 FROM "flow_edge" h WHERE n."from" = h."from" AND n."to" = h."to")`], aggregateSql: null },
];
