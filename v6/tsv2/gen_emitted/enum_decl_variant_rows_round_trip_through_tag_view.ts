...
INSERT OR IGNORE INTO "body_tag" ("id", "tag") SELECT b0."id", 'redirect' FROM "body_redirect" b0`, supportSql: [`DELETE FROM "__support_next_body_tag"`, `INSERT INTO "__support_next_body_tag" ("id", "tag", "__refcount") SELECT "id", "tag", sum("__refcount") FROM (SELECT b0."id" AS "id", 'page' AS "tag", count(*) AS "__refcount" FROM "body_page" b0 GROUP BY b0."id", 'page' UNION ALL SELECT b0."id" AS "id", 'redirect' AS "tag", count(*) AS "__refcount" FROM "body_redirect" b0 GROUP BY b0."id", 'redirect') GROUP BY "id", "tag"`, `UPDATE "body_tag" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_body_tag" n WHERE n."id" = h."id" AND n."tag" = h."tag"), 0))`, `INSERT INTO "__delta_body_tag" ("_sign", "_sequence", "id", "tag") SELECT -1, row_number() OVER () - 1, "id", "tag" FROM "body_tag" WHERE "__refcount" <= 0`, `DELETE FROM "body_tag" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_body_tag" ("_sign", "_sequence", "id", "tag") SELECT 1, row_number() OVER () - 1, n."id", n."tag" FROM "__support_next_body_tag" n WHERE NOT EXISTS (SELECT 1 FROM "body_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`, `INSERT INTO "__frontier_body_tag" ("_phase", "_sequence", "id", "tag") SELECT ?, row_number() OVER () - 1, n."id", n."tag" FROM "__support_next_body_tag" n WHERE NOT EXISTS (SELECT 1 FROM "body_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`, `INSERT INTO "__next_frontier_body_tag" ("_phase", "_sequence", "id", "tag") SELECT ?, row_number() OVER () - 1, n."id", n."tag" FROM "__support_next_body_tag" n WHERE NOT EXISTS (SELECT 1 FROM "body_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`, `INSERT INTO "body_tag" ("id", "tag", "__refcount") SELECT n."id", n."tag", n."__refcount" FROM "__support_next_body_tag" n WHERE NOT EXISTS (SELECT 1 FROM "body_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`], aggregateSql: null },
];
