...
INSERT OR IGNORE INTO "leg_total" ("leg_id", "dispatch_id", "kilos") SELECT b0."leg_id", b0."dispatch_id", (b1."kilos" + b0."kilos") FROM "dispatch_leg" b0, "leg_total" b1 WHERE b1."leg_id" = b0."previous_leg" AND b1."dispatch_id" = b0."dispatch_id"`, supportSql: [`DELETE FROM "__support_next_leg_total"`, `INSERT INTO "__support_next_leg_total" ("leg_id", "dispatch_id", "kilos", "__refcount") WITH RECURSIVE "leg_total" ("leg_id", "dispatch_id", "kilos") AS (SELECT b0."leg_id" AS "leg_id", b0."dispatch_id" AS "dispatch_id", b0."kilos" AS "kilos" FROM "dispatch_leg" b0 WHERE b0."previous_leg" = 0 UNION SELECT b0."leg_id" AS "leg_id", b0."dispatch_id" AS "dispatch_id", (b1."kilos" + b0."kilos") AS "kilos" FROM "dispatch_leg" b0, "leg_total" b1 WHERE b1."leg_id" = b0."previous_leg" AND b1."dispatch_id" = b0."dispatch_id") SELECT "leg_id", "dispatch_id", "kilos", 1 FROM "leg_total"`, `UPDATE "leg_total" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_leg_total" n WHERE n."leg_id" = h."leg_id" AND n."dispatch_id" = h."dispatch_id" AND n."kilos" = h."kilos"), 0))`, `INSERT INTO "__delta_leg_total" ("_sign", "_sequence", "leg_id", "dispatch_id", "kilos") SELECT -1, row_number() OVER () - 1, "leg_id", "dispatch_id", "kilos" FROM "leg_total" WHERE "__refcount" <= 0`, `DELETE FROM "leg_total" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_leg_total" ("_sign", "_sequence", "leg_id", "dispatch_id", "kilos") SELECT 1, row_number() OVER () - 1, n."leg_id", n."dispatch_id", n."kilos" FROM "__support_next_leg_total" n WHERE NOT EXISTS (SELECT 1 FROM "leg_total" h WHERE n."leg_id" = h."leg_id" AND n."dispatch_id" = h."dispatch_id" AND n."kilos" = h."kilos")`, `INSERT INTO "__frontier_leg_total" ("_phase", "_sequence", "leg_id", "dispatch_id", "kilos") SELECT ?, row_number() OVER () - 1, n."leg_id", n."dispatch_id", n."kilos" FROM "__support_next_leg_total" n WHERE NOT EXISTS (SELECT 1 FROM "leg_total" h WHERE n."leg_id" = h."leg_id" AND n."dispatch_id" = h."dispatch_id" AND n."kilos" = h."kilos")`, `INSERT INTO "__next_frontier_leg_total" ("_phase", "_sequence", "leg_id", "dispatch_id", "kilos") SELECT ?, row_number() OVER () - 1, n."leg_id", n."dispatch_id", n."kilos" FROM "__support_next_leg_total" n WHERE NOT EXISTS (SELECT 1 FROM "leg_total" h WHERE n."leg_id" = h."leg_id" AND n."dispatch_id" = h."dispatch_id" AND n."kilos" = h."kilos")`, `INSERT INTO "leg_total" ("leg_id", "dispatch_id", "kilos", "__refcount") SELECT n."leg_id", n."dispatch_id", n."kilos", n."__refcount" FROM "__support_next_leg_total" n WHERE NOT EXISTS (SELECT 1 FROM "leg_total" h WHERE n."leg_id" = h."leg_id" AND n."dispatch_id" = h."dispatch_id" AND n."kilos" = h."kilos")`], aggregateSql: null },
];
