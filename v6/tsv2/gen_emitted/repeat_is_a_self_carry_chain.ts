...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    kick: select_rows(seam, `SELECT CASE WHEN json_valid("col1") AND json_type("col1") = 'object' AND json_type("col1", '$.fn') = 'text' AND json_type("col1", '$.args') = 'array' THEN json_extract("col1", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("col1", '$.args')), '') || ')' ELSE "col1" END AS "col1" FROM "kick"`, rel_columns.kick!, rel_column_types.kick!),
