...
export const demandedRels: readonly string[] = ["rust_file/1", "worktree_edit/3", "worktree_file/3"];
...
const ddl: readonly string[] = [
  `CREATE TABLE "rust_file" ("path" TEXT NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("path")) WITHOUT ROWID`,
  ...
  `CREATE TEMP TABLE "__support_next_rust_file" ("path" TEXT NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("path")) WITHOUT ROWID`,
];
...
const boot: readonly IBootStatement[] = [
  { sql: `DELETE FROM "rust_file"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "rust_file" ("path") SELECT b0."path" FROM "worktree_file" b0 WHERE b0."kind" = 'rust'`, params: [] },
];
