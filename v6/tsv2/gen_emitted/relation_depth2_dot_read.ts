...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "fpath", ruleId: "relation_depth2_dot_read:fpath/1#1", headDeltaTableName: "__delta_fpath", headColumns: ["name"], insertSql: `INSERT OR IGNORE INTO "fpath" ("name") SELECT DISTINCT d0."path_name" FROM "__frontier_raw" d0 WHERE d0."_phase" >= 0 RETURNING "name"`, selectSql: `SELECT "name" FROM "fpath"`, recomputeSql: `DELETE FROM "fpath";
INSERT OR IGNORE INTO "fpath" ("name") SELECT b0."path_name" FROM "raw" b0`, supportSql: [`DELETE FROM "__support_next_fpath"`, `INSERT INTO "__support_next_fpath" ("name", "__refcount") SELECT "name", sum("__refcount") FROM (SELECT b0."path_name" AS "name", count(*) AS "__refcount" FROM "raw" b0 GROUP BY b0."path_name") GROUP BY "name"`, `UPDATE "fpath" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_fpath" n WHERE n."name" = h."name"), 0))`, `INSERT INTO "__delta_fpath" ("_sign", "_sequence", "name") SELECT -1, row_number() OVER () - 1, "name" FROM "fpath" WHERE "__refcount" <= 0`, `DELETE FROM "fpath" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_fpath" ("_sign", "_sequence", "name") SELECT 1, row_number() OVER () - 1, n."name" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`, `INSERT INTO "__frontier_fpath" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`, `INSERT INTO "__next_frontier_fpath" ("_phase", "_sequence", "name") SELECT ?, row_number() OVER () - 1, n."name" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`, `INSERT INTO "fpath" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_fpath" n WHERE NOT EXISTS (SELECT 1 FROM "fpath" h WHERE n."name" = h."name")`], aggregateSql: null },
  { headRel: "repo", ruleId: "relation_depth2_dot_read:repo/1#1", headDeltaTableName: "__delta_repo", headColumns: ["name"], insertSql: `INSERT OR IGNORE INTO "repo" ("name") SELECT DISTINCT d0."repo_name" FROM "__frontier_raw" d0 WHERE d0."_phase" >= 0 RETURNING "name"`, selectSql: `SELECT "name" FROM "repo"`, recomputeSql: `DELETE FROM "repo";
...
INSERT OR IGNORE INTO "span" ("file", "start", "end") SELECT b1."__id", b0."start", b0."end" FROM "raw" b0, "file" b1, "__ref_repo" b2, "__ref_fpath" b3 WHERE b2."__id" = b1."repo" AND b2."name" = b0."repo_name" AND b3."__id" = b1."at" AND b3."name" = b0."path_name"`, supportSql: [`DELETE FROM "__support_next_span"`, `INSERT INTO "__support_next_span" ("file", "start", "end", "__refcount") SELECT "file", "start", "end", sum("__refcount") FROM (SELECT b1."__id" AS "file", b0."start" AS "start", b0."end" AS "end", count(*) AS "__refcount" FROM "raw" b0, "file" b1, "__ref_repo" b2, "__ref_fpath" b3 WHERE b2."__id" = b1."repo" AND b2."name" = b0."repo_name" AND b3."__id" = b1."at" AND b3."name" = b0."path_name" GROUP BY b1."__id", b0."start", b0."end") GROUP BY "file", "start", "end"`, `UPDATE "span" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_span" n WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end"), 0))`, `INSERT INTO "__delta_span" ("_sign", "_sequence", "file", "start", "end") SELECT -1, row_number() OVER () - 1, "file", "start", "end" FROM "span" WHERE "__refcount" <= 0`, `DELETE FROM "span" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_span" ("_sign", "_sequence", "file", "start", "end") SELECT 1, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__frontier_span" ("_phase", "_sequence", "file", "start", "end") SELECT ?, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__next_frontier_span" ("_phase", "_sequence", "file", "start", "end") SELECT ?, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "span" ("file", "start", "end", "__refcount") SELECT n."file", n."start", n."end", n."__refcount" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`], aggregateSql: null },
  { headRel: "dcoord", ruleId: "relation_depth2_dot_read:dcoord/3#1", headDeltaTableName: "__delta_dcoord", headColumns: ["path_name", "start", "end"], insertSql: `INSERT OR IGNORE INTO "dcoord" ("path_name", "start", "end") SELECT DISTINCT b1."name", d0."start", d0."end" FROM "__frontier_span" d0, "__ref_file" b0, "__ref_fpath" b1 WHERE d0."_phase" >= 0 AND b0."__id" = d0."file" AND b1."__id" = b0."at" RETURNING "path_name", "start", "end"`, selectSql: `SELECT "path_name", "start", "end" FROM "dcoord"`, recomputeSql: `DELETE FROM "dcoord";
INSERT OR IGNORE INTO "dcoord" ("path_name", "start", "end") SELECT b2."name", b0."start", b0."end" FROM "span" b0, "__ref_file" b1, "__ref_fpath" b2 WHERE b1."__id" = b0."file" AND b2."__id" = b1."at"`, supportSql: [`DELETE FROM "__support_next_dcoord"`, `INSERT INTO "__support_next_dcoord" ("path_name", "start", "end", "__refcount") SELECT "path_name", "start", "end", sum("__refcount") FROM (SELECT b2."name" AS "path_name", b0."start" AS "start", b0."end" AS "end", count(*) AS "__refcount" FROM "span" b0, "__ref_file" b1, "__ref_fpath" b2 WHERE b1."__id" = b0."file" AND b2."__id" = b1."at" GROUP BY b2."name", b0."start", b0."end") GROUP BY "path_name", "start", "end"`, `UPDATE "dcoord" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_dcoord" n WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end"), 0))`, `INSERT INTO "__delta_dcoord" ("_sign", "_sequence", "path_name", "start", "end") SELECT -1, row_number() OVER () - 1, "path_name", "start", "end" FROM "dcoord" WHERE "__refcount" <= 0`, `DELETE FROM "dcoord" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_dcoord" ("_sign", "_sequence", "path_name", "start", "end") SELECT 1, row_number() OVER () - 1, n."path_name", n."start", n."end" FROM "__support_next_dcoord" n WHERE NOT EXISTS (SELECT 1 FROM "dcoord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__frontier_dcoord" ("_phase", "_sequence", "path_name", "start", "end") SELECT ?, row_number() OVER () - 1, n."path_name", n."start", n."end" FROM "__support_next_dcoord" n WHERE NOT EXISTS (SELECT 1 FROM "dcoord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__next_frontier_dcoord" ("_phase", "_sequence", "path_name", "start", "end") SELECT ?, row_number() OVER () - 1, n."path_name", n."start", n."end" FROM "__support_next_dcoord" n WHERE NOT EXISTS (SELECT 1 FROM "dcoord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "dcoord" ("path_name", "start", "end", "__refcount") SELECT n."path_name", n."start", n."end", n."__refcount" FROM "__support_next_dcoord" n WHERE NOT EXISTS (SELECT 1 FROM "dcoord" h WHERE n."path_name" = h."path_name" AND n."start" = h."start" AND n."end" = h."end")`], aggregateSql: null },
];
