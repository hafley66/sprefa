...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__new_dcoord" ("path_name" TEXT NOT NULL, "start" INTEGER NOT NULL, "end" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL)`,
...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    dcoord: select_rows(seam, `SELECT CASE WHEN json_valid("path_name") AND json_type("path_name") = 'object' AND json_type("path_name", '$.fn') = 'text' AND json_type("path_name", '$.args') = 'array' THEN json_extract("path_name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path_name", '$.args')), '') || ')' ELSE "path_name" END AS "path_name", "start", "end" FROM "dcoord"`, rel_columns.dcoord!, rel_column_types.dcoord!),
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "dcoord", kind: "set", table_name: "dcoord", delta_table_name: "__delta_dcoord", frontier_table_name: "__frontier_dcoord", next_frontier_table_name: "__next_frontier_dcoord", columns: ["path_name", "start", "end"], column_types: ["text", "int", "int"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid("path_name") AND json_type("path_name") = 'object' AND json_type("path_name", '$.fn') = 'text' AND json_type("path_name", '$.args') = 'array' THEN json_extract("path_name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path_name", '$.args')), '') || ')' ELSE "path_name" END AS "path_name", "start", "end", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_dcoord" WHERE "_sign" IN (-1, 1) GROUP BY "path_name", "start", "end", "_sign"`, rule_observers: [] },
