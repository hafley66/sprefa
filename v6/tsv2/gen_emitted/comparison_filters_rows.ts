...
INSERT OR IGNORE INTO "union_size" ("left", "right", "union") SELECT b0."left", b1."left", ((b0."left_size" + b1."left_size") - b2."shared") FROM "callee_set_size" b0, "callee_set_size" b1, "shared_count" b2 WHERE b2."left" = b0."left" AND b2."right" = b1."left"`, supportSql: [`DELETE FROM "__support_next_union_size"`, `INSERT INTO "__support_next_union_size" ("left", "right", "union", "__refcount") SELECT "left", "right", "union", sum("__refcount") FROM (SELECT b0."left" AS "left", b1."left" AS "right", ((b0."left_size" + b1."left_size") - b2."shared") AS "union", count(*) AS "__refcount" FROM "callee_set_size" b0, "callee_set_size" b1, "shared_count" b2 WHERE b2."left" = b0."left" AND b2."right" = b1."left" GROUP BY b0."left", b1."left", ((b0."left_size" + b1."left_size") - b2."shared")) GROUP BY "left", "right", "union"`, `UPDATE "union_size" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_union_size" n WHERE n."left" = h."left" AND n."right" = h."right" AND n."union" = h."union"), 0))`, `INSERT INTO "__delta_union_size" ("_sign", "_sequence", "left", "right", "union") SELECT -1, row_number() OVER () - 1, "left", "right", "union" FROM "union_size" WHERE "__refcount" <= 0`, `DELETE FROM "union_size" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_union_size" ("_sign", "_sequence", "left", "right", "union") SELECT 1, row_number() OVER () - 1, n."left", n."right", n."union" FROM "__support_next_union_size" n WHERE NOT EXISTS (SELECT 1 FROM "union_size" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."union" = h."union")`, `INSERT INTO "__frontier_union_size" ("_phase", "_sequence", "left", "right", "union") SELECT ?, row_number() OVER () - 1, n."left", n."right", n."union" FROM "__support_next_union_size" n WHERE NOT EXISTS (SELECT 1 FROM "union_size" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."union" = h."union")`, `INSERT INTO "__next_frontier_union_size" ("_phase", "_sequence", "left", "right", "union") SELECT ?, row_number() OVER () - 1, n."left", n."right", n."union" FROM "__support_next_union_size" n WHERE NOT EXISTS (SELECT 1 FROM "union_size" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."union" = h."union")`, `INSERT INTO "union_size" ("left", "right", "union", "__refcount") SELECT n."left", n."right", n."union", n."__refcount" FROM "__support_next_union_size" n WHERE NOT EXISTS (SELECT 1 FROM "union_size" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."union" = h."union")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "jaccard" ("left", "right", "col3") SELECT b0."left", b0."right", ((b0."shared" * 100) / b1."union") FROM "shared_count" b0, "union_size" b1 WHERE b1."left" = b0."left" AND b1."right" = b0."right" AND (b1."union" > 0) AND (((b0."shared" * 100) / b1."union") >= 40)`, supportSql: [`DELETE FROM "__support_next_jaccard"`, `INSERT INTO "__support_next_jaccard" ("left", "right", "col3", "__refcount") SELECT "left", "right", "col3", sum("__refcount") FROM (SELECT b0."left" AS "left", b0."right" AS "right", ((b0."shared" * 100) / b1."union") AS "col3", count(*) AS "__refcount" FROM "shared_count" b0, "union_size" b1 WHERE b1."left" = b0."left" AND b1."right" = b0."right" AND (b1."union" > 0) AND (((b0."shared" * 100) / b1."union") >= 40) GROUP BY b0."left", b0."right", ((b0."shared" * 100) / b1."union")) GROUP BY "left", "right", "col3"`, `UPDATE "jaccard" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_jaccard" n WHERE n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3"), 0))`, `INSERT INTO "__delta_jaccard" ("_sign", "_sequence", "left", "right", "col3") SELECT -1, row_number() OVER () - 1, "left", "right", "col3" FROM "jaccard" WHERE "__refcount" <= 0`, `DELETE FROM "jaccard" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_jaccard" ("_sign", "_sequence", "left", "right", "col3") SELECT 1, row_number() OVER () - 1, n."left", n."right", n."col3" FROM "__support_next_jaccard" n WHERE NOT EXISTS (SELECT 1 FROM "jaccard" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3")`, `INSERT INTO "__frontier_jaccard" ("_phase", "_sequence", "left", "right", "col3") SELECT ?, row_number() OVER () - 1, n."left", n."right", n."col3" FROM "__support_next_jaccard" n WHERE NOT EXISTS (SELECT 1 FROM "jaccard" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3")`, `INSERT INTO "__next_frontier_jaccard" ("_phase", "_sequence", "left", "right", "col3") SELECT ?, row_number() OVER () - 1, n."left", n."right", n."col3" FROM "__support_next_jaccard" n WHERE NOT EXISTS (SELECT 1 FROM "jaccard" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3")`, `INSERT INTO "jaccard" ("left", "right", "col3", "__refcount") SELECT n."left", n."right", n."col3", n."__refcount" FROM "__support_next_jaccard" n WHERE NOT EXISTS (SELECT 1 FROM "jaccard" h WHERE n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3")`], aggregateSql: null },
];
