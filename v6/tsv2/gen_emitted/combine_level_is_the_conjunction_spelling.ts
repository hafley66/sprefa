...
INSERT OR IGNORE INTO "pair" ("left", "right") SELECT b0."left", b1."right" FROM "source_a" b0, "source_b" b1`, supportSql: [`DELETE FROM "__support_next_pair"`, `INSERT INTO "__support_next_pair" ("left", "right", "__refcount") SELECT "left", "right", sum("__refcount") FROM (SELECT b0."left" AS "left", b1."right" AS "right", count(*) AS "__refcount" FROM "source_a" b0, "source_b" b1 GROUP BY b0."left", b1."right") GROUP BY "left", "right"`, `UPDATE "pair" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_pair" n WHERE n."left" = h."left" AND n."right" = h."right"), 0))`, `INSERT INTO "__delta_pair" ("_sign", "_sequence", "left", "right") SELECT -1, row_number() OVER () - 1, "left", "right" FROM "pair" WHERE "__refcount" <= 0`, `DELETE FROM "pair" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_pair" ("_sign", "_sequence", "left", "right") SELECT 1, row_number() OVER () - 1, n."left", n."right" FROM "__support_next_pair" n WHERE NOT EXISTS (SELECT 1 FROM "pair" h WHERE n."left" = h."left" AND n."right" = h."right")`, `INSERT INTO "__frontier_pair" ("_phase", "_sequence", "left", "right") SELECT ?, row_number() OVER () - 1, n."left", n."right" FROM "__support_next_pair" n WHERE NOT EXISTS (SELECT 1 FROM "pair" h WHERE n."left" = h."left" AND n."right" = h."right")`, `INSERT INTO "__next_frontier_pair" ("_phase", "_sequence", "left", "right") SELECT ?, row_number() OVER () - 1, n."left", n."right" FROM "__support_next_pair" n WHERE NOT EXISTS (SELECT 1 FROM "pair" h WHERE n."left" = h."left" AND n."right" = h."right")`, `INSERT INTO "pair" ("left", "right", "__refcount") SELECT n."left", n."right", n."__refcount" FROM "__support_next_pair" n WHERE NOT EXISTS (SELECT 1 FROM "pair" h WHERE n."left" = h."left" AND n."right" = h."right")`], aggregateSql: null },
];
