...
INSERT OR IGNORE INTO "result_tag" ("id", "tag") SELECT b0."id", 'error' FROM "result_error" b0`, supportSql: [`DELETE FROM "__support_next_result_tag"`, `INSERT INTO "__support_next_result_tag" ("id", "tag", "__refcount") SELECT "id", "tag", sum("__refcount") FROM (SELECT b0."id" AS "id", 'ok' AS "tag", count(*) AS "__refcount" FROM "result_ok" b0 GROUP BY b0."id", 'ok' UNION ALL SELECT b0."id" AS "id", 'error' AS "tag", count(*) AS "__refcount" FROM "result_error" b0 GROUP BY b0."id", 'error') GROUP BY "id", "tag"`, `UPDATE "result_tag" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_result_tag" n WHERE n."id" = h."id" AND n."tag" = h."tag"), 0))`, `INSERT INTO "__delta_result_tag" ("_sign", "_sequence", "id", "tag") SELECT -1, row_number() OVER () - 1, "id", "tag" FROM "result_tag" WHERE "__refcount" <= 0`, `DELETE FROM "result_tag" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_result_tag" ("_sign", "_sequence", "id", "tag") SELECT 1, row_number() OVER () - 1, n."id", n."tag" FROM "__support_next_result_tag" n WHERE NOT EXISTS (SELECT 1 FROM "result_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`, `INSERT INTO "__frontier_result_tag" ("_phase", "_sequence", "id", "tag") SELECT ?, row_number() OVER () - 1, n."id", n."tag" FROM "__support_next_result_tag" n WHERE NOT EXISTS (SELECT 1 FROM "result_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`, `INSERT INTO "__next_frontier_result_tag" ("_phase", "_sequence", "id", "tag") SELECT ?, row_number() OVER () - 1, n."id", n."tag" FROM "__support_next_result_tag" n WHERE NOT EXISTS (SELECT 1 FROM "result_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`, `INSERT INTO "result_tag" ("id", "tag", "__refcount") SELECT n."id", n."tag", n."__refcount" FROM "__support_next_result_tag" n WHERE NOT EXISTS (SELECT 1 FROM "result_tag" h WHERE n."id" = h."id" AND n."tag" = h."tag")`], aggregateSql: null },
];
