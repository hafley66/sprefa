...
INSERT OR IGNORE INTO "stream_status" ("args", "col2") SELECT b0."args", 'done' FROM "stream_end" b0`, supportSql: [`DELETE FROM "__support_next_stream_status"`, `INSERT INTO "__support_next_stream_status" ("args", "col2", "__refcount") SELECT "args", "col2", sum("__refcount") FROM (SELECT b0."args" AS "args", 'running' AS "col2", count(*) AS "__refcount" FROM "stream_item" b0 WHERE NOT EXISTS (SELECT 1 FROM "stream_end" n0 WHERE n0."args" = b0."args") GROUP BY b0."args", 'running' UNION ALL SELECT b0."args" AS "args", 'done' AS "col2", count(*) AS "__refcount" FROM "stream_end" b0 GROUP BY b0."args", 'done') GROUP BY "args", "col2"`, `UPDATE "stream_status" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_stream_status" n WHERE n."args" = h."args" AND n."col2" = h."col2"), 0))`, `INSERT INTO "__delta_stream_status" ("_sign", "_sequence", "args", "col2") SELECT -1, row_number() OVER () - 1, "args", "col2" FROM "stream_status" WHERE "__refcount" <= 0`, `DELETE FROM "stream_status" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_stream_status" ("_sign", "_sequence", "args", "col2") SELECT 1, row_number() OVER () - 1, n."args", n."col2" FROM "__support_next_stream_status" n WHERE NOT EXISTS (SELECT 1 FROM "stream_status" h WHERE n."args" = h."args" AND n."col2" = h."col2")`, `INSERT INTO "__frontier_stream_status" ("_phase", "_sequence", "args", "col2") SELECT ?, row_number() OVER () - 1, n."args", n."col2" FROM "__support_next_stream_status" n WHERE NOT EXISTS (SELECT 1 FROM "stream_status" h WHERE n."args" = h."args" AND n."col2" = h."col2")`, `INSERT INTO "__next_frontier_stream_status" ("_phase", "_sequence", "args", "col2") SELECT ?, row_number() OVER () - 1, n."args", n."col2" FROM "__support_next_stream_status" n WHERE NOT EXISTS (SELECT 1 FROM "stream_status" h WHERE n."args" = h."args" AND n."col2" = h."col2")`, `INSERT INTO "stream_status" ("args", "col2", "__refcount") SELECT n."args", n."col2", n."__refcount" FROM "__support_next_stream_status" n WHERE NOT EXISTS (SELECT 1 FROM "stream_status" h WHERE n."args" = h."args" AND n."col2" = h."col2")`], aggregateSql: null },
];
