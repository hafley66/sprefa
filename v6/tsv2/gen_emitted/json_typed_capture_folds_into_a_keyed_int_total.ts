...
const ddl: readonly string[] = [
  ...
  `CREATE INDEX "__next_frontier_star_event_phase" ON "__next_frontier_star_event" ("_phase")`,
...
INSERT OR IGNORE INTO "star_event" ("repo", "stars") SELECT json_extract(b0."payload", '$."repo"'), json_extract(b0."payload", '$."stars"') FROM "event" b0 WHERE json_type(b0."payload", '$') = 'object' AND json_type(b0."payload", '$."repo"') = 'text' AND json_type(b0."payload", '$."stars"') = 'integer'`, supportSql: [`DELETE FROM "__support_next_star_event"`, `INSERT INTO "__support_next_star_event" ("repo", "stars", "__refcount") SELECT "repo", "stars", sum("__refcount") FROM (SELECT json_extract(b0."payload", '$."repo"') AS "repo", json_extract(b0."payload", '$."stars"') AS "stars", count(*) AS "__refcount" FROM "event" b0 WHERE json_type(b0."payload", '$') = 'object' AND json_type(b0."payload", '$."repo"') = 'text' AND json_type(b0."payload", '$."stars"') = 'integer' GROUP BY json_extract(b0."payload", '$."repo"'), json_extract(b0."payload", '$."stars"')) GROUP BY "repo", "stars"`, `UPDATE "star_event" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_star_event" n WHERE n."repo" = h."repo" AND n."stars" = h."stars"), 0))`, `INSERT INTO "__delta_star_event" ("_sign", "_sequence", "repo", "stars") SELECT -1, row_number() OVER () - 1, "repo", "stars" FROM "star_event" WHERE "__refcount" <= 0`, `DELETE FROM "star_event" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_star_event" ("_sign", "_sequence", "repo", "stars") SELECT 1, row_number() OVER () - 1, n."repo", n."stars" FROM "__support_next_star_event" n WHERE NOT EXISTS (SELECT 1 FROM "star_event" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`, `INSERT INTO "__frontier_star_event" ("_phase", "_sequence", "repo", "stars") SELECT ?, row_number() OVER () - 1, n."repo", n."stars" FROM "__support_next_star_event" n WHERE NOT EXISTS (SELECT 1 FROM "star_event" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`, `INSERT INTO "__next_frontier_star_event" ("_phase", "_sequence", "repo", "stars") SELECT ?, row_number() OVER () - 1, n."repo", n."stars" FROM "__support_next_star_event" n WHERE NOT EXISTS (SELECT 1 FROM "star_event" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`, `INSERT INTO "star_event" ("repo", "stars", "__refcount") SELECT n."repo", n."stars", n."__refcount" FROM "__support_next_star_event" n WHERE NOT EXISTS (SELECT 1 FROM "star_event" h WHERE n."repo" = h."repo" AND n."stars" = h."stars")`], aggregateSql: null },
];
