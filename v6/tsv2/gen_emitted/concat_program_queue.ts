...
INSERT OR IGNORE INTO "live_tab" ("session_id", "tab_id") SELECT b0."session_id", b0."tab_id" FROM "open_tab" b0 WHERE NOT EXISTS (SELECT 1 FROM "closed" n0 WHERE n0."session_id" = b0."session_id" AND n0."tab_id" = b0."tab_id")`, supportSql: [`DELETE FROM "__support_next_live_tab"`, `INSERT INTO "__support_next_live_tab" ("session_id", "tab_id", "__refcount") SELECT "session_id", "tab_id", sum("__refcount") FROM (SELECT b0."session_id" AS "session_id", b0."tab_id" AS "tab_id", count(*) AS "__refcount" FROM "open_tab" b0 WHERE NOT EXISTS (SELECT 1 FROM "closed" n0 WHERE n0."session_id" = b0."session_id" AND n0."tab_id" = b0."tab_id") GROUP BY b0."session_id", b0."tab_id") GROUP BY "session_id", "tab_id"`, `UPDATE "live_tab" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_live_tab" n WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id"), 0))`, `INSERT INTO "__delta_live_tab" ("_sign", "_sequence", "session_id", "tab_id") SELECT -1, row_number() OVER () - 1, "session_id", "tab_id" FROM "live_tab" WHERE "__refcount" <= 0`, `DELETE FROM "live_tab" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_live_tab" ("_sign", "_sequence", "session_id", "tab_id") SELECT 1, row_number() OVER () - 1, n."session_id", n."tab_id" FROM "__support_next_live_tab" n WHERE NOT EXISTS (SELECT 1 FROM "live_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`, `INSERT INTO "__frontier_live_tab" ("_phase", "_sequence", "session_id", "tab_id") SELECT ?, row_number() OVER () - 1, n."session_id", n."tab_id" FROM "__support_next_live_tab" n WHERE NOT EXISTS (SELECT 1 FROM "live_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`, `INSERT INTO "__next_frontier_live_tab" ("_phase", "_sequence", "session_id", "tab_id") SELECT ?, row_number() OVER () - 1, n."session_id", n."tab_id" FROM "__support_next_live_tab" n WHERE NOT EXISTS (SELECT 1 FROM "live_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`, `INSERT INTO "live_tab" ("session_id", "tab_id", "__refcount") SELECT n."session_id", n."tab_id", n."__refcount" FROM "__support_next_live_tab" n WHERE NOT EXISTS (SELECT 1 FROM "live_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "demanded" ("col1", "session_id") SELECT json_object('fn', 'tab', 'args', json_array(b0."tab_id")), b0."session_id" FROM "live_tab" b0`, supportSql: [`DELETE FROM "__support_next_demanded"`, `INSERT INTO "__support_next_demanded" ("col1", "session_id", "__refcount") SELECT "col1", "session_id", sum("__refcount") FROM (SELECT json_object('fn', 'tab', 'args', json_array(b0."tab_id")) AS "col1", b0."session_id" AS "session_id", count(*) AS "__refcount" FROM "live_tab" b0 GROUP BY json_object('fn', 'tab', 'args', json_array(b0."tab_id")), b0."session_id") GROUP BY "col1", "session_id"`, `UPDATE "demanded" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_demanded" n WHERE n."col1" = h."col1" AND n."session_id" = h."session_id"), 0))`, `INSERT INTO "__delta_demanded" ("_sign", "_sequence", "col1", "session_id") SELECT -1, row_number() OVER () - 1, "col1", "session_id" FROM "demanded" WHERE "__refcount" <= 0`, `DELETE FROM "demanded" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_demanded" ("_sign", "_sequence", "col1", "session_id") SELECT 1, row_number() OVER () - 1, n."col1", n."session_id" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."col1" = h."col1" AND n."session_id" = h."session_id")`, `INSERT INTO "__frontier_demanded" ("_phase", "_sequence", "col1", "session_id") SELECT ?, row_number() OVER () - 1, n."col1", n."session_id" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."col1" = h."col1" AND n."session_id" = h."session_id")`, `INSERT INTO "__next_frontier_demanded" ("_phase", "_sequence", "col1", "session_id") SELECT ?, row_number() OVER () - 1, n."col1", n."session_id" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."col1" = h."col1" AND n."session_id" = h."session_id")`, `INSERT INTO "demanded" ("col1", "session_id", "__refcount") SELECT n."col1", n."session_id", n."__refcount" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."col1" = h."col1" AND n."session_id" = h."session_id")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "queue_head_tab" ("session_id", "tab_id") SELECT b0."session_id", b1."tab_id" FROM "queue_head" b0, "queue_slot" b1 WHERE b1."session_id" = b0."session_id" AND b1."next" = b0."ordinal"`, supportSql: [`DELETE FROM "__support_next_queue_head_tab"`, `INSERT INTO "__support_next_queue_head_tab" ("session_id", "tab_id", "__refcount") SELECT "session_id", "tab_id", sum("__refcount") FROM (SELECT b0."session_id" AS "session_id", b1."tab_id" AS "tab_id", count(*) AS "__refcount" FROM "queue_head" b0, "queue_slot" b1 WHERE b1."session_id" = b0."session_id" AND b1."next" = b0."ordinal" GROUP BY b0."session_id", b1."tab_id") GROUP BY "session_id", "tab_id"`, `UPDATE "queue_head_tab" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_queue_head_tab" n WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id"), 0))`, `INSERT INTO "__delta_queue_head_tab" ("_sign", "_sequence", "session_id", "tab_id") SELECT -1, row_number() OVER () - 1, "session_id", "tab_id" FROM "queue_head_tab" WHERE "__refcount" <= 0`, `DELETE FROM "queue_head_tab" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_queue_head_tab" ("_sign", "_sequence", "session_id", "tab_id") SELECT 1, row_number() OVER () - 1, n."session_id", n."tab_id" FROM "__support_next_queue_head_tab" n WHERE NOT EXISTS (SELECT 1 FROM "queue_head_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`, `INSERT INTO "__frontier_queue_head_tab" ("_phase", "_sequence", "session_id", "tab_id") SELECT ?, row_number() OVER () - 1, n."session_id", n."tab_id" FROM "__support_next_queue_head_tab" n WHERE NOT EXISTS (SELECT 1 FROM "queue_head_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`, `INSERT INTO "__next_frontier_queue_head_tab" ("_phase", "_sequence", "session_id", "tab_id") SELECT ?, row_number() OVER () - 1, n."session_id", n."tab_id" FROM "__support_next_queue_head_tab" n WHERE NOT EXISTS (SELECT 1 FROM "queue_head_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`, `INSERT INTO "queue_head_tab" ("session_id", "tab_id", "__refcount") SELECT n."session_id", n."tab_id", n."__refcount" FROM "__support_next_queue_head_tab" n WHERE NOT EXISTS (SELECT 1 FROM "queue_head_tab" h WHERE n."session_id" = h."session_id" AND n."tab_id" = h."tab_id")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "tab_view" ("tab_id", "body") SELECT json_extract(b0."col1", '$.args[0]'), b1."body" FROM "demanded" b0, "tab_row" b1 WHERE json_extract(b0."col1", '$.fn') = 'tab' AND b1."tab_id" = json_extract(b0."col1", '$.args[0]')`, supportSql: [`DELETE FROM "__support_next_tab_view"`, `INSERT INTO "__support_next_tab_view" ("tab_id", "body", "__refcount") SELECT "tab_id", "body", sum("__refcount") FROM (SELECT json_extract(b0."col1", '$.args[0]') AS "tab_id", b1."body" AS "body", count(*) AS "__refcount" FROM "demanded" b0, "tab_row" b1 WHERE json_extract(b0."col1", '$.fn') = 'tab' AND b1."tab_id" = json_extract(b0."col1", '$.args[0]') GROUP BY json_extract(b0."col1", '$.args[0]'), b1."body") GROUP BY "tab_id", "body"`, `UPDATE "tab_view" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_tab_view" n WHERE n."tab_id" = h."tab_id" AND n."body" = h."body"), 0))`, `INSERT INTO "__delta_tab_view" ("_sign", "_sequence", "tab_id", "body") SELECT -1, row_number() OVER () - 1, "tab_id", "body" FROM "tab_view" WHERE "__refcount" <= 0`, `DELETE FROM "tab_view" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_tab_view" ("_sign", "_sequence", "tab_id", "body") SELECT 1, row_number() OVER () - 1, n."tab_id", n."body" FROM "__support_next_tab_view" n WHERE NOT EXISTS (SELECT 1 FROM "tab_view" h WHERE n."tab_id" = h."tab_id" AND n."body" = h."body")`, `INSERT INTO "__frontier_tab_view" ("_phase", "_sequence", "tab_id", "body") SELECT ?, row_number() OVER () - 1, n."tab_id", n."body" FROM "__support_next_tab_view" n WHERE NOT EXISTS (SELECT 1 FROM "tab_view" h WHERE n."tab_id" = h."tab_id" AND n."body" = h."body")`, `INSERT INTO "__next_frontier_tab_view" ("_phase", "_sequence", "tab_id", "body") SELECT ?, row_number() OVER () - 1, n."tab_id", n."body" FROM "__support_next_tab_view" n WHERE NOT EXISTS (SELECT 1 FROM "tab_view" h WHERE n."tab_id" = h."tab_id" AND n."body" = h."body")`, `INSERT INTO "tab_view" ("tab_id", "body", "__refcount") SELECT n."tab_id", n."body", n."__refcount" FROM "__support_next_tab_view" n WHERE NOT EXISTS (SELECT 1 FROM "tab_view" h WHERE n."tab_id" = h."tab_id" AND n."body" = h."body")`], aggregateSql: null },
];
