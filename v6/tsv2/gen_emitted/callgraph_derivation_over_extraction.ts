...
INSERT OR IGNORE INTO "calls" ("caller", "callee") SELECT b0."name", b1."callee" FROM "def" b0, "call" b1, "def" b2 WHERE b1."path" = b0."path" AND b2."name" = b1."callee" AND (b0."name" <> b1."callee")`, supportSql: [`DELETE FROM "__support_next_calls"`, `INSERT INTO "__support_next_calls" ("caller", "callee", "__refcount") SELECT "caller", "callee", sum("__refcount") FROM (SELECT b0."name" AS "caller", b1."callee" AS "callee", count(*) AS "__refcount" FROM "def" b0, "call" b1, "def" b2 WHERE b1."path" = b0."path" AND b2."name" = b1."callee" AND (b0."name" <> b1."callee") GROUP BY b0."name", b1."callee") GROUP BY "caller", "callee"`, `UPDATE "calls" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_calls" n WHERE n."caller" = h."caller" AND n."callee" = h."callee"), 0))`, `INSERT INTO "__delta_calls" ("_sign", "_sequence", "caller", "callee") SELECT -1, row_number() OVER () - 1, "caller", "callee" FROM "calls" WHERE "__refcount" <= 0`, `DELETE FROM "calls" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_calls" ("_sign", "_sequence", "caller", "callee") SELECT 1, row_number() OVER () - 1, n."caller", n."callee" FROM "__support_next_calls" n WHERE NOT EXISTS (SELECT 1 FROM "calls" h WHERE n."caller" = h."caller" AND n."callee" = h."callee")`, `INSERT INTO "__frontier_calls" ("_phase", "_sequence", "caller", "callee") SELECT ?, row_number() OVER () - 1, n."caller", n."callee" FROM "__support_next_calls" n WHERE NOT EXISTS (SELECT 1 FROM "calls" h WHERE n."caller" = h."caller" AND n."callee" = h."callee")`, `INSERT INTO "__next_frontier_calls" ("_phase", "_sequence", "caller", "callee") SELECT ?, row_number() OVER () - 1, n."caller", n."callee" FROM "__support_next_calls" n WHERE NOT EXISTS (SELECT 1 FROM "calls" h WHERE n."caller" = h."caller" AND n."callee" = h."callee")`, `INSERT INTO "calls" ("caller", "callee", "__refcount") SELECT n."caller", n."callee", n."__refcount" FROM "__support_next_calls" n WHERE NOT EXISTS (SELECT 1 FROM "calls" h WHERE n."caller" = h."caller" AND n."callee" = h."callee")`], aggregateSql: null },
];
