...
function readSnapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    known_repo: selectRows(seam, `SELECT "col1" FROM "known_repo"`, relColumns.known_repo!),
