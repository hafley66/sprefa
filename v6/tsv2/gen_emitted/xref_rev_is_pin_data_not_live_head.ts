...
export const demandedRels: readonly string[] = ["head/2", "head_move/2", "pin_extracted/5", "xref/6"];
...
const boot: readonly IBootStatement[] = [
  { sql: `INSERT OR IGNORE INTO "head" ("repo_id", "rev_id") VALUES (?, ?)`, params: [2, 100] },
  { sql: `INSERT OR IGNORE INTO "known_repo" ("col1") VALUES (?)`, params: [2] },
];
