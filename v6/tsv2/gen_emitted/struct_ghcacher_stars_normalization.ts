...
const finalSelect: Record<string, string> = {
  current_body: `SELECT CASE WHEN json_valid("ep") AND json_type("ep") = 'object' THEN json_extract("ep", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("ep", '$.args')) || ')' ELSE "ep" END AS "ep", (SELECT d."__rendered" FROM "__ref_repo_body" d WHERE d."__id" = "body") AS "body" FROM "current_body"`,
