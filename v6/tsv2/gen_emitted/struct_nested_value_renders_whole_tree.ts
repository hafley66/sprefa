...
const finalSelect: Record<string, string> = {
  diag: `SELECT (SELECT d."__rendered" FROM "__ref_place" d WHERE d."__id" = "where") AS "where", CASE WHEN json_valid("message") AND json_type("message") = 'object' THEN json_extract("message", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("message", '$.args')) || ')' ELSE "message" END AS "message" FROM "diag"`,
  ...
  place: `SELECT CASE WHEN json_valid("file") AND json_type("file") = 'object' THEN json_extract("file", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("file", '$.args')) || ')' ELSE "file" END AS "file", (SELECT d."__rendered" FROM "__ref_span" d WHERE d."__id" = "at") AS "at" FROM "place"`,
