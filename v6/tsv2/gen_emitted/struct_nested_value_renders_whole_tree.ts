...
INSERT OR IGNORE INTO "diag_file" ("file") SELECT b1."file" FROM "diag" b0, "__ref_place" b1 WHERE b1."__id" = b0."where"`, supportSql: [`DELETE FROM "__support_next_diag_file"`, `INSERT INTO "__support_next_diag_file" ("file", "__refcount") SELECT "file", sum("__refcount") FROM (SELECT b1."file" AS "file", count(*) AS "__refcount" FROM "diag" b0, "__ref_place" b1 WHERE b1."__id" = b0."where" GROUP BY b1."file") GROUP BY "file"`, `UPDATE "diag_file" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_diag_file" n WHERE n."file" = h."file"), 0))`, `INSERT INTO "__delta_diag_file" ("_sign", "_sequence", "file") SELECT -1, row_number() OVER () - 1, "file" FROM "diag_file" WHERE "__refcount" <= 0`, `DELETE FROM "diag_file" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_diag_file" ("_sign", "_sequence", "file") SELECT 1, row_number() OVER () - 1, n."file" FROM "__support_next_diag_file" n WHERE NOT EXISTS (SELECT 1 FROM "diag_file" h WHERE n."file" = h."file")`, `INSERT INTO "__frontier_diag_file" ("_phase", "_sequence", "file") SELECT ?, row_number() OVER () - 1, n."file" FROM "__support_next_diag_file" n WHERE NOT EXISTS (SELECT 1 FROM "diag_file" h WHERE n."file" = h."file")`, `INSERT INTO "__next_frontier_diag_file" ("_phase", "_sequence", "file") SELECT ?, row_number() OVER () - 1, n."file" FROM "__support_next_diag_file" n WHERE NOT EXISTS (SELECT 1 FROM "diag_file" h WHERE n."file" = h."file")`, `INSERT INTO "diag_file" ("file", "__refcount") SELECT n."file", n."__refcount" FROM "__support_next_diag_file" n WHERE NOT EXISTS (SELECT 1 FROM "diag_file" h WHERE n."file" = h."file")`], aggregateSql: null },
];
