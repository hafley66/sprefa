...
INSERT OR IGNORE INTO "repo_candidate" ("to_repo_id") SELECT b0."to_repo_id" FROM "pin_extracted" b0 WHERE NOT EXISTS (SELECT 1 FROM "known_repo" n0 WHERE n0."to_repo_id" = b0."to_repo_id")`, supportSql: [`DELETE FROM "__support_next_repo_candidate"`, `INSERT INTO "__support_next_repo_candidate" ("to_repo_id", "__refcount") SELECT "to_repo_id", sum("__refcount") FROM (SELECT b0."to_repo_id" AS "to_repo_id", count(*) AS "__refcount" FROM "pin_extracted" b0 WHERE NOT EXISTS (SELECT 1 FROM "known_repo" n0 WHERE n0."to_repo_id" = b0."to_repo_id") GROUP BY b0."to_repo_id") GROUP BY "to_repo_id"`, `UPDATE "repo_candidate" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_repo_candidate" n WHERE n."to_repo_id" = h."to_repo_id"), 0))`, `INSERT INTO "__delta_repo_candidate" ("_sign", "_sequence", "to_repo_id") SELECT -1, row_number() OVER () - 1, "to_repo_id" FROM "repo_candidate" WHERE "__refcount" <= 0`, `DELETE FROM "repo_candidate" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_repo_candidate" ("_sign", "_sequence", "to_repo_id") SELECT 1, row_number() OVER () - 1, n."to_repo_id" FROM "__support_next_repo_candidate" n WHERE NOT EXISTS (SELECT 1 FROM "repo_candidate" h WHERE n."to_repo_id" = h."to_repo_id")`, `INSERT INTO "__frontier_repo_candidate" ("_phase", "_sequence", "to_repo_id") SELECT ?, row_number() OVER () - 1, n."to_repo_id" FROM "__support_next_repo_candidate" n WHERE NOT EXISTS (SELECT 1 FROM "repo_candidate" h WHERE n."to_repo_id" = h."to_repo_id")`, `INSERT INTO "__next_frontier_repo_candidate" ("_phase", "_sequence", "to_repo_id") SELECT ?, row_number() OVER () - 1, n."to_repo_id" FROM "__support_next_repo_candidate" n WHERE NOT EXISTS (SELECT 1 FROM "repo_candidate" h WHERE n."to_repo_id" = h."to_repo_id")`, `INSERT INTO "repo_candidate" ("to_repo_id", "__refcount") SELECT n."to_repo_id", n."__refcount" FROM "__support_next_repo_candidate" n WHERE NOT EXISTS (SELECT 1 FROM "repo_candidate" h WHERE n."to_repo_id" = h."to_repo_id")`], aggregateSql: null },
];
