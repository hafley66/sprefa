...
const boot: readonly IBootStatement[] = [
  { sql: `INSERT OR IGNORE INTO "raw_doc" ("body") VALUES (?)`, params: ["{\"\":7,\"a\":8}"] },
  { sql: `DELETE FROM "pair"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "pair" ("name", "value") SELECT j0.key, j0.value FROM "raw_doc" b0, json_each(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.value IS NOT NULL`, params: [] },
];
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "pair", headDeltaTableName: "__delta_pair", headColumns: ["name", "value"], insertSql: `INSERT OR IGNORE INTO "pair" ("name", "value") SELECT DISTINCT j0.key, j0.value FROM "__frontier_raw_doc" d0, json_each(d0."body") j0 WHERE d0."_phase" >= 0 AND json_type(d0."body", '$') = 'object' AND j0.value IS NOT NULL RETURNING "name", "value"`, selectSql: `SELECT "name", "value" FROM "pair"`, recomputeSql: `DELETE FROM "pair";
