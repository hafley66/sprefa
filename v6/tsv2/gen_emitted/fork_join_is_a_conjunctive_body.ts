...
INSERT OR IGNORE INTO "combined" ("value_a", "value_b") SELECT b0."value_a", b1."value_b" FROM "result_a" b0, "result_b" b1`, supportSql: [`DELETE FROM "__support_next_combined"`, `INSERT INTO "__support_next_combined" ("value_a", "value_b", "__refcount") SELECT "value_a", "value_b", sum("__refcount") FROM (SELECT b0."value_a" AS "value_a", b1."value_b" AS "value_b", count(*) AS "__refcount" FROM "result_a" b0, "result_b" b1 GROUP BY b0."value_a", b1."value_b") GROUP BY "value_a", "value_b"`, `UPDATE "combined" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_combined" n WHERE n."value_a" = h."value_a" AND n."value_b" = h."value_b"), 0))`, `INSERT INTO "__delta_combined" ("_sign", "_sequence", "value_a", "value_b") SELECT -1, row_number() OVER () - 1, "value_a", "value_b" FROM "combined" WHERE "__refcount" <= 0`, `DELETE FROM "combined" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_combined" ("_sign", "_sequence", "value_a", "value_b") SELECT 1, row_number() OVER () - 1, n."value_a", n."value_b" FROM "__support_next_combined" n WHERE NOT EXISTS (SELECT 1 FROM "combined" h WHERE n."value_a" = h."value_a" AND n."value_b" = h."value_b")`, `INSERT INTO "__frontier_combined" ("_phase", "_sequence", "value_a", "value_b") SELECT ?, row_number() OVER () - 1, n."value_a", n."value_b" FROM "__support_next_combined" n WHERE NOT EXISTS (SELECT 1 FROM "combined" h WHERE n."value_a" = h."value_a" AND n."value_b" = h."value_b")`, `INSERT INTO "__next_frontier_combined" ("_phase", "_sequence", "value_a", "value_b") SELECT ?, row_number() OVER () - 1, n."value_a", n."value_b" FROM "__support_next_combined" n WHERE NOT EXISTS (SELECT 1 FROM "combined" h WHERE n."value_a" = h."value_a" AND n."value_b" = h."value_b")`, `INSERT INTO "combined" ("value_a", "value_b", "__refcount") SELECT n."value_a", n."value_b", n."__refcount" FROM "__support_next_combined" n WHERE NOT EXISTS (SELECT 1 FROM "combined" h WHERE n."value_a" = h."value_a" AND n."value_b" = h."value_b")`], aggregateSql: null },
];
