...
INSERT OR IGNORE INTO "demanded" ("target", "session_id") SELECT b0."target", b0."session_id" FROM "open_feed" b0`, supportSql: [`DELETE FROM "__support_next_demanded"`, `INSERT INTO "__support_next_demanded" ("target", "session_id", "__refcount") SELECT "target", "session_id", sum("__refcount") FROM (SELECT b0."target" AS "target", b0."session_id" AS "session_id", count(*) AS "__refcount" FROM "open_feed" b0 GROUP BY b0."target", b0."session_id") GROUP BY "target", "session_id"`, `UPDATE "demanded" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_demanded" n WHERE n."target" = h."target" AND n."session_id" = h."session_id"), 0))`, `INSERT INTO "__delta_demanded" ("_sign", "_sequence", "target", "session_id") SELECT -1, row_number() OVER () - 1, "target", "session_id" FROM "demanded" WHERE "__refcount" <= 0`, `DELETE FROM "demanded" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_demanded" ("_sign", "_sequence", "target", "session_id") SELECT 1, row_number() OVER () - 1, n."target", n."session_id" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."target" = h."target" AND n."session_id" = h."session_id")`, `INSERT INTO "__frontier_demanded" ("_phase", "_sequence", "target", "session_id") SELECT ?, row_number() OVER () - 1, n."target", n."session_id" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."target" = h."target" AND n."session_id" = h."session_id")`, `INSERT INTO "__next_frontier_demanded" ("_phase", "_sequence", "target", "session_id") SELECT ?, row_number() OVER () - 1, n."target", n."session_id" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."target" = h."target" AND n."session_id" = h."session_id")`, `INSERT INTO "demanded" ("target", "session_id", "__refcount") SELECT n."target", n."session_id", n."__refcount" FROM "__support_next_demanded" n WHERE NOT EXISTS (SELECT 1 FROM "demanded" h WHERE n."target" = h."target" AND n."session_id" = h."session_id")`], aggregateSql: null },
  { headRel: "effect_call", ruleId: "shared_demand_refcount:effect_call/1#1", headDeltaTableName: "__delta_effect_call", headColumns: ["target"], insertSql: `INSERT OR IGNORE INTO "effect_call" ("target") SELECT DISTINCT d0."target" FROM "__frontier_demanded" d0 WHERE d0."_phase" >= 0 RETURNING "target"`, selectSql: `SELECT "target" FROM "effect_call"`, recomputeSql: `DELETE FROM "effect_call";
INSERT OR IGNORE INTO "effect_call" ("target") SELECT b0."target" FROM "demanded" b0`, supportSql: [`DELETE FROM "__support_next_effect_call"`, `INSERT INTO "__support_next_effect_call" ("target", "__refcount") SELECT "target", sum("__refcount") FROM (SELECT b0."target" AS "target", count(*) AS "__refcount" FROM "demanded" b0 GROUP BY b0."target") GROUP BY "target"`, `UPDATE "effect_call" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_effect_call" n WHERE n."target" = h."target"), 0))`, `INSERT INTO "__delta_effect_call" ("_sign", "_sequence", "target") SELECT -1, row_number() OVER () - 1, "target" FROM "effect_call" WHERE "__refcount" <= 0`, `DELETE FROM "effect_call" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_effect_call" ("_sign", "_sequence", "target") SELECT 1, row_number() OVER () - 1, n."target" FROM "__support_next_effect_call" n WHERE NOT EXISTS (SELECT 1 FROM "effect_call" h WHERE n."target" = h."target")`, `INSERT INTO "__frontier_effect_call" ("_phase", "_sequence", "target") SELECT ?, row_number() OVER () - 1, n."target" FROM "__support_next_effect_call" n WHERE NOT EXISTS (SELECT 1 FROM "effect_call" h WHERE n."target" = h."target")`, `INSERT INTO "__next_frontier_effect_call" ("_phase", "_sequence", "target") SELECT ?, row_number() OVER () - 1, n."target" FROM "__support_next_effect_call" n WHERE NOT EXISTS (SELECT 1 FROM "effect_call" h WHERE n."target" = h."target")`, `INSERT INTO "effect_call" ("target", "__refcount") SELECT n."target", n."__refcount" FROM "__support_next_effect_call" n WHERE NOT EXISTS (SELECT 1 FROM "effect_call" h WHERE n."target" = h."target")`], aggregateSql: null },
];
