...
INSERT OR IGNORE INTO "flow_node_type" ("node", "path", "name", "ty") SELECT b2."node", b0."path", b0."name", b3."ty" FROM "sink_callee" b0, "type_owner" b1, "df_param" b2, "sig" b3 WHERE b1."path" = b0."path" AND b1."name" = b0."name" AND b2."path" = b0."path" AND b3."path" = b0."path" AND b3."owner_start" = b1."start" AND b3."owner_end" = b1."end" AND b3."slot" = 'param' AND b3."pos" = b2."pos"`, supportSql: [`DELETE FROM "__support_next_flow_node_type"`, `INSERT INTO "__support_next_flow_node_type" ("node", "path", "name", "ty", "__refcount") SELECT "node", "path", "name", "ty", sum("__refcount") FROM (SELECT b2."node" AS "node", b0."path" AS "path", b0."name" AS "name", b3."ty" AS "ty", count(*) AS "__refcount" FROM "sink_callee" b0, "type_owner" b1, "df_param" b2, "sig" b3 WHERE b1."path" = b0."path" AND b1."name" = b0."name" AND b2."path" = b0."path" AND b3."path" = b0."path" AND b3."owner_start" = b1."start" AND b3."owner_end" = b1."end" AND b3."slot" = 'param' AND b3."pos" = b2."pos" GROUP BY b2."node", b0."path", b0."name", b3."ty") GROUP BY "node", "path", "name", "ty"`, `UPDATE "flow_node_type" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_flow_node_type" n WHERE n."node" = h."node" AND n."path" = h."path" AND n."name" = h."name" AND n."ty" = h."ty"), 0))`, `INSERT INTO "__delta_flow_node_type" ("_sign", "_sequence", "node", "path", "name", "ty") SELECT -1, row_number() OVER () - 1, "node", "path", "name", "ty" FROM "flow_node_type" WHERE "__refcount" <= 0`, `DELETE FROM "flow_node_type" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_flow_node_type" ("_sign", "_sequence", "node", "path", "name", "ty") SELECT 1, row_number() OVER () - 1, n."node", n."path", n."name", n."ty" FROM "__support_next_flow_node_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_node_type" h WHERE n."node" = h."node" AND n."path" = h."path" AND n."name" = h."name" AND n."ty" = h."ty")`, `INSERT INTO "__frontier_flow_node_type" ("_phase", "_sequence", "node", "path", "name", "ty") SELECT ?, row_number() OVER () - 1, n."node", n."path", n."name", n."ty" FROM "__support_next_flow_node_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_node_type" h WHERE n."node" = h."node" AND n."path" = h."path" AND n."name" = h."name" AND n."ty" = h."ty")`, `INSERT INTO "__next_frontier_flow_node_type" ("_phase", "_sequence", "node", "path", "name", "ty") SELECT ?, row_number() OVER () - 1, n."node", n."path", n."name", n."ty" FROM "__support_next_flow_node_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_node_type" h WHERE n."node" = h."node" AND n."path" = h."path" AND n."name" = h."name" AND n."ty" = h."ty")`, `INSERT INTO "flow_node_type" ("node", "path", "name", "ty", "__refcount") SELECT n."node", n."path", n."name", n."ty", n."__refcount" FROM "__support_next_flow_node_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_node_type" h WHERE n."node" = h."node" AND n."path" = h."path" AND n."name" = h."name" AND n."ty" = h."ty")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "flow_param_type" ("path", "name", "pos", "ty") SELECT b0."path", b0."name", b2."pos", b2."ty" FROM "sink_callee" b0, "type_owner" b1, "sig" b2 WHERE b1."path" = b0."path" AND b1."name" = b0."name" AND b2."path" = b0."path" AND b2."owner_start" = b1."start" AND b2."owner_end" = b1."end" AND b2."slot" = 'param'`, supportSql: [`DELETE FROM "__support_next_flow_param_type"`, `INSERT INTO "__support_next_flow_param_type" ("path", "name", "pos", "ty", "__refcount") SELECT "path", "name", "pos", "ty", sum("__refcount") FROM (SELECT b0."path" AS "path", b0."name" AS "name", b2."pos" AS "pos", b2."ty" AS "ty", count(*) AS "__refcount" FROM "sink_callee" b0, "type_owner" b1, "sig" b2 WHERE b1."path" = b0."path" AND b1."name" = b0."name" AND b2."path" = b0."path" AND b2."owner_start" = b1."start" AND b2."owner_end" = b1."end" AND b2."slot" = 'param' GROUP BY b0."path", b0."name", b2."pos", b2."ty") GROUP BY "path", "name", "pos", "ty"`, `UPDATE "flow_param_type" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_flow_param_type" n WHERE n."path" = h."path" AND n."name" = h."name" AND n."pos" = h."pos" AND n."ty" = h."ty"), 0))`, `INSERT INTO "__delta_flow_param_type" ("_sign", "_sequence", "path", "name", "pos", "ty") SELECT -1, row_number() OVER () - 1, "path", "name", "pos", "ty" FROM "flow_param_type" WHERE "__refcount" <= 0`, `DELETE FROM "flow_param_type" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_flow_param_type" ("_sign", "_sequence", "path", "name", "pos", "ty") SELECT 1, row_number() OVER () - 1, n."path", n."name", n."pos", n."ty" FROM "__support_next_flow_param_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_param_type" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."pos" = h."pos" AND n."ty" = h."ty")`, `INSERT INTO "__frontier_flow_param_type" ("_phase", "_sequence", "path", "name", "pos", "ty") SELECT ?, row_number() OVER () - 1, n."path", n."name", n."pos", n."ty" FROM "__support_next_flow_param_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_param_type" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."pos" = h."pos" AND n."ty" = h."ty")`, `INSERT INTO "__next_frontier_flow_param_type" ("_phase", "_sequence", "path", "name", "pos", "ty") SELECT ?, row_number() OVER () - 1, n."path", n."name", n."pos", n."ty" FROM "__support_next_flow_param_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_param_type" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."pos" = h."pos" AND n."ty" = h."ty")`, `INSERT INTO "flow_param_type" ("path", "name", "pos", "ty", "__refcount") SELECT n."path", n."name", n."pos", n."ty", n."__refcount" FROM "__support_next_flow_param_type" n WHERE NOT EXISTS (SELECT 1 FROM "flow_param_type" h WHERE n."path" = h."path" AND n."name" = h."name" AND n."pos" = h."pos" AND n."ty" = h."ty")`], aggregateSql: null },
];
