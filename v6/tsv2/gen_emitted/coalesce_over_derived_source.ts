...
INSERT OR IGNORE INTO "heavy" ("tree_id", "kilos") SELECT b0."tree_id", b0."kilos" FROM "pick" b0 WHERE (b0."kilos" > 10)`, supportSql: [`DELETE FROM "__support_next_heavy"`, `INSERT INTO "__support_next_heavy" ("tree_id", "kilos", "__refcount") SELECT "tree_id", "kilos", sum("__refcount") FROM (SELECT b0."tree_id" AS "tree_id", b0."kilos" AS "kilos", count(*) AS "__refcount" FROM "pick" b0 WHERE (b0."kilos" > 10) GROUP BY b0."tree_id", b0."kilos") GROUP BY "tree_id", "kilos"`, `UPDATE "heavy" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_heavy" n WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos"), 0))`, `INSERT INTO "__delta_heavy" ("_sign", "_sequence", "tree_id", "kilos") SELECT -1, row_number() OVER () - 1, "tree_id", "kilos" FROM "heavy" WHERE "__refcount" <= 0`, `DELETE FROM "heavy" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_heavy" ("_sign", "_sequence", "tree_id", "kilos") SELECT 1, row_number() OVER () - 1, n."tree_id", n."kilos" FROM "__support_next_heavy" n WHERE NOT EXISTS (SELECT 1 FROM "heavy" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`, `INSERT INTO "__frontier_heavy" ("_phase", "_sequence", "tree_id", "kilos") SELECT ?, row_number() OVER () - 1, n."tree_id", n."kilos" FROM "__support_next_heavy" n WHERE NOT EXISTS (SELECT 1 FROM "heavy" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`, `INSERT INTO "__next_frontier_heavy" ("_phase", "_sequence", "tree_id", "kilos") SELECT ?, row_number() OVER () - 1, n."tree_id", n."kilos" FROM "__support_next_heavy" n WHERE NOT EXISTS (SELECT 1 FROM "heavy" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`, `INSERT INTO "heavy" ("tree_id", "kilos", "__refcount") SELECT n."tree_id", n."kilos", n."__refcount" FROM "__support_next_heavy" n WHERE NOT EXISTS (SELECT 1 FROM "heavy" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "report" ("tree_id", "kilos") SELECT b0."tree_id", 0 FROM "tree" b0 WHERE NOT EXISTS (SELECT 1 FROM "heavy" n0 WHERE n0."tree_id" = b0."tree_id")`, supportSql: [`DELETE FROM "__support_next_report"`, `INSERT INTO "__support_next_report" ("tree_id", "kilos", "__refcount") SELECT "tree_id", "kilos", sum("__refcount") FROM (SELECT b0."tree_id" AS "tree_id", b1."kilos" AS "kilos", count(*) AS "__refcount" FROM "tree" b0, "heavy" b1 WHERE b1."tree_id" = b0."tree_id" GROUP BY b0."tree_id", b1."kilos" UNION ALL SELECT b0."tree_id" AS "tree_id", 0 AS "kilos", count(*) AS "__refcount" FROM "tree" b0 WHERE NOT EXISTS (SELECT 1 FROM "heavy" n0 WHERE n0."tree_id" = b0."tree_id") GROUP BY b0."tree_id", (0 + 0)) GROUP BY "tree_id", "kilos"`, `UPDATE "report" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_report" n WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos"), 0))`, `INSERT INTO "__delta_report" ("_sign", "_sequence", "tree_id", "kilos") SELECT -1, row_number() OVER () - 1, "tree_id", "kilos" FROM "report" WHERE "__refcount" <= 0`, `DELETE FROM "report" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_report" ("_sign", "_sequence", "tree_id", "kilos") SELECT 1, row_number() OVER () - 1, n."tree_id", n."kilos" FROM "__support_next_report" n WHERE NOT EXISTS (SELECT 1 FROM "report" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`, `INSERT INTO "__frontier_report" ("_phase", "_sequence", "tree_id", "kilos") SELECT ?, row_number() OVER () - 1, n."tree_id", n."kilos" FROM "__support_next_report" n WHERE NOT EXISTS (SELECT 1 FROM "report" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`, `INSERT INTO "__next_frontier_report" ("_phase", "_sequence", "tree_id", "kilos") SELECT ?, row_number() OVER () - 1, n."tree_id", n."kilos" FROM "__support_next_report" n WHERE NOT EXISTS (SELECT 1 FROM "report" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`, `INSERT INTO "report" ("tree_id", "kilos", "__refcount") SELECT n."tree_id", n."kilos", n."__refcount" FROM "__support_next_report" n WHERE NOT EXISTS (SELECT 1 FROM "report" h WHERE n."tree_id" = h."tree_id" AND n."kilos" = h."kilos")`], aggregateSql: null },
];
