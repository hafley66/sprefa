...
const ddl: readonly string[] = [
  `CREATE TABLE "__host_demand_score" ("identity_digest" TEXT NOT NULL, "witness_digest" TEXT NOT NULL, "path" TEXT NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("identity_digest", "witness_digest", "path")) WITHOUT ROWID`,
  ...
  `CREATE TABLE "accepted" ("path" TEXT NOT NULL, "score" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("path", "score")) WITHOUT ROWID`,
  ...
  `CREATE TEMP TABLE "__support_next___host_demand_score" ("identity_digest" TEXT NOT NULL, "witness_digest" TEXT NOT NULL, "path" TEXT NOT NULL, "__refcount" INTEGER NOT NULL, PRIMARY KEY ("identity_digest", "witness_digest", "path")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__support_next_accepted" ("path" TEXT NOT NULL, "score" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL, PRIMARY KEY ("path", "score")) WITHOUT ROWID`,
];
...
const boot: readonly IBootStatement[] = [
  ...
  { rel: "__host_demand_score", sql: `INSERT OR IGNORE INTO "__host_demand_score" ("identity_digest", "witness_digest", "path") SELECT ('identity|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path"), ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path"), b0."path" FROM "input" b0`, params: [] },
  { rel: "accepted", sql: `DELETE FROM "accepted"`, params: [] },
  { rel: "accepted", sql: `INSERT OR IGNORE INTO "accepted" ("path", "score") SELECT b0."path", b1."score" FROM "input" b0, "__host_response_score" b1 WHERE b1."path" = b0."path" AND b1."witness_digest" = ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path") AND (b1."score" > 10)`, params: [] },
];
...
INSERT OR IGNORE INTO "__host_demand_score" ("identity_digest", "witness_digest", "path") SELECT ('identity|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path"), ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path"), b0."path" FROM "input" b0`, supportSql: [`DELETE FROM "__support_next___host_demand_score"`, `INSERT INTO "__support_next___host_demand_score" ("identity_digest", "witness_digest", "path", "__refcount") SELECT "identity_digest", "witness_digest", "path", sum("__refcount") FROM (SELECT ('identity|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path") AS "identity_digest", ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path") AS "witness_digest", b0."path" AS "path", count(*) AS "__refcount" FROM "input" b0 GROUP BY ('identity|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path"), ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path"), b0."path") GROUP BY "identity_digest", "witness_digest", "path"`, `UPDATE "__host_demand_score" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next___host_demand_score" n WHERE n."identity_digest" = h."identity_digest" AND n."witness_digest" = h."witness_digest" AND n."path" = h."path"), 0))`, `INSERT INTO "__delta___host_demand_score" ("_sign", "_sequence", "identity_digest", "witness_digest", "path") SELECT -1, row_number() OVER () - 1, "identity_digest", "witness_digest", "path" FROM "__host_demand_score" WHERE "__refcount" <= 0`, `DELETE FROM "__host_demand_score" WHERE "__refcount" <= 0`, `INSERT INTO "__delta___host_demand_score" ("_sign", "_sequence", "identity_digest", "witness_digest", "path") SELECT 1, row_number() OVER () - 1, n."identity_digest", n."witness_digest", n."path" FROM "__support_next___host_demand_score" n WHERE NOT EXISTS (SELECT 1 FROM "__host_demand_score" h WHERE n."identity_digest" = h."identity_digest" AND n."witness_digest" = h."witness_digest" AND n."path" = h."path")`, `INSERT INTO "__frontier___host_demand_score" ("_phase", "_sequence", "identity_digest", "witness_digest", "path") SELECT ?, row_number() OVER () - 1, n."identity_digest", n."witness_digest", n."path" FROM "__support_next___host_demand_score" n WHERE NOT EXISTS (SELECT 1 FROM "__host_demand_score" h WHERE n."identity_digest" = h."identity_digest" AND n."witness_digest" = h."witness_digest" AND n."path" = h."path")`, `INSERT INTO "__next_frontier___host_demand_score" ("_phase", "_sequence", "identity_digest", "witness_digest", "path") SELECT ?, row_number() OVER () - 1, n."identity_digest", n."witness_digest", n."path" FROM "__support_next___host_demand_score" n WHERE NOT EXISTS (SELECT 1 FROM "__host_demand_score" h WHERE n."identity_digest" = h."identity_digest" AND n."witness_digest" = h."witness_digest" AND n."path" = h."path")`, `INSERT INTO "__host_demand_score" ("identity_digest", "witness_digest", "path", "__refcount") SELECT n."identity_digest", n."witness_digest", n."path", n."__refcount" FROM "__support_next___host_demand_score" n WHERE NOT EXISTS (SELECT 1 FROM "__host_demand_score" h WHERE n."identity_digest" = h."identity_digest" AND n."witness_digest" = h."witness_digest" AND n."path" = h."path")`], aggregateSql: null },
...
INSERT OR IGNORE INTO "accepted" ("path", "score") SELECT b0."path", b1."score" FROM "input" b0, "__host_response_score" b1 WHERE b1."path" = b0."path" AND b1."witness_digest" = ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path") AND (b1."score" > 10)`, supportSql: [`DELETE FROM "__support_next_accepted"`, `INSERT INTO "__support_next_accepted" ("path", "score", "__refcount") SELECT "path", "score", sum("__refcount") FROM (SELECT b0."path" AS "path", b1."score" AS "score", count(*) AS "__refcount" FROM "input" b0, "__host_response_score" b1 WHERE b1."path" = b0."path" AND b1."witness_digest" = ('witness|score' || '|' || 'path' || ':' || 'text' || '=' || b0."path") AND (b1."score" > 10) GROUP BY b0."path", b1."score") GROUP BY "path", "score"`, `UPDATE "accepted" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_accepted" n WHERE n."path" = h."path" AND n."score" = h."score"), 0))`, `INSERT INTO "__delta_accepted" ("_sign", "_sequence", "path", "score") SELECT -1, row_number() OVER () - 1, "path", "score" FROM "accepted" WHERE "__refcount" <= 0`, `DELETE FROM "accepted" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_accepted" ("_sign", "_sequence", "path", "score") SELECT 1, row_number() OVER () - 1, n."path", n."score" FROM "__support_next_accepted" n WHERE NOT EXISTS (SELECT 1 FROM "accepted" h WHERE n."path" = h."path" AND n."score" = h."score")`, `INSERT INTO "__frontier_accepted" ("_phase", "_sequence", "path", "score") SELECT ?, row_number() OVER () - 1, n."path", n."score" FROM "__support_next_accepted" n WHERE NOT EXISTS (SELECT 1 FROM "accepted" h WHERE n."path" = h."path" AND n."score" = h."score")`, `INSERT INTO "__next_frontier_accepted" ("_phase", "_sequence", "path", "score") SELECT ?, row_number() OVER () - 1, n."path", n."score" FROM "__support_next_accepted" n WHERE NOT EXISTS (SELECT 1 FROM "accepted" h WHERE n."path" = h."path" AND n."score" = h."score")`, `INSERT INTO "accepted" ("path", "score", "__refcount") SELECT n."path", n."score", n."__refcount" FROM "__support_next_accepted" n WHERE NOT EXISTS (SELECT 1 FROM "accepted" h WHERE n."path" = h."path" AND n."score" = h."score")`], aggregateSql: null },
];
