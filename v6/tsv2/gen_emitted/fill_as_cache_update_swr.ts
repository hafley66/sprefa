...
INSERT OR IGNORE INTO "feed_view" ("target", "body") SELECT b0."target", b1."body" FROM "demanded" b0, "cache_row" b1 WHERE b1."target" = b0."target"`, supportSql: [`DELETE FROM "__support_next_feed_view"`, `INSERT INTO "__support_next_feed_view" ("target", "body", "__refcount") SELECT "target", "body", sum("__refcount") FROM (SELECT b0."target" AS "target", b1."body" AS "body", count(*) AS "__refcount" FROM "demanded" b0, "cache_row" b1 WHERE b1."target" = b0."target" GROUP BY b0."target", b1."body") GROUP BY "target", "body"`, `UPDATE "feed_view" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_feed_view" n WHERE n."target" = h."target" AND n."body" = h."body"), 0))`, `INSERT INTO "__delta_feed_view" ("_sign", "_sequence", "target", "body") SELECT -1, row_number() OVER () - 1, "target", "body" FROM "feed_view" WHERE "__refcount" <= 0`, `DELETE FROM "feed_view" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_feed_view" ("_sign", "_sequence", "target", "body") SELECT 1, row_number() OVER () - 1, n."target", n."body" FROM "__support_next_feed_view" n WHERE NOT EXISTS (SELECT 1 FROM "feed_view" h WHERE n."target" = h."target" AND n."body" = h."body")`, `INSERT INTO "__frontier_feed_view" ("_phase", "_sequence", "target", "body") SELECT ?, row_number() OVER () - 1, n."target", n."body" FROM "__support_next_feed_view" n WHERE NOT EXISTS (SELECT 1 FROM "feed_view" h WHERE n."target" = h."target" AND n."body" = h."body")`, `INSERT INTO "__next_frontier_feed_view" ("_phase", "_sequence", "target", "body") SELECT ?, row_number() OVER () - 1, n."target", n."body" FROM "__support_next_feed_view" n WHERE NOT EXISTS (SELECT 1 FROM "feed_view" h WHERE n."target" = h."target" AND n."body" = h."body")`, `INSERT INTO "feed_view" ("target", "body", "__refcount") SELECT n."target", n."body", n."__refcount" FROM "__support_next_feed_view" n WHERE NOT EXISTS (SELECT 1 FROM "feed_view" h WHERE n."target" = h."target" AND n."body" = h."body")`], aggregateSql: null },
];
