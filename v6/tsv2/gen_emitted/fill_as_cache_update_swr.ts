...
function readSnapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    cache_row: selectRows(seam, `SELECT CASE WHEN json_valid("target") AND json_type("target") = 'object' THEN json_extract("target", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("target", '$.args')) || ')' ELSE "target" END AS "target", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body" FROM "cache_row"`, relColumns.cache_row!, relColumnTypes.cache_row!),
    ...
    feed_view: selectRows(seam, `SELECT CASE WHEN json_valid("target") AND json_type("target") = 'object' THEN json_extract("target", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("target", '$.args')) || ')' ELSE "target" END AS "target", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body" FROM "feed_view"`, relColumns.feed_view!, relColumnTypes.feed_view!),
    ...
    open_feed: selectRows(seam, `SELECT CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", CASE WHEN json_valid("target") AND json_type("target") = 'object' THEN json_extract("target", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("target", '$.args')) || ')' ELSE "target" END AS "target" FROM "open_feed"`, relColumns.open_feed!, relColumnTypes.open_feed!),
  });
}
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "cache_row", kind: "set", tableName: "cache_row", deltaTableName: "__delta_cache_row", frontierTableName: "__frontier_cache_row", nextFrontierTableName: "__next_frontier_cache_row", columns: ["target", "body"], columnTypes: ["text", "text"], keyIndices: [0], arrivalAddSql: null, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("target") AND json_type("target") = 'object' THEN json_extract("target", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("target", '$.args')) || ')' ELSE "target" END AS "target", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_cache_row" WHERE "_sign" IN (-1, 1) GROUP BY "target", "body", "_sign"` },
  ...
  { rel: "feed_view", kind: "set", tableName: "feed_view", deltaTableName: "__delta_feed_view", frontierTableName: "__frontier_feed_view", nextFrontierTableName: "__next_frontier_feed_view", columns: ["target", "body"], columnTypes: ["text", "text"], keyIndices: [], arrivalAddSql: null, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("target") AND json_type("target") = 'object' THEN json_extract("target", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("target", '$.args')) || ')' ELSE "target" END AS "target", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_feed_view" WHERE "_sign" IN (-1, 1) GROUP BY "target", "body", "_sign"` },
  { rel: "fill_arrived", kind: "log", tableName: "fill_arrived", deltaTableName: "__delta_fill_arrived", frontierTableName: "__frontier_fill_arrived", nextFrontierTableName: "__next_frontier_fill_arrived", columns: ["target", "body"], columnTypes: ["text", "text"], keyIndices: [], arrivalAddSql: `INSERT INTO "fill_arrived" ("target", "body") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "target", "body"`, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("target") AND json_type("target") = 'object' THEN json_extract("target", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("target", '$.args')) || ')' ELSE "target" END AS "target", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_fill_arrived" WHERE "_sign" IN (-1, 1) GROUP BY "target", "body", "_sign"` },
