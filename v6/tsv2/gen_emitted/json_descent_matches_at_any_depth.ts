...
INSERT OR IGNORE INTO "image" ("repository", "tag") SELECT json_extract(j0.value, '$."image"."repository"'), json_extract(j0.value, '$."image"."tag"') FROM "chart" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_type(j0.value, '$."image"') = 'object' AND json_extract(j0.value, '$."image"."repository"') IS NOT NULL AND json_extract(j0.value, '$."image"."tag"') IS NOT NULL`, supportSql: [`DELETE FROM "__support_next_image"`, `INSERT INTO "__support_next_image" ("repository", "tag", "__refcount") SELECT "repository", "tag", sum("__refcount") FROM (SELECT json_extract(j0.value, '$."image"."repository"') AS "repository", json_extract(j0.value, '$."image"."tag"') AS "tag", count(*) AS "__refcount" FROM "chart" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_type(j0.value, '$."image"') = 'object' AND json_extract(j0.value, '$."image"."repository"') IS NOT NULL AND json_extract(j0.value, '$."image"."tag"') IS NOT NULL GROUP BY json_extract(j0.value, '$."image"."repository"'), json_extract(j0.value, '$."image"."tag"')) GROUP BY "repository", "tag"`, `UPDATE "image" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_image" n WHERE n."repository" = h."repository" AND n."tag" = h."tag"), 0))`, `INSERT INTO "__delta_image" ("_sign", "_sequence", "repository", "tag") SELECT -1, row_number() OVER () - 1, "repository", "tag" FROM "image" WHERE "__refcount" <= 0`, `DELETE FROM "image" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_image" ("_sign", "_sequence", "repository", "tag") SELECT 1, row_number() OVER () - 1, n."repository", n."tag" FROM "__support_next_image" n WHERE NOT EXISTS (SELECT 1 FROM "image" h WHERE n."repository" = h."repository" AND n."tag" = h."tag")`, `INSERT INTO "__frontier_image" ("_phase", "_sequence", "repository", "tag") SELECT ?, row_number() OVER () - 1, n."repository", n."tag" FROM "__support_next_image" n WHERE NOT EXISTS (SELECT 1 FROM "image" h WHERE n."repository" = h."repository" AND n."tag" = h."tag")`, `INSERT INTO "__next_frontier_image" ("_phase", "_sequence", "repository", "tag") SELECT ?, row_number() OVER () - 1, n."repository", n."tag" FROM "__support_next_image" n WHERE NOT EXISTS (SELECT 1 FROM "image" h WHERE n."repository" = h."repository" AND n."tag" = h."tag")`, `INSERT INTO "image" ("repository", "tag", "__refcount") SELECT n."repository", n."tag", n."__refcount" FROM "__support_next_image" n WHERE NOT EXISTS (SELECT 1 FROM "image" h WHERE n."repository" = h."repository" AND n."tag" = h."tag")`], aggregateSql: null },
];
