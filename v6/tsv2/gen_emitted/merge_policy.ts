...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "close_request", kind: "log", tableName: "close_request", deltaTableName: "__delta_close_request", columns: ["session_id", "tab_id"], arrivalAddSql: `INSERT INTO "close_request" ("session_id", "tab_id") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "session_id", "tab_id"`, boundarySql: `SELECT CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_close_request" WHERE "_sign" IN (-1, 1) GROUP BY "session_id", "tab_id", "_sign"` },
  { rel: "closed", kind: "log", tableName: "closed", deltaTableName: "__delta_closed", columns: ["session_id", "tab_id"], arrivalAddSql: null, boundarySql: `SELECT CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_closed" WHERE "_sign" IN (-1, 1) GROUP BY "session_id", "tab_id", "_sign"` },
  { rel: "demanded", kind: "set", tableName: "demanded", deltaTableName: "__delta_demanded", columns: ["col1", "session_id"], arrivalAddSql: null, boundarySql: `SELECT CASE WHEN json_valid("col1") AND json_type("col1") = 'object' THEN json_extract("col1", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("col1", '$.args')) || ')' ELSE "col1" END AS "col1", CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_demanded" WHERE "_sign" IN (-1, 1) GROUP BY "col1", "session_id", "_sign"` },
  { rel: "live_tab", kind: "set", tableName: "live_tab", deltaTableName: "__delta_live_tab", columns: ["session_id", "tab_id"], arrivalAddSql: null, boundarySql: `SELECT CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_live_tab" WHERE "_sign" IN (-1, 1) GROUP BY "session_id", "tab_id", "_sign"` },
  { rel: "open_request", kind: "log", tableName: "open_request", deltaTableName: "__delta_open_request", columns: ["session_id", "tab_id"], arrivalAddSql: `INSERT INTO "open_request" ("session_id", "tab_id") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "session_id", "tab_id"`, boundarySql: `SELECT CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_open_request" WHERE "_sign" IN (-1, 1) GROUP BY "session_id", "tab_id", "_sign"` },
  { rel: "open_tab", kind: "set", tableName: "open_tab", deltaTableName: "__delta_open_tab", columns: ["session_id", "tab_id"], arrivalAddSql: null, boundarySql: `SELECT CASE WHEN json_valid("session_id") AND json_type("session_id") = 'object' THEN json_extract("session_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("session_id", '$.args')) || ')' ELSE "session_id" END AS "session_id", CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_open_tab" WHERE "_sign" IN (-1, 1) GROUP BY "session_id", "tab_id", "_sign"` },
  { rel: "tab_row", kind: "set", tableName: "tab_row", deltaTableName: "__delta_tab_row", columns: ["tab_id", "body"], arrivalAddSql: `INSERT OR IGNORE INTO "tab_row" ("tab_id", "body") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "tab_id", "body"`, boundarySql: `SELECT CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_tab_row" WHERE "_sign" IN (-1, 1) GROUP BY "tab_id", "body", "_sign"` },
  { rel: "tab_view", kind: "set", tableName: "tab_view", deltaTableName: "__delta_tab_view", columns: ["tab_id", "body"], arrivalAddSql: null, boundarySql: `SELECT CASE WHEN json_valid("tab_id") AND json_type("tab_id") = 'object' THEN json_extract("tab_id", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("tab_id", '$.args')) || ')' ELSE "tab_id" END AS "tab_id", CASE WHEN json_valid("body") AND json_type("body") = 'object' THEN json_extract("body", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("body", '$.args')) || ')' ELSE "body" END AS "body", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_tab_view" WHERE "_sign" IN (-1, 1) GROUP BY "tab_id", "body", "_sign"` },
];

const INCREMENTAL_EDGE_STATEMENTS: readonly IIncrementalEdgeStatement[] = [
  { headRel: "open_tab", headKind: "set", headTableName: "open_tab", headDeltaTableName: "__delta_open_tab", headColumns: ["session_id", "tab_id"], keyIndices: [0, 1], projectSql: `SELECT d0."session_id" AS "session_id", d0."tab_id" AS "tab_id" FROM "__delta_open_request" d0 WHERE d0."_sign" = 1 ORDER BY d0."_sequence"` },
  { headRel: "closed", headKind: "log", headTableName: "closed", headDeltaTableName: "__delta_closed", headColumns: ["session_id", "tab_id"], keyIndices: [], projectSql: `SELECT d0."session_id" AS "session_id", d0."tab_id" AS "tab_id" FROM "__delta_close_request" d0 WHERE d0."_sign" = 1 ORDER BY d0."_sequence"` },
];

const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "live_tab", headDeltaTableName: "__delta_live_tab", headColumns: ["session_id", "tab_id"], insertSql: `INSERT OR IGNORE INTO "live_tab" ("session_id", "tab_id") SELECT DISTINCT d0."session_id", d0."tab_id" FROM "__delta_open_tab" d0 WHERE d0."_sign" = 1 AND NOT EXISTS (SELECT 1 FROM "closed" n0 WHERE n0."session_id" = d0."session_id" AND n0."tab_id" = d0."tab_id") RETURNING "session_id", "tab_id"` },
  { headRel: "demanded", headDeltaTableName: "__delta_demanded", headColumns: ["col1", "session_id"], insertSql: `INSERT OR IGNORE INTO "demanded" ("col1", "session_id") SELECT DISTINCT json_object('fn', 'tab', 'args', json_array(d0."tab_id")), d0."session_id" FROM "__delta_live_tab" d0 WHERE d0."_sign" = 1 RETURNING "col1", "session_id"` },
  { headRel: "tab_view", headDeltaTableName: "__delta_tab_view", headColumns: ["tab_id", "body"], insertSql: `INSERT OR IGNORE INTO "tab_view" ("tab_id", "body") SELECT DISTINCT json_extract(d0."col1", '$.args[0]'), b0."body" FROM "__delta_demanded" d0, "tab_row" b0 WHERE d0."_sign" = 1 AND json_extract(d0."col1", '$.fn') = 'tab' AND b0."tab_id" = json_extract(d0."col1", '$.args[0]') UNION ALL SELECT DISTINCT d0."tab_id", d0."body" FROM "__delta_tab_row" d0, "demanded" b0 WHERE d0."_sign" = 1 AND json_extract(b0."col1", '$.fn') = 'tab' AND json_extract(b0."col1", '$.args[0]') = d0."tab_id" RETURNING "tab_id", "body"` },
];
...
function runIncrementalTick(seam: ISqlSeam, arrivals: IArrivalBatch): Observable<ITickDeltas> {
  return IncrementalRuntime.clearDeltas(seam, INCREMENTAL_RELATIONS).pipe(
    ...
    map((rels): ITickDeltas => ({
      rels,
      carryPending: rels.some((delta) => ["closed", "open_tab"].includes(delta.rel) && (delta.add.length > 0 || delta.del.length > 0)),
    })),
  );
}
