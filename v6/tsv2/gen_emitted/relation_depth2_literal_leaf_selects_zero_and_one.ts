...
const boot: readonly IBootStatement[] = [
  ...
  { rel: "hit", sql: `INSERT OR IGNORE INTO "hit" ("start") SELECT b0."start" FROM "span" b0, "__ref_repo" b1, "__ref_file" b2 WHERE b1."name" = 'acme' AND b2."__id" = b0."file" AND b2."repo" = b1."__id"`, params: [] },
  { rel: "miss", sql: `DELETE FROM "miss"`, params: [] },
  { rel: "miss", sql: `INSERT OR IGNORE INTO "miss" ("start") SELECT b0."start" FROM "span" b0, "__ref_repo" b1, "__ref_file" b2 WHERE b1."name" = 'globex' AND b2."__id" = b0."file" AND b2."repo" = b1."__id"`, params: [] },
];
...
INSERT OR IGNORE INTO "span" ("file", "start", "end") SELECT b1."__id", b0."start", b0."end" FROM "raw" b0, "file" b1, "__ref_repo" b2, "__ref_fpath" b3 WHERE b2."__id" = b1."repo" AND b2."name" = b0."repo_name" AND b3."__id" = b1."at" AND b3."name" = b0."path_name"`, supportSql: [`DELETE FROM "__support_next_span"`, `INSERT INTO "__support_next_span" ("file", "start", "end", "__refcount") SELECT "file", "start", "end", sum("__refcount") FROM (SELECT b1."__id" AS "file", b0."start" AS "start", b0."end" AS "end", count(*) AS "__refcount" FROM "raw" b0, "file" b1, "__ref_repo" b2, "__ref_fpath" b3 WHERE b2."__id" = b1."repo" AND b2."name" = b0."repo_name" AND b3."__id" = b1."at" AND b3."name" = b0."path_name" GROUP BY b1."__id", b0."start", b0."end") GROUP BY "file", "start", "end"`, `UPDATE "span" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_span" n WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end"), 0))`, `INSERT INTO "__delta_span" ("_sign", "_sequence", "file", "start", "end") SELECT -1, row_number() OVER () - 1, "file", "start", "end" FROM "span" WHERE "__refcount" <= 0`, `DELETE FROM "span" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_span" ("_sign", "_sequence", "file", "start", "end") SELECT 1, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__frontier_span" ("_phase", "_sequence", "file", "start", "end") SELECT ?, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "__next_frontier_span" ("_phase", "_sequence", "file", "start", "end") SELECT ?, row_number() OVER () - 1, n."file", n."start", n."end" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`, `INSERT INTO "span" ("file", "start", "end", "__refcount") SELECT n."file", n."start", n."end", n."__refcount" FROM "__support_next_span" n WHERE NOT EXISTS (SELECT 1 FROM "span" h WHERE n."file" = h."file" AND n."start" = h."start" AND n."end" = h."end")`], aggregateSql: null },
  { headRel: "hit", ruleId: "relation_depth2_literal_leaf_selects_zero_and_one:hit/1#1", headDeltaTableName: "__delta_hit", headColumns: ["start"], insertSql: `INSERT OR IGNORE INTO "hit" ("start") SELECT DISTINCT d0."start" FROM "__frontier_span" d0, "__ref_repo" b0, "__ref_file" b1 WHERE d0."_phase" >= 0 AND b0."name" = 'acme' AND b1."__id" = d0."file" AND b1."repo" = b0."__id" RETURNING "start"`, selectSql: `SELECT "start" FROM "hit"`, recomputeSql: `DELETE FROM "hit";
INSERT OR IGNORE INTO "hit" ("start") SELECT b0."start" FROM "span" b0, "__ref_repo" b1, "__ref_file" b2 WHERE b1."name" = 'acme' AND b2."__id" = b0."file" AND b2."repo" = b1."__id"`, supportSql: [`DELETE FROM "__support_next_hit"`, `INSERT INTO "__support_next_hit" ("start", "__refcount") SELECT "start", sum("__refcount") FROM (SELECT b0."start" AS "start", count(*) AS "__refcount" FROM "span" b0, "__ref_repo" b1, "__ref_file" b2 WHERE b1."name" = 'acme' AND b2."__id" = b0."file" AND b2."repo" = b1."__id" GROUP BY b0."start") GROUP BY "start"`, `UPDATE "hit" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_hit" n WHERE n."start" = h."start"), 0))`, `INSERT INTO "__delta_hit" ("_sign", "_sequence", "start") SELECT -1, row_number() OVER () - 1, "start" FROM "hit" WHERE "__refcount" <= 0`, `DELETE FROM "hit" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_hit" ("_sign", "_sequence", "start") SELECT 1, row_number() OVER () - 1, n."start" FROM "__support_next_hit" n WHERE NOT EXISTS (SELECT 1 FROM "hit" h WHERE n."start" = h."start")`, `INSERT INTO "__frontier_hit" ("_phase", "_sequence", "start") SELECT ?, row_number() OVER () - 1, n."start" FROM "__support_next_hit" n WHERE NOT EXISTS (SELECT 1 FROM "hit" h WHERE n."start" = h."start")`, `INSERT INTO "__next_frontier_hit" ("_phase", "_sequence", "start") SELECT ?, row_number() OVER () - 1, n."start" FROM "__support_next_hit" n WHERE NOT EXISTS (SELECT 1 FROM "hit" h WHERE n."start" = h."start")`, `INSERT INTO "hit" ("start", "__refcount") SELECT n."start", n."__refcount" FROM "__support_next_hit" n WHERE NOT EXISTS (SELECT 1 FROM "hit" h WHERE n."start" = h."start")`], aggregateSql: null },
  { headRel: "miss", ruleId: "relation_depth2_literal_leaf_selects_zero_and_one:miss/1#1", headDeltaTableName: "__delta_miss", headColumns: ["start"], insertSql: `INSERT OR IGNORE INTO "miss" ("start") SELECT DISTINCT d0."start" FROM "__frontier_span" d0, "__ref_repo" b0, "__ref_file" b1 WHERE d0."_phase" >= 0 AND b0."name" = 'globex' AND b1."__id" = d0."file" AND b1."repo" = b0."__id" RETURNING "start"`, selectSql: `SELECT "start" FROM "miss"`, recomputeSql: `DELETE FROM "miss";
INSERT OR IGNORE INTO "miss" ("start") SELECT b0."start" FROM "span" b0, "__ref_repo" b1, "__ref_file" b2 WHERE b1."name" = 'globex' AND b2."__id" = b0."file" AND b2."repo" = b1."__id"`, supportSql: [`DELETE FROM "__support_next_miss"`, `INSERT INTO "__support_next_miss" ("start", "__refcount") SELECT "start", sum("__refcount") FROM (SELECT b0."start" AS "start", count(*) AS "__refcount" FROM "span" b0, "__ref_repo" b1, "__ref_file" b2 WHERE b1."name" = 'globex' AND b2."__id" = b0."file" AND b2."repo" = b1."__id" GROUP BY b0."start") GROUP BY "start"`, `UPDATE "miss" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_miss" n WHERE n."start" = h."start"), 0))`, `INSERT INTO "__delta_miss" ("_sign", "_sequence", "start") SELECT -1, row_number() OVER () - 1, "start" FROM "miss" WHERE "__refcount" <= 0`, `DELETE FROM "miss" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_miss" ("_sign", "_sequence", "start") SELECT 1, row_number() OVER () - 1, n."start" FROM "__support_next_miss" n WHERE NOT EXISTS (SELECT 1 FROM "miss" h WHERE n."start" = h."start")`, `INSERT INTO "__frontier_miss" ("_phase", "_sequence", "start") SELECT ?, row_number() OVER () - 1, n."start" FROM "__support_next_miss" n WHERE NOT EXISTS (SELECT 1 FROM "miss" h WHERE n."start" = h."start")`, `INSERT INTO "__next_frontier_miss" ("_phase", "_sequence", "start") SELECT ?, row_number() OVER () - 1, n."start" FROM "__support_next_miss" n WHERE NOT EXISTS (SELECT 1 FROM "miss" h WHERE n."start" = h."start")`, `INSERT INTO "miss" ("start", "__refcount") SELECT n."start", n."__refcount" FROM "__support_next_miss" n WHERE NOT EXISTS (SELECT 1 FROM "miss" h WHERE n."start" = h."start")`], aggregateSql: null },
];
