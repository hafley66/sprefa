...
INSERT OR IGNORE INTO "changed_since" ("turn_id", "path") SELECT b0."turn_id", b1."path" FROM "agent_turn" b0, "change_event" b1 WHERE (b1."tick" > b0."tick")`, supportSql: [`DELETE FROM "__support_next_changed_since"`, `INSERT INTO "__support_next_changed_since" ("turn_id", "path", "__refcount") SELECT "turn_id", "path", sum("__refcount") FROM (SELECT b0."turn_id" AS "turn_id", b1."path" AS "path", count(*) AS "__refcount" FROM "agent_turn" b0, "change_event" b1 WHERE (b1."tick" > b0."tick") GROUP BY b0."turn_id", b1."path") GROUP BY "turn_id", "path"`, `UPDATE "changed_since" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_changed_since" n WHERE n."turn_id" = h."turn_id" AND n."path" = h."path"), 0))`, `INSERT INTO "__delta_changed_since" ("_sign", "_sequence", "turn_id", "path") SELECT -1, row_number() OVER () - 1, "turn_id", "path" FROM "changed_since" WHERE "__refcount" <= 0`, `DELETE FROM "changed_since" WHERE "__refcount" <= 0`, `INSERT INTO "__delta_changed_since" ("_sign", "_sequence", "turn_id", "path") SELECT 1, row_number() OVER () - 1, n."turn_id", n."path" FROM "__support_next_changed_since" n WHERE NOT EXISTS (SELECT 1 FROM "changed_since" h WHERE n."turn_id" = h."turn_id" AND n."path" = h."path")`, `INSERT INTO "__frontier_changed_since" ("_phase", "_sequence", "turn_id", "path") SELECT ?, row_number() OVER () - 1, n."turn_id", n."path" FROM "__support_next_changed_since" n WHERE NOT EXISTS (SELECT 1 FROM "changed_since" h WHERE n."turn_id" = h."turn_id" AND n."path" = h."path")`, `INSERT INTO "__next_frontier_changed_since" ("_phase", "_sequence", "turn_id", "path") SELECT ?, row_number() OVER () - 1, n."turn_id", n."path" FROM "__support_next_changed_since" n WHERE NOT EXISTS (SELECT 1 FROM "changed_since" h WHERE n."turn_id" = h."turn_id" AND n."path" = h."path")`, `INSERT INTO "changed_since" ("turn_id", "path", "__refcount") SELECT n."turn_id", n."path", n."__refcount" FROM "__support_next_changed_since" n WHERE NOT EXISTS (SELECT 1 FROM "changed_since" h WHERE n."turn_id" = h."turn_id" AND n."path" = h."path")`], aggregateSql: null },
];
