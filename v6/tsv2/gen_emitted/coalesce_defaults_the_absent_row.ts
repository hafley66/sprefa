...
const relCatalog: readonly IRelCatalogRow[] = [
  ...
  { relId: 6, parentId: 0, ordinal: 0, localName: "coalesce_defaults_the_absent_row", kind: "module", typeId: 0, arity: 0, moduleId: 6, hId: "493f644239a2dcce", hSchema: "", hRule: "" },
  { relId: 7, parentId: 6, ordinal: 0, localName: "latest_commit", kind: "rel", typeId: 0, arity: 2, moduleId: 6, hId: "d86ea41331bdc334", hSchema: "d4f3566ce68ea8d7", hRule: "" },
  { relId: 8, parentId: 7, ordinal: 1, localName: "name", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "ff171c27c95504d3", hSchema: "", hRule: "" },
  { relId: 9, parentId: 7, ordinal: 2, localName: "commit", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "6676d8bcfb330f05", hSchema: "", hRule: "" },
  { relId: 10, parentId: 6, ordinal: 0, localName: "repo", kind: "rel", typeId: 0, arity: 1, moduleId: 6, hId: "fb5bf5637a400c6d", hSchema: "a30b139c04a632dd", hRule: "" },
  { relId: 11, parentId: 10, ordinal: 1, localName: "name", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "59120e6a2953bf7c", hSchema: "", hRule: "" },
  { relId: 12, parentId: 6, ordinal: 0, localName: "repo_latest", kind: "rel", typeId: 0, arity: 2, moduleId: 6, hId: "7bbdefbd11ede7d6", hSchema: "d4f3566ce68ea8d7", hRule: "652d04bf16c0b121" },
  { relId: 13, parentId: 12, ordinal: 1, localName: "name", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "c53bf22b20321ba1", hSchema: "", hRule: "" },
  { relId: 14, parentId: 12, ordinal: 2, localName: "commit", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "f3e7cf27cef9963c", hSchema: "", hRule: "" },
];
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "repo_latest", ruleId: "coalesce_defaults_the_absent_row:repo_latest/2#1", headDeltaTableName: "__delta_repo_latest", headColumns: ["name", "commit"], insertSql: `INSERT OR IGNORE INTO "repo_latest" ("name", "commit") SELECT DISTINCT d0."name", b0."commit" FROM "__frontier_repo" d0, "latest_commit" b0 WHERE d0."_phase" >= 0 AND b0."name" = d0."name" UNION ALL SELECT DISTINCT d0."name", d0."commit" FROM "__frontier_latest_commit" d0, "repo" b0 WHERE d0."_phase" >= 0 AND b0."name" = d0."name" UNION ALL SELECT DISTINCT d0."name", 'absent' FROM "__frontier_repo" d0 WHERE d0."_phase" >= 0 AND NOT EXISTS (SELECT 1 FROM "latest_commit" n0 WHERE n0."name" = d0."name") RETURNING "name", "commit"`, selectSql: `SELECT "name", "commit" FROM "repo_latest"`, recomputeSql: `DELETE FROM "repo_latest";
