...
PROGRAM="$GOLDEN_DIR/0_ghcacher_304_golden.dl6"
...
WORK_DIR="$(mktemp -d "$TSV2_DIR/.ghcacher-304-golden.XXXXXX")"
GENERATED="$WORK_DIR/ghcacher_304_golden.ts"
...
printf 'GHCACHER_304_GOLDEN_HOLDS ticks=6 final=1\n'
