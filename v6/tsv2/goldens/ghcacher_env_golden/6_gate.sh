...
PROGRAM="$GOLDEN_DIR/0_ghcacher_env_golden.dl6"
...
WORK_DIR="$(mktemp -d "$TSV2_DIR/.ghcacher-env-golden.XXXXXX")"
GENERATED="$WORK_DIR/ghcacher_env_golden.ts"
...
printf 'GHCACHER_ENV_GOLDEN_HOLDS ticks=5 final=1\n'
