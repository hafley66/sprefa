...
PROGRAM="$GOLDEN_DIR/0_ghcacher_config_golden.dl6"
...
WORK_DIR="$(mktemp -d "$TSV2_DIR/.ghcacher-config-golden.XXXXXX")"
GENERATED="$WORK_DIR/ghcacher_config_golden.ts"
...
printf 'GHCACHER_CONFIG_GOLDEN_HOLDS ticks=8 final=1\n'
