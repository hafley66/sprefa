...
expand_program_run(Door, SurfaceProgram0, Bindings, ExpandedProgram,
    ...
    run_compile_step(plan, expansion:refresh_relation_type_decls,
                     dot_expand:refresh_relation_type_decls(PhasedProgram,
                                                            MirroredProgram), _),
    run_compile_step(plan, expansion:erase_type_path_aliases,
                     dot_expand:erase_type_path_aliases(MirroredProgram,
                                                        ResolvedProgram), _),
    run_compile_step(plan, expansion:drop_minted_keyed_on_derived,
                     drop_minted_keyed_on_derived(EnumContext, ResolvedProgram,
                                                  DroppedProgram), _),
