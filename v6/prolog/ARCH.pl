...
task(tsi_a6_rust_semantic, unbuilt, [tsi_a5_ts_semantic]). % lane feature-tsi-a6-rust-semantic dispatched 2026-09-02; brief plans/2026-09-02-tsi-A6-rust-semantic.BRIEF.md.
