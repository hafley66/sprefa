...
task(go_syntax_type_graph, unbuilt, [tsi_name_row]). % DISPATCHED 2026-09-03 (brief plans/2026-09-03-go-syntax-type-graph.BRIEF.md): go.rs emits zero tsi rows at 555869ed7; new go_type_edges.rs beside project_types, rows per the brief table, fixture probe_graph.go, tests/112. v7 prelude has no Go primitive block (codex-tsi).
