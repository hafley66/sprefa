...
task(rust_syntax_type_graph, labbed, [tsi_a4_syntax_rows]). % DISPATCHED 2026-09-03 (brief plans/2026-09-03-rust-syntax-type-graph.BRIEF.md, lane fix/rust-syntax-type-graph): last-segment origin spans, tsi.called on every written Name<Args>, variant payload edges, method edges from the owner, const/static has_type, tsi.primitive for the 17 builtins plus unit. Measured on src/trail.rs before: 38 tsi.type, 0 called, 0 primitive, 0 has_type.
