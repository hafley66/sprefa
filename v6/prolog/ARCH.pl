...
task(v6_2_scale_gates, active, [v6_2_ts_closeout]). % USER-RULED 2026-07-30. WATCHER HALF LANDED: v6/tsv2/scripts/5_file-watch-scale.ts + mirrored test use real WatchBindRunner, LiveEngine, file SQLite, virtual coalescing, and hashing. 100 files: 480 events, 3 ticks, 1 subscription, 1.185185 write amplification, 39.198ms, 153845760B RSS, 40960B SQLite, 90 final rows, 0 wrong. 1000 files: 4800 events, 3 ticks, 1 subscription, same amplification, 265.241292ms, 189202432B RSS, 253952B SQLite, 900 final rows, 0 wrong. Grafana crawl remains required before done.
