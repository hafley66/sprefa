...
task(pairwise_single_tick_wrong, unbuilt, [point_free_lab]). % LIVE DEFECT (receipt Q1e in the lab, recoverable at 89ccaccf): pairwise spelled finalize+read pairs (10,9)+(14,9) instead of (10,14)+(14,9) when changes land every tick with no idle gap; correct WITH a gap; compiles clean, zero diagnostic; distinct from update-arm U4 same-tick collapse. Unowned.
