...
task(tsi_a5_ts_semantic, unbuilt, [tsi_a2_multi_witness, tsi_a4_syntax_rows]). % lane feature-tsi-a5-ts-semantic dispatched 2026-09-02; brief plans/2026-09-02-tsi-A5-ts-semantic.BRIEF.md.
task(tsi_a6_rust_semantic, unbuilt, [tsi_a5_ts_semantic]). % brief plans/2026-09-02-tsi-A6-rust-semantic.BRIEF.md.
task(tsi_a8_intersection, unbuilt, [tsi_a6_rust_semantic]). % brief plans/2026-09-02-tsi-A8-intersection.BRIEF.md.
