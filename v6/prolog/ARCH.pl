...
task(extraction_live_p2,  in_flight, [runtime_bridge_p1]). % golden plan phase 2: FIXED scip/ast-grep extractor output through hosts, watcher bind (fs.watch first per fork watcher_first_impl), enumerate/enumerate_at pair. Header = plans/2026-07-29-extraction-live-p2-header.md (4 named slots). DISPATCHED 2026-07-29 night, opus worktree
