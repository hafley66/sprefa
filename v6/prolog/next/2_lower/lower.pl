...
:- use_module('analyze').
:- use_module('../0_parse/use_resolve', [short_hash/2]).
:- use_module('../../0_rel_record').
:- use_module('../1_expand/0_generic_expand', [canonical_type_name/2,
                                   type_relation_rows/2,
                                   schema_member_transport_rows/3]).
:- use_module('../../0_type_ids', [id_kind_name/3, semantic_type_id_text/2]).
:- use_module('../1_expand/0_option_expand', [acyclic_companion/5]).
:- use_module('../1_expand/1_host_expand', [query_decl/3]).
...
:- use_module('../1_expand/0_body_walk', [walk_body/3, body_relation_atoms/4]).
