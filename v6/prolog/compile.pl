...
:- use_module('next/1_expand/1_host_expand', [prepare_program/5, query_decl/3]).
...
:- use_module('next/0_parse/parse_dl_dcg', [ parse_dl_line_for_reason/2 ]).
...
:- use_module('next/1_expand/0_generic_expand', [generated_generic_name/1]).
