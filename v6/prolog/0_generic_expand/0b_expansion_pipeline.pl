expand_generic_program_round(prog(Decls0, Rules0), Bindings,
    ...
    call(Step, generic:merge_surface_enum_type_rows,
         merge_surface_enum_type_rows(Decls0, ExpandedDecls,
                                      SurfaceEnumRowedDecls), _),
    call(Step, generic:freeze_type_rows,
         freeze_type_rows(SurfaceEnumRowedDecls, FrozenExpandedDecls), _),
...
expand_generic_program_raw(prog(Decls0, Rules0), prog(Decls, Rules)) :-
    ...
    merge_surface_enum_type_rows(Decls0, ExpandedDecls,
                                 SurfaceEnumRowedDecls),
    freeze_type_rows(SurfaceEnumRowedDecls, FrozenExpandedDecls),
