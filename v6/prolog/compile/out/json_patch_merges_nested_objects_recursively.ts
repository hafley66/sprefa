...
// hand-edit; recompile. Program: json_patch_merges_nested_objects_recursively.
...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("session" INTEGER NOT NULL, "patch" TEXT NOT NULL CHECK (json_valid("patch")))`,
  `CREATE TEMP VIEW "__txt_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" AS SELECT (SELECT s."content" FROM "__str" s WHERE s."__id" = t."session") AS "session", t."patch" AS "patch" FROM "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" t`,
  ...
  `CREATE TEMP TABLE "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("_sign" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "session" INTEGER NOT NULL, "patch" TEXT NOT NULL CHECK (json_valid("patch")))`,
  `CREATE INDEX "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a_sign" ON "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("_sign")`,
  `CREATE INDEX "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a_group" ON "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("session", "patch")`,
  `CREATE TEMP TABLE "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "session" INTEGER NOT NULL, "patch" TEXT NOT NULL CHECK (json_valid("patch")))`,
  `CREATE INDEX "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a_phase" ON "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("_phase")`,
  `CREATE TEMP TABLE "__next_frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "session" INTEGER NOT NULL, "patch" TEXT NOT NULL CHECK (json_valid("patch")))`,
  `CREATE TEMP VIEW "__txt___delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" AS SELECT (SELECT s."content" FROM "__str" s WHERE s."__id" = t."session") AS "session", t."patch" AS "patch", t."_sign" AS "_sign", t."_sequence" AS "_sequence" FROM "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" t`,
...
const rel_physical_names: Record<string, string> = {
  metric_doc: "json_patch_merges_nested_objects_recursively_metric_doc",
  metric_sample: "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a",
};
...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 7, parent_id: 0, ordinal: 0, local_name: "json_patch_merges_nested_objects_recursively", kind: "module", type_id: 0, arity: 0, module_id: 7, h_id: "8ad274887cf5932e", h_schema: "", h_rule: "" },
  { rel_id: 8, parent_id: 7, ordinal: 0, local_name: "metric_doc", kind: "rel", type_id: 0, arity: 2, module_id: 7, h_id: "ca3c525fac4cfd7e", h_schema: "6f73e11b8ff39830", h_rule: "f82be1b9d8b76786" },
  { rel_id: 9, parent_id: 8, ordinal: 1, local_name: "session", kind: "column", type_id: 1, arity: 0, module_id: 7, h_id: "69cf41c8c8b5dfb3", h_schema: "", h_rule: "" },
  { rel_id: 10, parent_id: 8, ordinal: 2, local_name: "snapshot", kind: "column", type_id: 5, arity: 0, module_id: 7, h_id: "cc776e2d19e7810c", h_schema: "", h_rule: "" },
  ...
  { rel_id: 20, parent_id: 11, ordinal: 0, local_name: "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", kind: "delta", type_id: 0, arity: 4, module_id: 7, h_id: "eba3edfe9dfae5f8", h_schema: "c57327b6ae72c1d5", h_rule: "" },
  { rel_id: 21, parent_id: 11, ordinal: 0, local_name: "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", kind: "frontier", type_id: 0, arity: 4, module_id: 7, h_id: "97f10382bfdc0bac", h_schema: "09a1fb321f2224ec", h_rule: "" },
  { rel_id: 22, parent_id: 11, ordinal: 0, local_name: "__next_frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", kind: "next_frontier", type_id: 0, arity: 4, module_id: 7, h_id: "5f8631f3a773747b", h_schema: "09a1fb321f2224ec", h_rule: "" },
  { rel_id: 23, parent_id: 11, ordinal: 0, local_name: "__txt_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "074dd83561116c54", h_schema: "09449400610c38a7", h_rule: "" },
  { rel_id: 24, parent_id: 20, ordinal: 0, local_name: "__txt___delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "734eeb6107f9fe70", h_schema: "09449400610c38a7", h_rule: "" },
  ...
  { rel_id: 28, parent_id: 12, ordinal: 1, local_name: "interned_id", kind: "storage", type_id: 0, arity: 0, module_id: 7, h_id: "e9d519cc2bd20b3b", h_schema: "", h_rule: "" },
  { rel_id: 29, parent_id: 13, ordinal: 2, local_name: "raw_characters", kind: "storage", type_id: 0, arity: 0, module_id: 7, h_id: "5ed63d7405c56f00", h_schema: "", h_rule: "" },
];
...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    metric_sample: select_rows(seam, `SELECT CASE WHEN json_valid(t."session") AND json_type(t."session") = 'object' AND json_type(t."session", '$.fn') = 'text' AND json_type(t."session", '$.args') = 'array' THEN json_extract(t."session", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."session", '$.args')), '') || ')' ELSE t."session" END AS "session", t."patch" FROM "__txt_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" t`, rel_columns.metric_sample!, rel_column_types.metric_sample!),
  });
}
...
function read_stored_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    metric_sample: select_rows(seam, `SELECT "session", "patch" FROM "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a"`, rel_columns.metric_sample!, rel_stored_column_types.metric_sample!),
  });
}
...
const final_select: Record<string, string> = {
  ...
  metric_sample: `SELECT CASE WHEN json_valid(t."session") AND json_type(t."session") = 'object' AND json_type(t."session", '$.fn') = 'text' AND json_type(t."session", '$.args') = 'array' THEN json_extract(t."session", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."session", '$.args')), '') || ')' ELSE t."session" END AS "session", t."patch" FROM "__txt_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" t`,
};

const ARRIVAL_STATEMENTS: Record<string, { kind: "log" | "set"; add_sql: string; del_sql: string | null }> = {
  metric_sample: { kind: "log", add_sql: `INSERT INTO "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("session", "patch") VALUES (?, ?)`, del_sql: null },
};

function arrival_statement(arrival: IArrivalRow): SqlStatement {
  const template = ARRIVAL_STATEMENTS[arrival.rel];
  if (template === undefined) {
    throw new Error(`json_patch_merges_nested_objects_recursively: tick received an arrival for undeclared rel '${arrival.rel}'`);
  }
  if (arrival.sign === "del") {
    if (template.kind === "log") {
      throw new Error(`json_patch_merges_nested_objects_recursively: retract from log rel '${arrival.rel}' (engine.pl retract_from_log)`);
    }
    if (template.del_sql === null) {
      throw new Error(`json_patch_merges_nested_objects_recursively: rel '${arrival.rel}' has no delete statement`);
    }
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "metric_sample", kind: "log", table_name: "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", delta_table_name: "__delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", frontier_table_name: "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", next_frontier_table_name: "__next_frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a", columns: ["session", "patch"], column_types: ["text", "json"], key_indices: [], arrival_add_sql: `INSERT INTO "json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ("session", "patch") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "session", "patch"`, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."session") AND json_type(t."session") = 'object' AND json_type(t."session", '$.fn') = 'text' AND json_type(t."session", '$.args') = 'array' THEN json_extract(t."session", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."session", '$.args')), '') || ')' ELSE t."session" END AS "session", t."patch", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" t WHERE t."_sign" IN (-1, 1) GROUP BY t."session", t."patch", t."_sign"`, rule_observers: ["metric_doc/2"] },
];

const INCREMENTAL_EDGE_STATEMENTS: readonly IIncrementalEdgeStatement[] = [
  { head_rel: "metric_doc", rule_id: "json_patch_merges_nested_objects_recursively:metric_doc/2#1", head_kind: "set", head_table_name: "json_patch_merges_nested_objects_recursively_metric_doc", head_delta_table_name: "__delta_json_patch_merges_nested_objects_recursively_metric_doc", head_columns: ["session", "snapshot"], key_indices: [0], project_sql: `SELECT d0."session" AS "session", json_patch(json(b0."snapshot"), json(d0."patch")) AS "snapshot" FROM "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" d0, "__pre_json_patch_merges_nested_objects_recursively_metric_doc" b0 WHERE d0."_phase" >= 0 AND b0."session" = d0."session" ORDER BY d0."_phase", d0."_sequence"` },
];
...
const ORDERED_CARRY_READS: readonly { readonly rel: string; readonly sql: string; readonly columns: readonly string[] }[] = [
  { rel: "metric_sample", sql: `SELECT "_sequence" AS "__sequence", "session", "patch" FROM "__frontier_json_patch_merges_nested_objects_recursively_metric_sample_c7851eaf2e4a" ORDER BY "_phase", "_sequence"`, columns: ["session", "patch"] },
];
...
function run_ordered_tick(seam: ISqlSeam, arrivals: IArrivalBatch): Observable<ITickDeltas> {
  ...
  // json_patch_merges_nested_objects_recursively: ordered process_occurrences with evolving pre snapshots.
}
...
export const program: IGenProgramWithBoot = {
  name: "json_patch_merges_nested_objects_recursively",
  ir_version: 1,
  internMode: "dict",
  ddl,
  rel_columns,
