...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    combined: select_rows(seam, `SELECT CASE WHEN json_valid("value_a") AND json_type("value_a") = 'object' AND json_type("value_a", '$.fn') = 'text' AND json_type("value_a", '$.args') = 'array' THEN json_extract("value_a", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_a", '$.args')), '') || ')' ELSE "value_a" END AS "value_a", CASE WHEN json_valid("value_b") AND json_type("value_b") = 'object' AND json_type("value_b", '$.fn') = 'text' AND json_type("value_b", '$.args') = 'array' THEN json_extract("value_b", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_b", '$.args')), '') || ')' ELSE "value_b" END AS "value_b" FROM "__txt_combined" t`, rel_columns.combined!, rel_column_types.combined!),
    result_a: select_rows(seam, `SELECT CASE WHEN json_valid("value_a") AND json_type("value_a") = 'object' AND json_type("value_a", '$.fn') = 'text' AND json_type("value_a", '$.args') = 'array' THEN json_extract("value_a", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_a", '$.args')), '') || ')' ELSE "value_a" END AS "value_a" FROM "__txt_result_a" t`, rel_columns.result_a!, rel_column_types.result_a!),
    result_b: select_rows(seam, `SELECT CASE WHEN json_valid("value_b") AND json_type("value_b") = 'object' AND json_type("value_b", '$.fn') = 'text' AND json_type("value_b", '$.args') = 'array' THEN json_extract("value_b", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_b", '$.args')), '') || ')' ELSE "value_b" END AS "value_b" FROM "__txt_result_b" t`, rel_columns.result_b!, rel_column_types.result_b!),
  });
}
...
const final_select: Record<string, string> = {
  combined: `SELECT CASE WHEN json_valid("value_a") AND json_type("value_a") = 'object' AND json_type("value_a", '$.fn') = 'text' AND json_type("value_a", '$.args') = 'array' THEN json_extract("value_a", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_a", '$.args')), '') || ')' ELSE "value_a" END AS "value_a", CASE WHEN json_valid("value_b") AND json_type("value_b") = 'object' AND json_type("value_b", '$.fn') = 'text' AND json_type("value_b", '$.args') = 'array' THEN json_extract("value_b", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_b", '$.args')), '') || ')' ELSE "value_b" END AS "value_b" FROM "__txt_combined" t`,
  result_a: `SELECT CASE WHEN json_valid("value_a") AND json_type("value_a") = 'object' AND json_type("value_a", '$.fn') = 'text' AND json_type("value_a", '$.args') = 'array' THEN json_extract("value_a", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_a", '$.args')), '') || ')' ELSE "value_a" END AS "value_a" FROM "__txt_result_a" t`,
  result_b: `SELECT CASE WHEN json_valid("value_b") AND json_type("value_b") = 'object' AND json_type("value_b", '$.fn') = 'text' AND json_type("value_b", '$.args') = 'array' THEN json_extract("value_b", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("value_b", '$.args')), '') || ')' ELSE "value_b" END AS "value_b" FROM "__txt_result_b" t`,
};
