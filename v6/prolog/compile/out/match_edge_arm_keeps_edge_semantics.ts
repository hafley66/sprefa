...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__frontier_match_edge_arm_keeps_edge_semantics_cache" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "key" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
