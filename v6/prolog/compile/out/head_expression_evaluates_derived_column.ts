...
const relCatalog: readonly IRelCatalogRow[] = [
  ...
  { relId: 6, parentId: 0, ordinal: 0, localName: "head_expression_evaluates_derived_column", kind: "module", typeId: 0, arity: 0, moduleId: 6, hId: "3c943195def90a46", hSchema: "", hRule: "" },
  { relId: 7, parentId: 6, ordinal: 0, localName: "callee_set_size", kind: "rel", typeId: 0, arity: 2, moduleId: 6, hId: "ab6a8f39d20a17d4", hSchema: "edb533b8689f8fc1", hRule: "" },
  { relId: 8, parentId: 7, ordinal: 1, localName: "left", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "78473d3d9141e539", hSchema: "", hRule: "" },
  { relId: 9, parentId: 7, ordinal: 2, localName: "left_size", kind: "column", typeId: 2, arity: 0, moduleId: 6, hId: "75c6bba1f2859782", hSchema: "", hRule: "" },
  { relId: 10, parentId: 6, ordinal: 0, localName: "shared_count", kind: "rel", typeId: 0, arity: 3, moduleId: 6, hId: "6361066008f7f96c", hSchema: "45ce68388ec8d4df", hRule: "" },
  { relId: 11, parentId: 10, ordinal: 1, localName: "left", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "7440ab1e666eea64", hSchema: "", hRule: "" },
  { relId: 12, parentId: 10, ordinal: 2, localName: "right", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "0aef6283f84f132f", hSchema: "", hRule: "" },
  { relId: 13, parentId: 10, ordinal: 3, localName: "shared", kind: "column", typeId: 2, arity: 0, moduleId: 6, hId: "12b7e632200f08f4", hSchema: "", hRule: "" },
  { relId: 14, parentId: 6, ordinal: 0, localName: "union_size", kind: "rel", typeId: 0, arity: 3, moduleId: 6, hId: "c9fdfc0fed426dcb", hSchema: "fcd3e999763cdb49", hRule: "044a8ee22c9dd379" },
  { relId: 15, parentId: 14, ordinal: 1, localName: "left", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "325d1cd6c49eb6ac", hSchema: "", hRule: "" },
  { relId: 16, parentId: 14, ordinal: 2, localName: "right", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "b0b6096c3d68a6ca", hSchema: "", hRule: "" },
  { relId: 17, parentId: 14, ordinal: 3, localName: "col3", kind: "column", typeId: 2, arity: 0, moduleId: 6, hId: "6870a3180aa4a6a7", hSchema: "", hRule: "" },
];
...
INSERT OR IGNORE INTO "union_size" ("left", "right", "col3") SELECT b0."left", b1."left", ((b0."left_size" + b1."left_size") - b2."shared") FROM "callee_set_size" b0, "callee_set_size" b1, "shared_count" b2 WHERE b2."left" = b0."left" AND b2."right" = b1."left"`, supportSql: [`DELETE FROM "__support_next_union_size"`, `INSERT INTO "__support_next_union_size" ("left", "right", "col3", "__refcount") SELECT "left", "right", "col3", sum("__refcount") FROM (SELECT b0."left" AS "left", b1."left" AS "right", ((b0."left_size" + b1."left_size") - b2."shared") AS "col3", count(*) AS "__refcount" FROM "callee_set_size" b0, "callee_set_size" b1, "shared_count" b2 WHERE b2."left" = b0."left" AND b2."right" = b1."left" GROUP BY b0."left", b1."left", ((b0."left_size" + b1."left_size") - b2."shared")) GROUP BY "left", "right", "col3"`, `UPDATE "union_size" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_union_size" n WHERE n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3"), 0)`, `INSERT INTO "__delta_union_size" ("_sign", "_sequence", "left", "right", "col3") SELECT -1, row_number() OVER () - 1, "left", "right", "col3" FROM "union_size" WHERE "__refcount" <= 0`, `DELETE FROM "union_size" WHERE "__refcount" <= 0`, `DELETE FROM "__new_union_size"`, `INSERT INTO "__new_union_size" ("left", "right", "col3", "__refcount") SELECT n."left", n."right", n."col3", n."__refcount" FROM "__support_next_union_size" n LEFT JOIN "union_size" h ON n."left" = h."left" AND n."right" = h."right" AND n."col3" = h."col3" WHERE h."left" IS NULL`, `INSERT INTO "__delta_union_size" ("_sign", "_sequence", "left", "right", "col3") SELECT 1, "rowid" - 1, "left", "right", "col3" FROM "__new_union_size"`, `INSERT INTO "__frontier_union_size" ("_phase", "_sequence", "left", "right", "col3") SELECT ?, "rowid" - 1, "left", "right", "col3" FROM "__new_union_size"`, `INSERT INTO "__next_frontier_union_size" ("_phase", "_sequence", "left", "right", "col3") SELECT ?, "rowid" - 1, "left", "right", "col3" FROM "__new_union_size"`, `INSERT OR IGNORE INTO "union_size" ("left", "right", "col3", "__refcount") SELECT n."left", n."right", n."col3", n."__refcount" FROM "__support_next_union_size" n`], expandSql: null, dredSql: null, fixpointIr: null, aggregateSql: null },
];
