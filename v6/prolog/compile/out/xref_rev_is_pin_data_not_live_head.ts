...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    known_repo: select_rows(seam, `SELECT "col1" FROM "known_repo" t`, rel_columns.known_repo!, rel_column_types.known_repo!),
...
const final_select: Record<string, string> = {
  ...
  known_repo: `SELECT "col1" FROM "known_repo" t`,
