...
export const demandedRels: readonly string[] = ["child/2", "nested/2"];
...
const boot: readonly IBootStatement[] = [
  { sql: `INSERT OR IGNORE INTO "child" ("group", "payload") VALUES (?, ?)`, params: ["north", "{\"a\":2,\"z\":1}"] },
  { sql: `INSERT OR IGNORE INTO "child" ("group", "payload") VALUES (?, ?)`, params: ["north", "{\"a\":3,\"z\":4}"] },
  { sql: `DELETE FROM "nested"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "nested" ("group", "col2") SELECT b0."group", json_group_array(json(b0."payload") ORDER BY b0."payload") FROM "child" b0 GROUP BY b0."group" HAVING count(*) > 0`, params: [] },
];
