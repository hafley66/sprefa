...
export const demandedRels: readonly string[] = ["close_request/2", "closed/2", "demanded/2", "drained/2", "live_tab/2", "open_request/2", "open_tab/2", "queue_head/2", "queue_head_tab/2", "queue_next/2", "queue_slot/3", "tab_row/2", "tab_view/2"];
