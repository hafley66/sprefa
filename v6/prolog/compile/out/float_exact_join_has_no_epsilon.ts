...
INSERT OR IGNORE INTO "matched" ("name") SELECT b0."name" FROM "left" b0, "right" b1 WHERE b1."name" = b0."name" AND b1."value" = b0."value"`, supportSql: [`DELETE FROM "__support_next_matched"`, `INSERT INTO "__support_next_matched" ("name", "__refcount") SELECT "name", sum("__refcount") FROM (SELECT b0."name" AS "name", count(*) AS "__refcount" FROM "left" b0, "right" b1 WHERE b1."name" = b0."name" AND b1."value" = b0."value" GROUP BY b0."name") GROUP BY "name"`, `UPDATE "matched" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_matched" n WHERE n."name" = h."name"), 0)`, `INSERT INTO "__delta_matched" ("_sign", "_sequence", "name") SELECT -1, row_number() OVER () - 1, "name" FROM "matched" WHERE "__refcount" <= 0`, `DELETE FROM "matched" WHERE "__refcount" <= 0`, `DELETE FROM "__new_matched"`, `INSERT INTO "__new_matched" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_matched" n LEFT JOIN "matched" h ON n."name" = h."name" WHERE h."name" IS NULL`, `INSERT INTO "__delta_matched" ("_sign", "_sequence", "name") SELECT 1, "rowid" - 1, "name" FROM "__new_matched"`, `INSERT INTO "__frontier_matched" ("_phase", "_sequence", "name") SELECT ?, "rowid" - 1, "name" FROM "__new_matched"`, `INSERT INTO "__next_frontier_matched" ("_phase", "_sequence", "name") SELECT ?, "rowid" - 1, "name" FROM "__new_matched"`, `INSERT OR IGNORE INTO "matched" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_matched" n`], aggregateSql: null },
];
