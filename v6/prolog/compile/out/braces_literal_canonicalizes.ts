...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "doc" ("value" TEXT NOT NULL CHECK (json_valid("value")), "__refcount" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("value")) WITHOUT ROWID`,
