...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    doc: select_rows(seam, `SELECT "value" FROM "doc" t`, rel_columns.doc!, rel_column_types.doc!),
