...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__frontier_keyed_edge_head_still_replaces_current_value" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "key" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
