...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__frontier_length_counts_characters_measured" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "text" INTEGER NOT NULL, "out" INTEGER NOT NULL)`,
