...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    pull_request: select_rows(seam, `SELECT "number", CASE WHEN json_valid("title") AND json_type("title") = 'object' AND json_type("title", '$.fn') = 'text' AND json_type("title", '$.args') = 'array' THEN json_extract("title", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("title", '$.args')), '') || ')' ELSE "title" END AS "title", CASE WHEN json_valid("author") AND json_type("author") = 'object' AND json_type("author", '$.fn') = 'text' AND json_type("author", '$.args') = 'array' THEN json_extract("author", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("author", '$.args')), '') || ')' ELSE "author" END AS "author" FROM "__txt_pull_request" t`, rel_columns.pull_request!, rel_column_types.pull_request!),
    resp: select_rows(seam, `SELECT "body" FROM "resp" t`, rel_columns.resp!, rel_column_types.resp!),
  });
}
...
const final_select: Record<string, string> = {
  pull_request: `SELECT "number", CASE WHEN json_valid("title") AND json_type("title") = 'object' AND json_type("title", '$.fn') = 'text' AND json_type("title", '$.args') = 'array' THEN json_extract("title", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("title", '$.args')), '') || ')' ELSE "title" END AS "title", CASE WHEN json_valid("author") AND json_type("author") = 'object' AND json_type("author", '$.fn') = 'text' AND json_type("author", '$.args') = 'array' THEN json_extract("author", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("author", '$.args')), '') || ')' ELSE "author" END AS "author" FROM "__txt_pull_request" t`,
  resp: `SELECT "body" FROM "resp" t`,
};
