...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__frontier_edge_chain_hops_tick_per_stage_stage_one" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE INDEX "__frontier_edge_chain_hops_tick_per_stage_stage_one_phase" ON "__frontier_edge_chain_hops_tick_per_stage_stage_one" ("_phase")`,
  `CREATE TEMP TABLE "__next_frontier_edge_chain_hops_tick_per_stage_stage_one" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE TEMP VIEW "__txt___delta_edge_chain_hops_tick_per_stage_stage_one" AS SELECT (SELECT s."content" FROM "__str" s WHERE s."__id" = t."item") AS "item", t."_sign" AS "_sign", t."_sequence" AS "_sequence" FROM "__delta_edge_chain_hops_tick_per_stage_stage_one" t`,
  `CREATE TEMP TABLE "__delta_edge_chain_hops_tick_per_stage_stage_two" ("_sign" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE INDEX "__delta_edge_chain_hops_tick_per_stage_stage_two_sign" ON "__delta_edge_chain_hops_tick_per_stage_stage_two" ("_sign")`,
  `CREATE INDEX "__delta_edge_chain_hops_tick_per_stage_stage_two_group" ON "__delta_edge_chain_hops_tick_per_stage_stage_two" ("item")`,
  `CREATE TEMP TABLE "__frontier_edge_chain_hops_tick_per_stage_stage_two" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE INDEX "__frontier_edge_chain_hops_tick_per_stage_stage_two_phase" ON "__frontier_edge_chain_hops_tick_per_stage_stage_two" ("_phase")`,
  `CREATE TEMP TABLE "__next_frontier_edge_chain_hops_tick_per_stage_stage_two" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE TEMP VIEW "__txt___delta_edge_chain_hops_tick_per_stage_stage_two" AS SELECT (SELECT s."content" FROM "__str" s WHERE s."__id" = t."item") AS "item", t."_sign" AS "_sign", t."_sequence" AS "_sequence" FROM "__delta_edge_chain_hops_tick_per_stage_stage_two" t`,
];
...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 22, parent_id: 10, ordinal: 0, local_name: "__txt_edge_chain_hops_tick_per_stage_stage_one", kind: "view", type_id: 0, arity: 1, module_id: 7, h_id: "ca04912d6b01bdeb", h_schema: "4f9957ccb96234b6", h_rule: "" },
  { rel_id: 23, parent_id: 19, ordinal: 0, local_name: "__txt___delta_edge_chain_hops_tick_per_stage_stage_one", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "a5d8a9d101906508", h_schema: "4f9957ccb96234b6", h_rule: "" },
  ...
  { rel_id: 27, parent_id: 12, ordinal: 0, local_name: "__txt_edge_chain_hops_tick_per_stage_stage_two", kind: "view", type_id: 0, arity: 1, module_id: 7, h_id: "4495a13e4150b4f9", h_schema: "4f9957ccb96234b6", h_rule: "" },
  { rel_id: 28, parent_id: 24, ordinal: 0, local_name: "__txt___delta_edge_chain_hops_tick_per_stage_stage_two", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "e3e6cf243fd326c8", h_schema: "4f9957ccb96234b6", h_rule: "" },
