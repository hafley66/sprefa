...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    fee: select_rows(seam, `SELECT CASE WHEN json_valid("account") AND json_type("account") = 'object' AND json_type("account", '$.fn') = 'text' AND json_type("account", '$.args') = 'array' THEN json_extract("account", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("account", '$.args')), '') || ')' ELSE "account" END AS "account", "amount" FROM "__txt_fee" t`, rel_columns.fee!, rel_column_types.fee!),
    fee_stats: select_rows(seam, `SELECT CASE WHEN json_valid("account") AND json_type("account") = 'object' AND json_type("account", '$.fn') = 'text' AND json_type("account", '$.args') = 'array' THEN json_extract("account", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("account", '$.args')), '') || ')' ELSE "account" END AS "account", "next" FROM "__txt_fee_stats" t`, rel_columns.fee_stats!, rel_column_types.fee_stats!),
  });
}
...
const final_select: Record<string, string> = {
  fee: `SELECT CASE WHEN json_valid("account") AND json_type("account") = 'object' AND json_type("account", '$.fn') = 'text' AND json_type("account", '$.args') = 'array' THEN json_extract("account", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("account", '$.args')), '') || ')' ELSE "account" END AS "account", "amount" FROM "__txt_fee" t`,
  fee_stats: `SELECT CASE WHEN json_valid("account") AND json_type("account") = 'object' AND json_type("account", '$.fn') = 'text' AND json_type("account", '$.args') = 'array' THEN json_extract("account", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("account", '$.args')), '') || ')' ELSE "account" END AS "account", "next" FROM "__txt_fee_stats" t`,
};
