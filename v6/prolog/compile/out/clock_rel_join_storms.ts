...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "ratchet" ("col1" INTEGER NOT NULL, "col2" INTEGER NOT NULL, PRIMARY KEY ("col1")) WITHOUT ROWID`,
...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    ratchet: select_rows(seam, `SELECT CASE WHEN json_valid("col1") AND json_type("col1") = 'object' AND json_type("col1", '$.fn') = 'text' AND json_type("col1", '$.args') = 'array' THEN json_extract("col1", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("col1", '$.args')), '') || ')' ELSE "col1" END AS "col1", "col2" FROM "__txt_ratchet"`, rel_columns.ratchet!, rel_column_types.ratchet!),
...
const final_select: Record<string, string> = {
  ...
  ratchet: `SELECT CASE WHEN json_valid("col1") AND json_type("col1") = 'object' AND json_type("col1", '$.fn') = 'text' AND json_type("col1", '$.args') = 'array' THEN json_extract("col1", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("col1", '$.args')), '') || ')' ELSE "col1" END AS "col1", "col2" FROM "__txt_ratchet"`,
