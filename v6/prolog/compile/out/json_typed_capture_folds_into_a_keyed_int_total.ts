...
const INCREMENTAL_EDGE_STATEMENTS: readonly IIncrementalEdgeStatement[] = [
  { headRel: "total", headKind: "set", headTableName: "total", headDeltaTableName: "__delta_total", headColumns: ["repo", "sum"], keyIndices: [0], projectSql: `SELECT d0."repo" AS "repo", d0."stars" AS "sum" FROM "__frontier_star_event" d0 WHERE d0."_phase" >= 0 AND NOT EXISTS (SELECT 1 FROM "total" n0 WHERE n0."repo" = d0."repo") ORDER BY d0."_phase", d0."_sequence"` },
  { headRel: "total", headKind: "set", headTableName: "total", headDeltaTableName: "__delta_total", headColumns: ["repo", "sum"], keyIndices: [0], projectSql: `SELECT d0."repo" AS "repo", (b0."sum" + d0."stars") AS "sum" FROM "__frontier_star_event" d0, "__pre_total" b0 WHERE d0."_phase" >= 0 AND b0."repo" = d0."repo" ORDER BY d0."_phase", d0."_sequence"` },
];

const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "star_event", headDeltaTableName: "__delta_star_event", headColumns: ["repo", "stars"], insertSql: `INSERT OR IGNORE INTO "star_event" ("repo", "stars") SELECT DISTINCT json_extract(d0."payload", '$."repo"'), json_extract(d0."payload", '$."stars"') FROM "__frontier_event" d0 WHERE d0."_phase" >= 0 AND json_type(d0."payload", '$') = 'object' AND json_type(d0."payload", '$."repo"') = 'text' AND json_type(d0."payload", '$."stars"') = 'integer' RETURNING "repo", "stars"`, selectSql: `SELECT "repo", "stars" FROM "star_event"`, recomputeSql: `DELETE FROM "star_event";
