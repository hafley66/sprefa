...
export const demandedRels: readonly string[] = ["demand_rev/2", "pin_want/3", "rev_fill/4", "rev_status/4", "stale_pin/2"];
...
const boot: readonly IBootStatement[] = [
  { sql: `DELETE FROM "stale_pin"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "stale_pin" ("dep_repo_id", "ref_text") SELECT b0."dep_repo_id", b0."ref_text" FROM "rev_status" b0 WHERE (b0."behind" > 0)`, params: [] },
];
