...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    demand_rev: select_rows(seam, `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text" FROM "__txt_demand_rev" t`, rel_columns.demand_rev!, rel_column_types.demand_rev!),
    pin_want: select_rows(seam, `SELECT "col1", "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text" FROM "__txt_pin_want" t`, rel_columns.pin_want!, rel_column_types.pin_want!),
    rev_fill: select_rows(seam, `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text", "behind", "ahead" FROM "__txt_rev_fill" t`, rel_columns.rev_fill!, rel_column_types.rev_fill!),
    rev_status: select_rows(seam, `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text", "behind", "ahead" FROM "__txt_rev_status" t`, rel_columns.rev_status!, rel_column_types.rev_status!),
    stale_pin: select_rows(seam, `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text" FROM "__txt_stale_pin" t`, rel_columns.stale_pin!, rel_column_types.stale_pin!),
  });
}
...
const final_select: Record<string, string> = {
  demand_rev: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text" FROM "__txt_demand_rev" t`,
  pin_want: `SELECT "col1", "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text" FROM "__txt_pin_want" t`,
  rev_fill: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text", "behind", "ahead" FROM "__txt_rev_fill" t`,
  rev_status: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text", "behind", "ahead" FROM "__txt_rev_status" t`,
  stale_pin: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text" FROM "__txt_stale_pin" t`,
};
...
function arrival_statement(arrival: IArrivalRow): SqlStatement {
  ...
  if (template === undefined) {
    throw new Error(`rev_fill_not_behind_keeps_stale_pin_empty: tick received an arrival for undeclared rel '${arrival.rel}'`);
  }
  if (arrival.sign === "del") {
    if (template.kind === "log") {
      throw new Error(`rev_fill_not_behind_keeps_stale_pin_empty: retract from log rel '${arrival.rel}' (engine.pl retract_from_log)`);
    }
    if (template.del_sql === null) {
      throw new Error(`rev_fill_not_behind_keeps_stale_pin_empty: rel '${arrival.rel}' has no delete statement`);
    }
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "demand_rev", kind: "set", table_name: "demand_rev", delta_table_name: "__delta_demand_rev", frontier_table_name: "__frontier_demand_rev", next_frontier_table_name: "__next_frontier_demand_rev", columns: ["dep_repo_id", "ref_text"], column_types: ["int", "text"], key_indices: [0, 1], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' AND json_type("ref_text", '$.fn') = 'text' AND json_type("ref_text", '$.args') = 'array' THEN json_extract("ref_text", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')), '') || ')' ELSE "ref_text" END AS "ref_text", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_demand_rev" t WHERE "_sign" IN (-1, 1) GROUP BY "dep_repo_id", "ref_text", "_sign"`, rule_observers: [] },
