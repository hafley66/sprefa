...
const finalSelect: Record<string, string> = {
  demand_rev: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' THEN json_extract("ref_text", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')) || ')' ELSE "ref_text" END AS "ref_text" FROM "demand_rev"`,
  pin_want: `SELECT "col1", "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' THEN json_extract("ref_text", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')) || ')' ELSE "ref_text" END AS "ref_text" FROM "pin_want"`,
  rev_fill: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' THEN json_extract("ref_text", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')) || ')' ELSE "ref_text" END AS "ref_text", "behind", "ahead" FROM "rev_fill"`,
  rev_status: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' THEN json_extract("ref_text", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')) || ')' ELSE "ref_text" END AS "ref_text", "behind", "ahead" FROM "rev_status"`,
  stale_pin: `SELECT "dep_repo_id", CASE WHEN json_valid("ref_text") AND json_type("ref_text") = 'object' THEN json_extract("ref_text", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("ref_text", '$.args')) || ')' ELSE "ref_text" END AS "ref_text" FROM "stale_pin"`,
};
