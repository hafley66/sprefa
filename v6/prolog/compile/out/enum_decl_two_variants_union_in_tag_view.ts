...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 20, parent_id: 8, ordinal: 0, local_name: "__txt_result_error", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "4b735abad06b6f35", h_schema: "06eee5bd0b4522c6", h_rule: "" },
  { rel_id: 21, parent_id: 17, ordinal: 0, local_name: "__txt___delta_result_error", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "90cedb7fa206032e", h_schema: "06eee5bd0b4522c6", h_rule: "" },
  ...
  { rel_id: 25, parent_id: 11, ordinal: 0, local_name: "__txt_result_ok", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "b0b40e0e3ee1134b", h_schema: "6199c1956655e339", h_rule: "" },
  { rel_id: 26, parent_id: 22, ordinal: 0, local_name: "__txt___delta_result_ok", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "3b15d7482de0ad31", h_schema: "6199c1956655e339", h_rule: "" },
  ...
  { rel_id: 30, parent_id: 14, ordinal: 0, local_name: "__txt_result_tag", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "7a3009a1f758b86f", h_schema: "2901e6f8122ebf0c", h_rule: "" },
  { rel_id: 31, parent_id: 27, ordinal: 0, local_name: "__txt___delta_result_tag", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "32b2d8c34f5275f6", h_schema: "2901e6f8122ebf0c", h_rule: "" },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "result_ok", kind: "set", table_name: "result_ok", delta_table_name: "__delta_result_ok", frontier_table_name: "__frontier_result_ok", next_frontier_table_name: "__next_frontier_result_ok", columns: ["id", "value"], column_types: ["int", "text"], key_indices: [1], arrival_add_sql: `INSERT INTO "result_ok" ("id", "value") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) WHERE true ON CONFLICT ("value") DO UPDATE SET "id" = excluded."id" RETURNING "id", "value"`, arrival_del_sql: `DELETE FROM "result_ok" WHERE ("id", "value") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?)) RETURNING "id", "value"`, boundary_sql: `SELECT t."id", CASE WHEN json_valid(t."value") AND json_type(t."value") = 'object' AND json_type(t."value", '$.fn') = 'text' AND json_type(t."value", '$.args') = 'array' THEN json_extract(t."value", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."value", '$.args')), '') || ')' ELSE t."value" END AS "value", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_result_ok" t WHERE t."_sign" IN (-1, 1) GROUP BY t."id", t."value", t."_sign"`, rule_observers: ["result_tag/2"] },
  { rel: "result_tag", kind: "set", table_name: "result_tag", delta_table_name: "__delta_result_tag", frontier_table_name: "__frontier_result_tag", next_frontier_table_name: "__next_frontier_result_tag", columns: ["id", "tag"], column_types: ["int", "text"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT t."id", CASE WHEN json_valid(t."tag") AND json_type(t."tag") = 'object' AND json_type(t."tag", '$.fn') = 'text' AND json_type(t."tag", '$.args') = 'array' THEN json_extract(t."tag", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."tag", '$.args')), '') || ')' ELSE t."tag" END AS "tag", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_result_tag" t WHERE t."_sign" IN (-1, 1) GROUP BY t."id", t."tag", t."_sign"`, rule_observers: [] },
];
