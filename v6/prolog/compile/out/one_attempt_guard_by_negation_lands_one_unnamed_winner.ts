...
const INCREMENTAL_EDGE_STATEMENTS: readonly IIncrementalEdgeStatement[] = [
  { headRel: "dispatch_first", ruleId: "one_attempt_guard_by_negation_lands_one_unnamed_winner:dispatch_first/2#1", headKind: "log", headTableName: "dispatch_first", headDeltaTableName: "__delta_dispatch_first", headColumns: ["dispatch_id", "_ack_tag"], keyIndices: [], projectSql: `SELECT d0."dispatch_id" AS "dispatch_id", 'acked' AS "_ack_tag" FROM "__frontier_dispatch_ack" d0 WHERE d0."_phase" >= 0 AND NOT EXISTS (SELECT 1 FROM "dispatch_first" n0 WHERE n0."dispatch_id" = d0."dispatch_id") ORDER BY d0."_phase", d0."_sequence"` },
  { headRel: "dispatch_first", ruleId: "one_attempt_guard_by_negation_lands_one_unnamed_winner:dispatch_first/2#2", headKind: "log", headTableName: "dispatch_first", headDeltaTableName: "__delta_dispatch_first", headColumns: ["dispatch_id", "_ack_tag"], keyIndices: [], projectSql: `SELECT d0."sealed_id" AS "dispatch_id", 'sealed' AS "_ack_tag" FROM "__frontier_dispatch_seal" d0 WHERE d0."_phase" >= 0 AND NOT EXISTS (SELECT 1 FROM "dispatch_first" n0 WHERE n0."dispatch_id" = d0."sealed_id") ORDER BY d0."_phase", d0."_sequence"` },
];
