...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 21, parent_id: 8, ordinal: 0, local_name: "__txt_bump", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "22036dd71e61a305", h_schema: "e8df68123fcae3cb", h_rule: "" },
  { rel_id: 22, parent_id: 18, ordinal: 0, local_name: "__txt___delta_bump", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "8b658e3419a52a10", h_schema: "e8df68123fcae3cb", h_rule: "" },
  ...
  { rel_id: 26, parent_id: 11, ordinal: 0, local_name: "__txt_over_budget", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "094512863b7eaf5b", h_schema: "947bbb1ab890cf25", h_rule: "" },
  { rel_id: 27, parent_id: 23, ordinal: 0, local_name: "__txt___delta_over_budget", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "9797e5795e0b10dd", h_schema: "947bbb1ab890cf25", h_rule: "" },
  ...
  { rel_id: 31, parent_id: 14, ordinal: 0, local_name: "__txt_seen", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "60b272f4d1bb4351", h_schema: "ffcc230fc7075d54", h_rule: "" },
  { rel_id: 32, parent_id: 28, ordinal: 0, local_name: "__txt___delta_seen", kind: "view", type_id: 0, arity: 5, module_id: 7, h_id: "2a81c8758f62ea84", h_schema: "ffcc230fc7075d54", h_rule: "" },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "over_budget", kind: "set", table_name: "over_budget", delta_table_name: "__delta_over_budget", frontier_table_name: "__frontier_over_budget", next_frontier_table_name: "__next_frontier_over_budget", columns: ["name", "sum"], column_types: ["text", "int"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."name") AND json_type(t."name") = 'object' AND json_type(t."name", '$.fn') = 'text' AND json_type(t."name", '$.args') = 'array' THEN json_extract(t."name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."name", '$.args')), '') || ')' ELSE t."name" END AS "name", t."sum", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_over_budget" t WHERE t."_sign" IN (-1, 1) GROUP BY t."name", t."sum", t."_sign"`, rule_observers: [] },
  { rel: "seen", kind: "set", table_name: "seen", delta_table_name: "__delta_seen", frontier_table_name: "__frontier_seen", next_frontier_table_name: "__next_frontier_seen", columns: ["name", "base", "col3"], column_types: ["text", "int", "text"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "seen" ("name", "base", "col3") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]'), json_extract(value, '$[2]') FROM json_each(?) RETURNING "name", "base", "col3"`, arrival_del_sql: `DELETE FROM "seen" WHERE ("name", "base", "col3") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]'), json_extract(value, '$[2]') FROM json_each(?)) RETURNING "name", "base", "col3"`, boundary_sql: `SELECT CASE WHEN json_valid(t."name") AND json_type(t."name") = 'object' AND json_type(t."name", '$.fn') = 'text' AND json_type(t."name", '$.args') = 'array' THEN json_extract(t."name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."name", '$.args')), '') || ')' ELSE t."name" END AS "name", t."base", CASE WHEN json_valid(t."col3") AND json_type(t."col3") = 'object' AND json_type(t."col3", '$.fn') = 'text' AND json_type(t."col3", '$.args') = 'array' THEN json_extract(t."col3", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."col3", '$.args')), '') || ')' ELSE t."col3" END AS "col3", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_seen" t WHERE t."_sign" IN (-1, 1) GROUP BY t."name", t."base", t."col3", t."_sign"`, rule_observers: ["over_budget/2"] },
];
