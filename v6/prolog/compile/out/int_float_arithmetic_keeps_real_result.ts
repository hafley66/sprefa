...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "measure" ("__id" INTEGER PRIMARY KEY, "name" INTEGER NOT NULL, "whole" INTEGER NOT NULL, "fraction" REAL NOT NULL CHECK (typeof("fraction") = 'real' AND "fraction" BETWEEN -1.7976931348623157e308 AND 1.7976931348623157e308), UNIQUE ("name", "whole", "fraction"))`,
  ...
  `CREATE TABLE "total" ("__id" INTEGER PRIMARY KEY, "name" INTEGER NOT NULL, "value" REAL NOT NULL CHECK (typeof("value") = 'real' AND "value" BETWEEN -1.7976931348623157e308 AND 1.7976931348623157e308), "__refcount" INTEGER NOT NULL DEFAULT 1, UNIQUE ("name", "value"))`,
...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    measure: select_rows(seam, `SELECT CASE WHEN json_valid("name") AND json_type("name") = 'object' AND json_type("name", '$.fn') = 'text' AND json_type("name", '$.args') = 'array' THEN json_extract("name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("name", '$.args')), '') || ')' ELSE "name" END AS "name", "whole", "fraction" FROM "__txt_measure" t`, rel_columns.measure!, rel_column_types.measure!),
...
const final_select: Record<string, string> = {
  measure: `SELECT CASE WHEN json_valid("name") AND json_type("name") = 'object' AND json_type("name", '$.fn') = 'text' AND json_type("name", '$.args') = 'array' THEN json_extract("name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("name", '$.args')), '') || ')' ELSE "name" END AS "name", "whole", "fraction" FROM "__txt_measure" t`,
  total: `SELECT CASE WHEN json_valid("name") AND json_type("name") = 'object' AND json_type("name", '$.fn') = 'text' AND json_type("name", '$.args') = 'array' THEN json_extract("name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("name", '$.args')), '') || ')' ELSE "name" END AS "name", "value" FROM "__txt_total" t`,
};
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "measure", kind: "set", table_name: "measure", delta_table_name: "__delta_measure", frontier_table_name: "__frontier_measure", next_frontier_table_name: "__next_frontier_measure", columns: ["name", "whole", "fraction"], column_types: ["text", "int", "float"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "measure" ("name", "whole", "fraction") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]'), json_extract(value, '$[2]') FROM json_each(?) RETURNING "name", "whole", "fraction"`, arrival_del_sql: `DELETE FROM "measure" WHERE ("name", "whole", "fraction") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]'), json_extract(value, '$[2]') FROM json_each(?)) RETURNING "name", "whole", "fraction"`, boundary_sql: `SELECT CASE WHEN json_valid("name") AND json_type("name") = 'object' AND json_type("name", '$.fn') = 'text' AND json_type("name", '$.args') = 'array' THEN json_extract("name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("name", '$.args')), '') || ')' ELSE "name" END AS "name", "whole", "fraction", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_measure" t WHERE "_sign" IN (-1, 1) GROUP BY "name", "whole", "fraction", "_sign"`, rule_observers: ["total/2"] },
  { rel: "total", kind: "set", table_name: "total", delta_table_name: "__delta_total", frontier_table_name: "__frontier_total", next_frontier_table_name: "__next_frontier_total", columns: ["name", "value"], column_types: ["text", "float"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid("name") AND json_type("name") = 'object' AND json_type("name", '$.fn') = 'text' AND json_type("name", '$.args') = 'array' THEN json_extract("name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("name", '$.args')), '') || ')' ELSE "name" END AS "name", "value", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_total" t WHERE "_sign" IN (-1, 1) GROUP BY "name", "value", "_sign"`, rule_observers: [] },
];
