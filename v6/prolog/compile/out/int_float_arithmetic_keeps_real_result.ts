...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 18, parent_id: 8, ordinal: 0, local_name: "__txt_measure", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "804a031c7aa87a69", h_schema: "5c48fdc0e6db9753", h_rule: "" },
  { rel_id: 19, parent_id: 15, ordinal: 0, local_name: "__txt___delta_measure", kind: "view", type_id: 0, arity: 5, module_id: 7, h_id: "b651d175a0f65e15", h_schema: "5c48fdc0e6db9753", h_rule: "" },
  ...
  { rel_id: 23, parent_id: 12, ordinal: 0, local_name: "__txt_total", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "4845f11eaf09918a", h_schema: "0afc9e4df0350232", h_rule: "" },
  { rel_id: 24, parent_id: 20, ordinal: 0, local_name: "__txt___delta_total", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "89d3346991951901", h_schema: "0afc9e4df0350232", h_rule: "" },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "total", kind: "set", table_name: "total", delta_table_name: "__delta_total", frontier_table_name: "__frontier_total", next_frontier_table_name: "__next_frontier_total", columns: ["name", "value"], column_types: ["text", "float"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."name") AND json_type(t."name") = 'object' AND json_type(t."name", '$.fn') = 'text' AND json_type(t."name", '$.args') = 'array' THEN json_extract(t."name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."name", '$.args')), '') || ')' ELSE t."name" END AS "name", t."value", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_total" t WHERE t."_sign" IN (-1, 1) GROUP BY t."name", t."value", t."_sign"`, rule_observers: [] },
];
