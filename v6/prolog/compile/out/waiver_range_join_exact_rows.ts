...
export const demandedRels: readonly string[] = ["eprintln_count/2", "eprintln_counted/2", "eprintln_hit/2", "eprintln_waived/2", "eprintln_waiver_line/2", "waiver_block_comment/2", "waiver_trailing_comment/2"];
