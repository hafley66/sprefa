...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 21, parent_id: 8, ordinal: 0, local_name: "__txt_stream_end", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "c64d4f405e6482d2", h_schema: "d5ce62a8c7d1fb6a", h_rule: "" },
  { rel_id: 22, parent_id: 18, ordinal: 0, local_name: "__txt___delta_stream_end", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "6bc0d5721466b927", h_schema: "d5ce62a8c7d1fb6a", h_rule: "" },
  ...
  { rel_id: 26, parent_id: 11, ordinal: 0, local_name: "__txt_stream_item", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "8d473e44d8934be0", h_schema: "7e04112c925af40b", h_rule: "" },
  { rel_id: 27, parent_id: 23, ordinal: 0, local_name: "__txt___delta_stream_item", kind: "view", type_id: 0, arity: 5, module_id: 7, h_id: "1f5e50fcf308216f", h_schema: "7e04112c925af40b", h_rule: "" },
  ...
  { rel_id: 31, parent_id: 15, ordinal: 0, local_name: "__txt_stream_status", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "b8dd7893434c8b66", h_schema: "d5ce62a8c7d1fb6a", h_rule: "" },
  { rel_id: 32, parent_id: 28, ordinal: 0, local_name: "__txt___delta_stream_status", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "66b585e0ae2371d7", h_schema: "d5ce62a8c7d1fb6a", h_rule: "" },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "stream_item", kind: "log", table_name: "stream_item", delta_table_name: "__delta_stream_item", frontier_table_name: "__frontier_stream_item", next_frontier_table_name: "__next_frontier_stream_item", columns: ["args", "col2", "col3"], column_types: ["text", "int", "text"], key_indices: [], arrival_add_sql: `INSERT INTO "stream_item" ("args", "col2", "col3") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]'), json_extract(value, '$[2]') FROM json_each(?) RETURNING "args", "col2", "col3"`, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."args") AND json_type(t."args") = 'object' AND json_type(t."args", '$.fn') = 'text' AND json_type(t."args", '$.args') = 'array' THEN json_extract(t."args", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."args", '$.args')), '') || ')' ELSE t."args" END AS "args", t."col2", CASE WHEN json_valid(t."col3") AND json_type(t."col3") = 'object' AND json_type(t."col3", '$.fn') = 'text' AND json_type(t."col3", '$.args') = 'array' THEN json_extract(t."col3", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."col3", '$.args')), '') || ')' ELSE t."col3" END AS "col3", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_stream_item" t WHERE t."_sign" IN (-1, 1) GROUP BY t."args", t."col2", t."col3", t."_sign"`, rule_observers: ["stream_status/2"] },
  { rel: "stream_status", kind: "set", table_name: "stream_status", delta_table_name: "__delta_stream_status", frontier_table_name: "__frontier_stream_status", next_frontier_table_name: "__next_frontier_stream_status", columns: ["args", "col2"], column_types: ["text", "text"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."args") AND json_type(t."args") = 'object' AND json_type(t."args", '$.fn') = 'text' AND json_type(t."args", '$.args') = 'array' THEN json_extract(t."args", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."args", '$.args')), '') || ')' ELSE t."args" END AS "args", CASE WHEN json_valid(t."col2") AND json_type(t."col2") = 'object' AND json_type(t."col2", '$.fn') = 'text' AND json_type(t."col2", '$.args') = 'array' THEN json_extract(t."col2", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."col2", '$.args')), '') || ')' ELSE t."col2" END AS "col2", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_stream_status" t WHERE t."_sign" IN (-1, 1) GROUP BY t."args", t."col2", t."_sign"`, rule_observers: [] },
];
