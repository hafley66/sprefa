...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__frontier_set_dedups_log_stacks_heard_count" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  ...
  `CREATE TEMP TABLE "__frontier_set_dedups_log_stacks_seen_count" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE INDEX "__frontier_set_dedups_log_stacks_seen_count_phase" ON "__frontier_set_dedups_log_stacks_seen_count" ("_phase")`,
  `CREATE TEMP TABLE "__next_frontier_set_dedups_log_stacks_seen_count" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "item" INTEGER NOT NULL)`,
  `CREATE TEMP VIEW "__txt___delta_set_dedups_log_stacks_seen_count" AS SELECT (SELECT s."content" FROM "__str" s WHERE s."__id" = t."item") AS "item", t."_sign" AS "_sign", t."_sequence" AS "_sequence" FROM "__delta_set_dedups_log_stacks_seen_count" t`,
];
...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 34, parent_id: 14, ordinal: 0, local_name: "__txt_set_dedups_log_stacks_seen_count", kind: "view", type_id: 0, arity: 1, module_id: 7, h_id: "f512017625370223", h_schema: "4f9957ccb96234b6", h_rule: "" },
  { rel_id: 35, parent_id: 31, ordinal: 0, local_name: "__txt___delta_set_dedups_log_stacks_seen_count", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "2cdd30f1968fd339", h_schema: "4f9957ccb96234b6", h_rule: "" },
