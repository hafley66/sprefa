...
INSERT OR IGNORE INTO "repo" ("name") SELECT b0."repo_name" FROM "rawk" b0`, supportSql: [`DELETE FROM "__support_next_repo"`, `INSERT INTO "__support_next_repo" ("name", "__refcount") SELECT "name", sum("__refcount") FROM (SELECT b0."repo_name" AS "name", count(*) AS "__refcount" FROM "rawk" b0 GROUP BY b0."repo_name") GROUP BY "name"`, `UPDATE "repo" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_repo" n WHERE n."name" = h."name"), 0)`, `INSERT INTO "__delta_repo" ("_sign", "_sequence", "name") SELECT -1, row_number() OVER () - 1, "name" FROM "repo" WHERE "__refcount" <= 0`, `DELETE FROM "repo" WHERE "__refcount" <= 0`, `DELETE FROM "__new_repo"`, `INSERT INTO "__new_repo" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_repo" n LEFT JOIN "repo" h ON n."name" = h."name" WHERE h."name" IS NULL`, `INSERT INTO "__delta_repo" ("_sign", "_sequence", "name") SELECT 1, "rowid" - 1, "name" FROM "__new_repo"`, `INSERT INTO "__frontier_repo" ("_phase", "_sequence", "name") SELECT ?, "rowid" - 1, "name" FROM "__new_repo"`, `INSERT INTO "__next_frontier_repo" ("_phase", "_sequence", "name") SELECT ?, "rowid" - 1, "name" FROM "__new_repo"`, `INSERT OR IGNORE INTO "repo" ("name", "__refcount") SELECT n."name", n."__refcount" FROM "__support_next_repo" n`], aggregateSql: null },
