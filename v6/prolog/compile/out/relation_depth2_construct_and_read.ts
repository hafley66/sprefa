...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "coord" ("path_name" INTEGER NOT NULL, "start" INTEGER NOT NULL, "end" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("path_name", "start", "end")) WITHOUT ROWID`,
...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    coord: select_rows(seam, `SELECT CASE WHEN json_valid("path_name") AND json_type("path_name") = 'object' AND json_type("path_name", '$.fn') = 'text' AND json_type("path_name", '$.args') = 'array' THEN json_extract("path_name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path_name", '$.args')), '') || ')' ELSE "path_name" END AS "path_name", "start", "end" FROM "__txt_coord"`, rel_columns.coord!, rel_column_types.coord!),
...
const final_select: Record<string, string> = {
  coord: `SELECT CASE WHEN json_valid("path_name") AND json_type("path_name") = 'object' AND json_type("path_name", '$.fn') = 'text' AND json_type("path_name", '$.args') = 'array' THEN json_extract("path_name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path_name", '$.args')), '') || ')' ELSE "path_name" END AS "path_name", "start", "end" FROM "__txt_coord"`,
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "coord", kind: "set", table_name: "coord", delta_table_name: "__delta_coord", frontier_table_name: "__frontier_coord", next_frontier_table_name: "__next_frontier_coord", columns: ["path_name", "start", "end"], column_types: ["text", "int", "int"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid("path_name") AND json_type("path_name") = 'object' AND json_type("path_name", '$.fn') = 'text' AND json_type("path_name", '$.args') = 'array' THEN json_extract("path_name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path_name", '$.args')), '') || ')' ELSE "path_name" END AS "path_name", "start", "end", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_coord" WHERE "_sign" IN (-1, 1) GROUP BY "path_name", "start", "end", "_sign"`, rule_observers: [] },
