...
const boot: readonly IBootStatement[] = [
  { sql: `DELETE FROM "counted"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "counted" ("repo", "stars") SELECT json_extract(b0."payload", '$."repo"'), json_extract(b0."payload", '$."stars"') FROM "event" b0 WHERE json_type(b0."payload", '$') = 'object' AND json_type(b0."payload", '$."repo"') = 'text' AND json_type(b0."payload", '$."stars"') = 'integer'`, params: [] },
];
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "counted", headDeltaTableName: "__delta_counted", headColumns: ["repo", "stars"], insertSql: `INSERT OR IGNORE INTO "counted" ("repo", "stars") SELECT DISTINCT json_extract(d0."payload", '$."repo"'), json_extract(d0."payload", '$."stars"') FROM "__frontier_event" d0 WHERE d0."_phase" >= 0 AND json_type(d0."payload", '$') = 'object' AND json_type(d0."payload", '$."repo"') = 'text' AND json_type(d0."payload", '$."stars"') = 'integer' RETURNING "repo", "stars"`, selectSql: `SELECT "repo", "stars" FROM "counted"`, recomputeSql: `DELETE FROM "counted";
