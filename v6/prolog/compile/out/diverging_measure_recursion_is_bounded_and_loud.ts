...
const ddl: readonly string[] = [
  `CREATE TABLE "counter" ("__id" INTEGER PRIMARY KEY, "value" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, UNIQUE ("value"))`,
  `CREATE TABLE "seed_number" ("__id" INTEGER PRIMARY KEY, "value" INTEGER NOT NULL, UNIQUE ("value"))`,
  `CREATE TEMP TABLE "__delta_counter" ("_sign" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
  `CREATE INDEX "__delta_counter_sign" ON "__delta_counter" ("_sign")`,
  `CREATE INDEX "__delta_counter_group" ON "__delta_counter" ("value")`,
  `CREATE TEMP TABLE "__frontier_counter" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
  `CREATE INDEX "__frontier_counter_phase" ON "__frontier_counter" ("_phase")`,
  `CREATE TEMP TABLE "__next_frontier_counter" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
  `CREATE TEMP TABLE "__delta_seed_number" ("_sign" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
  `CREATE INDEX "__delta_seed_number_sign" ON "__delta_seed_number" ("_sign")`,
  `CREATE INDEX "__delta_seed_number_group" ON "__delta_seed_number" ("value")`,
  `CREATE TEMP TABLE "__frontier_seed_number" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
  `CREATE INDEX "__frontier_seed_number_phase" ON "__frontier_seed_number" ("_phase")`,
  `CREATE TEMP TABLE "__next_frontier_seed_number" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "value" INTEGER NOT NULL)`,
  `CREATE TEMP TABLE "__support_next_counter" ("value" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__new_counter" ("value" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL)`,
  `CREATE INDEX "counter_zero" ON "counter" ("__refcount") WHERE "__refcount" <= 0`,
  `CREATE TEMP TABLE "__expand_a_counter" ("value" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__expand_b_counter" ("value" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__ping_counter" ("value" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__pong_counter" ("value" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
  `CREATE TEMP TABLE "__cone_counter" ("value" INTEGER NOT NULL, PRIMARY KEY ("value")) WITHOUT ROWID`,
];
...
const boot: readonly IBootStatement[] = [
  { rel: "counter", sql: `DELETE FROM "counter"`, params: [] },
  { rel: "counter", sql: `INSERT OR IGNORE INTO "counter" ("value") SELECT b0."value" FROM "seed_number" b0`, params: [] },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "seed_number", kind: "set", table_name: "seed_number", delta_table_name: "__delta_seed_number", frontier_table_name: "__frontier_seed_number", next_frontier_table_name: "__next_frontier_seed_number", columns: ["value"], column_types: ["int"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "seed_number" ("value") SELECT json_extract(value, '$[0]') FROM json_each(?) RETURNING "value"`, arrival_del_sql: `DELETE FROM "seed_number" WHERE ("value") IN (SELECT json_extract(value, '$[0]') FROM json_each(?)) RETURNING "value"`, boundary_sql: `SELECT t."value", t."_sign" AS "__sign", count(*) AS "__count" FROM "__delta_seed_number" t WHERE t."_sign" IN (-1, 1) GROUP BY t."value", t."_sign"`, rule_observers: ["counter/1"] },
];
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { head_rel: "counter", rule_id: "diverging_measure_recursion_is_bounded_and_loud:counter/1#1", head_delta_table_name: "__delta_counter", head_columns: ["value"], insert_sql: `INSERT OR IGNORE INTO "counter" ("value") SELECT DISTINCT d0."value" FROM "__frontier_seed_number" d0 WHERE d0."_phase" >= 0 UNION ALL SELECT DISTINCT (d0."value" + 1) FROM "__frontier_counter" d0 WHERE d0."_phase" >= 0 RETURNING "value"`, select_sql: `SELECT "value" FROM "counter"`, recompute_sql: `DELETE FROM "counter";
INSERT OR IGNORE INTO "counter" ("value") SELECT b0."value" FROM "seed_number" b0;
