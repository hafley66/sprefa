...
const INCREMENTAL_EDGE_STATEMENTS: readonly IIncrementalEdgeStatement[] = [
  ...
  { headRel: "numbered", headKind: "log", headTableName: "numbered", headDeltaTableName: "__delta_numbered", headColumns: ["ordinal", "payload"], keyIndices: [], projectSql: `SELECT 1 AS "ordinal", d0."payload" AS "payload" FROM "__frontier_arrival" d0 WHERE d0."_phase" >= 0 AND NOT EXISTS (SELECT 1 FROM "seq_numbered_1" n0 WHERE n0."partition" = 'q') ORDER BY d0."_phase", d0."_sequence"` },
  { headRel: "numbered", headKind: "log", headTableName: "numbered", headDeltaTableName: "__delta_numbered", headColumns: ["ordinal", "payload"], keyIndices: [], projectSql: `SELECT (b0."at" + 1) AS "ordinal", d0."payload" AS "payload" FROM "__frontier_arrival" d0, "__pre_seq_numbered_1" b0 WHERE d0."_phase" >= 0 AND b0."partition" = 'q' ORDER BY d0."_phase", d0."_sequence"` },
];
