...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "doc" ("__id" INTEGER PRIMARY KEY, "body" TEXT NOT NULL CHECK (json_valid("body")), UNIQUE ("body"))`,
  `CREATE TABLE "found" ("__id" INTEGER PRIMARY KEY, "value" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, UNIQUE ("value"))`,
...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 9, parent_id: 6, ordinal: 0, local_name: "found", kind: "rel", type_id: 0, arity: 1, module_id: 6, h_id: "402362f65aa4c0ac", h_schema: "84914f3feaa2025d", h_rule: "3b872cc913600583" },
  ...
  { rel_id: 11, parent_id: 7, ordinal: 0, local_name: "__delta_doc", kind: "delta", type_id: 0, arity: 3, module_id: 6, h_id: "50ad32be00c106c0", h_schema: "669db8c8e0e7991f", h_rule: "" },
  { rel_id: 12, parent_id: 7, ordinal: 0, local_name: "__frontier_doc", kind: "frontier", type_id: 0, arity: 3, module_id: 6, h_id: "b9d8df543eb2c285", h_schema: "c0ff50f985c9f689", h_rule: "" },
  { rel_id: 13, parent_id: 7, ordinal: 0, local_name: "__next_frontier_doc", kind: "next_frontier", type_id: 0, arity: 3, module_id: 6, h_id: "d333511f5737a920", h_schema: "c0ff50f985c9f689", h_rule: "" },
  { rel_id: 14, parent_id: 9, ordinal: 0, local_name: "__delta_found", kind: "delta", type_id: 0, arity: 3, module_id: 6, h_id: "1594bf045eab6a6c", h_schema: "6c1465af2fd8064e", h_rule: "" },
  { rel_id: 15, parent_id: 9, ordinal: 0, local_name: "__frontier_found", kind: "frontier", type_id: 0, arity: 3, module_id: 6, h_id: "fd1ee4be0404aed8", h_schema: "188c68a9f79671d5", h_rule: "" },
  { rel_id: 16, parent_id: 9, ordinal: 0, local_name: "__next_frontier_found", kind: "next_frontier", type_id: 0, arity: 3, module_id: 6, h_id: "1830f392db15bf2d", h_schema: "188c68a9f79671d5", h_rule: "" },
  { rel_id: 17, parent_id: 9, ordinal: 0, local_name: "__txt_found", kind: "view", type_id: 0, arity: 1, module_id: 6, h_id: "31d5e3a37d8e7bfe", h_schema: "84914f3feaa2025d", h_rule: "" },
  { rel_id: 18, parent_id: 14, ordinal: 0, local_name: "__txt___delta_found", kind: "view", type_id: 0, arity: 3, module_id: 6, h_id: "ee7774061c2154f1", h_schema: "84914f3feaa2025d", h_rule: "" },
  { rel_id: 19, parent_id: 6, ordinal: 0, local_name: "__str", kind: "dictionary", type_id: 0, arity: 2, module_id: 6, h_id: "33eea4ec7478d77e", h_schema: "", h_rule: "" },
  { rel_id: 20, parent_id: 9, ordinal: 0, local_name: "__support_next_found", kind: "refcount", type_id: 0, arity: 2, module_id: 6, h_id: "c7222e018afd306a", h_schema: "", h_rule: "" },
  { rel_id: 21, parent_id: 9, ordinal: 0, local_name: "__new_found", kind: "refcount_staging", type_id: 0, arity: 2, module_id: 6, h_id: "8624bd52021a4a60", h_schema: "", h_rule: "" },
  { rel_id: 22, parent_id: 8, ordinal: 1, local_name: "raw_characters", kind: "storage", type_id: 0, arity: 0, module_id: 6, h_id: "3e185a01becd356c", h_schema: "", h_rule: "" },
  { rel_id: 23, parent_id: 10, ordinal: 1, local_name: "interned_id", kind: "storage", type_id: 0, arity: 0, module_id: 6, h_id: "116c4e9dcd3e464f", h_schema: "", h_rule: "" },
];
...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    doc: select_rows(seam, `SELECT t."body" FROM "doc" t`, rel_columns.doc!, rel_column_types.doc!),
    found: select_rows(seam, `SELECT CASE WHEN json_valid(t."value") AND json_type(t."value") = 'object' AND json_type(t."value", '$.fn') = 'text' AND json_type(t."value", '$.args') = 'array' THEN json_extract(t."value", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."value", '$.args')), '') || ')' ELSE t."value" END AS "value" FROM "__txt_found" t`, rel_columns.found!, rel_column_types.found!),
  });
}
...
const final_select: Record<string, string> = {
  doc: `SELECT t."body" FROM "doc" t`,
  found: `SELECT CASE WHEN json_valid(t."value") AND json_type(t."value") = 'object' AND json_type(t."value", '$.fn') = 'text' AND json_type(t."value", '$.args') = 'array' THEN json_extract(t."value", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."value", '$.args')), '') || ')' ELSE t."value" END AS "value" FROM "__txt_found" t`,
};
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "doc", kind: "set", table_name: "doc", delta_table_name: "__delta_doc", frontier_table_name: "__frontier_doc", next_frontier_table_name: "__next_frontier_doc", columns: ["body"], column_types: ["json"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "doc" ("body") SELECT json_extract(value, '$[0]') FROM json_each(?) RETURNING "body"`, arrival_del_sql: `DELETE FROM "doc" WHERE ("body") IN (SELECT json_extract(value, '$[0]') FROM json_each(?)) RETURNING "body"`, boundary_sql: `SELECT t."body", t."_sign" AS "__sign", count(*) AS "__count" FROM "__delta_doc" t WHERE t."_sign" IN (-1, 1) GROUP BY t."body", t."_sign"`, rule_observers: ["found/1"] },
  { rel: "found", kind: "set", table_name: "found", delta_table_name: "__delta_found", frontier_table_name: "__frontier_found", next_frontier_table_name: "__next_frontier_found", columns: ["value"], column_types: ["text"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."value") AND json_type(t."value") = 'object' AND json_type(t."value", '$.fn') = 'text' AND json_type(t."value", '$.args') = 'array' THEN json_extract(t."value", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."value", '$.args')), '') || ')' ELSE t."value" END AS "value", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_found" t WHERE t."_sign" IN (-1, 1) GROUP BY t."value", t."_sign"`, rule_observers: [] },
];
