...
const boot: readonly IBootStatement[] = [
  { sql: `INSERT OR IGNORE INTO "doc" ("body") VALUES (?)`, params: ["{\"a\":1,\"b\":\"text\",\"c\":{\"leaf\":\"here\"},\"d\":[1,2]}"] },
  { sql: `DELETE FROM "found"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "found" ("value") SELECT json_extract(j0.value, '$."leaf"') FROM "doc" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_extract(j0.value, '$."leaf"') IS NOT NULL`, params: [] },
];
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "found", headDeltaTableName: "__delta_found", headColumns: ["value"], insertSql: `INSERT OR IGNORE INTO "found" ("value") SELECT DISTINCT json_extract(j0.value, '$."leaf"') FROM "__frontier_doc" d0, json_tree(d0."body") j0 WHERE d0."_phase" >= 0 AND json_type(d0."body", '$') = 'object' AND j0.type = 'object' AND json_extract(j0.value, '$."leaf"') IS NOT NULL RETURNING "value"`, selectSql: `SELECT "value" FROM "found"`, recomputeSql: `DELETE FROM "found";
