...
INSERT OR IGNORE INTO "found" ("value") SELECT json_extract(j0.value, '$."leaf"') FROM "doc" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_extract(j0.value, '$."leaf"') IS NOT NULL`, supportSql: [`DELETE FROM "__support_next_found"`, `INSERT INTO "__support_next_found" ("value", "__refcount") SELECT "value", sum("__refcount") FROM (SELECT json_extract(j0.value, '$."leaf"') AS "value", count(*) AS "__refcount" FROM "doc" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_extract(j0.value, '$."leaf"') IS NOT NULL GROUP BY json_extract(j0.value, '$."leaf"')) GROUP BY "value"`, `UPDATE "found" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_found" n WHERE n."value" = h."value"), 0)`, `INSERT INTO "__delta_found" ("_sign", "_sequence", "value") SELECT -1, row_number() OVER () - 1, "value" FROM "found" WHERE "__refcount" <= 0`, `DELETE FROM "found" WHERE "__refcount" <= 0`, `DELETE FROM "__new_found"`, `INSERT INTO "__new_found" ("value", "__refcount") SELECT n."value", n."__refcount" FROM "__support_next_found" n LEFT JOIN "found" h ON n."value" = h."value" WHERE h."value" IS NULL`, `INSERT INTO "__delta_found" ("_sign", "_sequence", "value") SELECT 1, "rowid" - 1, "value" FROM "__new_found"`, `INSERT INTO "__frontier_found" ("_phase", "_sequence", "value") SELECT ?, "rowid" - 1, "value" FROM "__new_found"`, `INSERT INTO "__next_frontier_found" ("_phase", "_sequence", "value") SELECT ?, "rowid" - 1, "value" FROM "__new_found"`, `INSERT OR IGNORE INTO "found" ("value", "__refcount") SELECT n."value", n."__refcount" FROM "__support_next_found" n`], aggregateSql: null },
];
