...
const relCatalog: readonly IRelCatalogRow[] = [
  ...
  { relId: 6, parentId: 0, ordinal: 0, localName: "json_descent_into_scalars_is_silent", kind: "module", typeId: 0, arity: 0, moduleId: 6, hId: "e58441083d7f780d", hSchema: "", hRule: "" },
  { relId: 7, parentId: 6, ordinal: 0, localName: "doc", kind: "rel", typeId: 0, arity: 1, moduleId: 6, hId: "e3167f0aac6e0a19", hSchema: "d12f7c978de0f0d7", hRule: "" },
  { relId: 8, parentId: 7, ordinal: 1, localName: "body", kind: "column", typeId: 5, arity: 0, moduleId: 6, hId: "6ca32005e180c030", hSchema: "", hRule: "" },
  { relId: 9, parentId: 6, ordinal: 0, localName: "found", kind: "rel", typeId: 0, arity: 1, moduleId: 6, hId: "402362f65aa4c0ac", hSchema: "84914f3feaa2025d", hRule: "363aacf7f18c71a4" },
  { relId: 10, parentId: 9, ordinal: 1, localName: "value", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "77a36410af54849f", hSchema: "", hRule: "" },
];
...
const arrivalTargets: readonly string[] = ["doc"];
...
const ARRIVAL_STATEMENTS: Record<string, { kind: "log" | "set"; addSql: string; delSql: string | null }> = {
  doc: { kind: "set", addSql: `INSERT OR IGNORE INTO "doc" ("body") VALUES (?)`, delSql: `DELETE FROM "doc" WHERE "body" = ?` },
};
...
INSERT OR IGNORE INTO "found" ("value") SELECT json_extract(j0.value, '$."leaf"') FROM "doc" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_extract(j0.value, '$."leaf"') IS NOT NULL`, supportSql: [`DELETE FROM "__support_next_found"`, `INSERT INTO "__support_next_found" ("value", "__refcount") SELECT "value", sum("__refcount") FROM (SELECT json_extract(j0.value, '$."leaf"') AS "value", count(*) AS "__refcount" FROM "doc" b0, json_tree(b0."body") j0 WHERE json_type(b0."body", '$') = 'object' AND j0.type = 'object' AND json_extract(j0.value, '$."leaf"') IS NOT NULL GROUP BY json_extract(j0.value, '$."leaf"')) GROUP BY "value"`, `UPDATE "found" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_found" n WHERE n."value" = h."value"), 0)`, `INSERT INTO "__delta_found" ("_sign", "_sequence", "value") SELECT -1, row_number() OVER () - 1, "value" FROM "found" WHERE "__refcount" <= 0`, `DELETE FROM "found" WHERE "__refcount" <= 0`, `DELETE FROM "__new_found"`, `INSERT INTO "__new_found" ("value", "__refcount") SELECT n."value", n."__refcount" FROM "__support_next_found" n LEFT JOIN "found" h ON n."value" = h."value" WHERE h."value" IS NULL`, `INSERT INTO "__delta_found" ("_sign", "_sequence", "value") SELECT 1, "rowid" - 1, "value" FROM "__new_found"`, `INSERT INTO "__frontier_found" ("_phase", "_sequence", "value") SELECT ?, "rowid" - 1, "value" FROM "__new_found"`, `INSERT INTO "__next_frontier_found" ("_phase", "_sequence", "value") SELECT ?, "rowid" - 1, "value" FROM "__new_found"`, `INSERT OR IGNORE INTO "found" ("value", "__refcount") SELECT n."value", n."__refcount" FROM "__support_next_found" n`], expandSql: null, dredSql: null, aggregateSql: null },
];
...
function buildDeltas(before: Snapshot, after: Snapshot): ITickDeltas {
  const doc = multisetDiff(before.doc, after.doc);
