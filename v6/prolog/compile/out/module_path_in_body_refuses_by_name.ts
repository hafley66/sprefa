...
// hand-edit; recompile. Program: module_path_in_body_refuses_by_name.
...
const ddl: readonly string[] = [
  `CREATE TABLE "orchard__fruit" ("tree_id" INTEGER NOT NULL, "picked" INTEGER NOT NULL, PRIMARY KEY ("tree_id", "picked")) WITHOUT ROWID`,
  `CREATE TABLE "ripe" ("tree_id" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("tree_id")) WITHOUT ROWID`,
...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 6, parent_id: 0, ordinal: 0, local_name: "module_path_in_body_refuses_by_name", kind: "module", type_id: 0, arity: 0, module_id: 6, h_id: "46c5e09af139fb27", h_schema: "", h_rule: "" },
  { rel_id: 7, parent_id: 12, ordinal: 0, local_name: "fruit", kind: "rel", type_id: 0, arity: 2, module_id: 6, h_id: "95dbe8b9bd04434c", h_schema: "c10cd2ee5a451cce", h_rule: "" },
  { rel_id: 8, parent_id: 7, ordinal: 1, local_name: "tree_id", kind: "column", type_id: 2, arity: 0, module_id: 6, h_id: "455e34e1aacc1c0b", h_schema: "", h_rule: "" },
  { rel_id: 9, parent_id: 7, ordinal: 2, local_name: "picked", kind: "column", type_id: 2, arity: 0, module_id: 6, h_id: "b74602ba898df3ad", h_schema: "", h_rule: "" },
  { rel_id: 10, parent_id: 6, ordinal: 0, local_name: "ripe", kind: "rel", type_id: 0, arity: 1, module_id: 6, h_id: "6143a9b1671a7137", h_schema: "f9ef23491f91e03d", h_rule: "da88ccf9443d4d9f" },
  { rel_id: 11, parent_id: 10, ordinal: 1, local_name: "tree_id", kind: "column", type_id: 2, arity: 0, module_id: 6, h_id: "9deb887ddec30059", h_schema: "", h_rule: "" },
  { rel_id: 12, parent_id: 6, ordinal: 0, local_name: "orchard", kind: "rel", type_id: 0, arity: 0, module_id: 6, h_id: "ab6c1e41c2bafe17", h_schema: "", h_rule: "" },
  { rel_id: 13, parent_id: 7, ordinal: 0, local_name: "__delta_orchard__fruit", kind: "delta", type_id: 0, arity: 4, module_id: 6, h_id: "826237592121344e", h_schema: "bf2e3fe79a36e009", h_rule: "" },
  { rel_id: 14, parent_id: 7, ordinal: 0, local_name: "__frontier_orchard__fruit", kind: "frontier", type_id: 0, arity: 4, module_id: 6, h_id: "7c5d6cced5d3acdf", h_schema: "f0b09e9ac03edd62", h_rule: "" },
  { rel_id: 15, parent_id: 7, ordinal: 0, local_name: "__next_frontier_orchard__fruit", kind: "next_frontier", type_id: 0, arity: 4, module_id: 6, h_id: "35d74f067f9a67b8", h_schema: "f0b09e9ac03edd62", h_rule: "" },
  { rel_id: 16, parent_id: 10, ordinal: 0, local_name: "__delta_ripe", kind: "delta", type_id: 0, arity: 3, module_id: 6, h_id: "f6c034dbc6d791e2", h_schema: "3fac23d94c210ea6", h_rule: "" },
  { rel_id: 17, parent_id: 10, ordinal: 0, local_name: "__frontier_ripe", kind: "frontier", type_id: 0, arity: 3, module_id: 6, h_id: "51f8496ffbd5d447", h_schema: "459af400e4fe51d7", h_rule: "" },
  { rel_id: 18, parent_id: 10, ordinal: 0, local_name: "__next_frontier_ripe", kind: "next_frontier", type_id: 0, arity: 3, module_id: 6, h_id: "9f4bb8c70a3ed99f", h_schema: "459af400e4fe51d7", h_rule: "" },
  { rel_id: 19, parent_id: 10, ordinal: 0, local_name: "__support_next_ripe", kind: "refcount", type_id: 0, arity: 2, module_id: 6, h_id: "b07508d3a26b3a5e", h_schema: "", h_rule: "" },
  { rel_id: 20, parent_id: 10, ordinal: 0, local_name: "__new_ripe", kind: "refcount_staging", type_id: 0, arity: 2, module_id: 6, h_id: "0bd8d920a8ce8d6a", h_schema: "", h_rule: "" },
  { rel_id: 21, parent_id: 8, ordinal: 1, local_name: "raw_characters", kind: "storage", type_id: 0, arity: 0, module_id: 6, h_id: "3c3a2f993078606a", h_schema: "", h_rule: "" },
  { rel_id: 22, parent_id: 9, ordinal: 2, local_name: "raw_characters", kind: "storage", type_id: 0, arity: 0, module_id: 6, h_id: "43a1bb634aaececd", h_schema: "", h_rule: "" },
  { rel_id: 23, parent_id: 11, ordinal: 1, local_name: "raw_characters", kind: "storage", type_id: 0, arity: 0, module_id: 6, h_id: "1ab3048bc459728e", h_schema: "", h_rule: "" },
];
...
type Snapshot = {
  readonly orchard__fruit: readonly IRow[];
  readonly ripe: readonly IRow[];
};
...
const ARRIVAL_STATEMENTS: Record<string, { kind: "log" | "set"; add_sql: string; del_sql: string | null }> = {
  orchard__fruit: { kind: "set", add_sql: `INSERT OR IGNORE INTO "orchard__fruit" ("tree_id", "picked") VALUES (?, ?)`, del_sql: `DELETE FROM "orchard__fruit" WHERE "tree_id" = ? AND "picked" = ?` },
};

function arrival_statement(arrival: IArrivalRow): SqlStatement {
  const template = ARRIVAL_STATEMENTS[arrival.rel];
  if (template === undefined) {
    throw new Error(`module_path_in_body_refuses_by_name: tick received an arrival for undeclared rel '${arrival.rel}'`);
  }
  if (arrival.sign === "del") {
    if (template.kind === "log") {
      throw new Error(`module_path_in_body_refuses_by_name: retract from log rel '${arrival.rel}' (engine.pl retract_from_log)`);
    }
    if (template.del_sql === null) {
      throw new Error(`module_path_in_body_refuses_by_name: rel '${arrival.rel}' has no delete statement`);
    }
...
function recompute_levels(seam: ISqlSeam): Observable<void> {
  const sql = `DELETE FROM "ripe";
INSERT OR IGNORE INTO "ripe" ("tree_id") SELECT b0."tree_id" FROM "orchard__fruit" b0`;
  return seam.runner.executeMultiple(seam.db, sql);
}

function build_deltas(before: Snapshot, after: Snapshot): ITickDeltas {
  const orchard__fruit = multiset_diff(before.orchard__fruit, after.orchard__fruit);
  const ripe = multiset_diff(before.ripe, after.ripe);
  return {
    rels: [
      { rel: "orchard__fruit", add: orchard__fruit.add, del: orchard__fruit.del },
      { rel: "ripe", add: ripe.add, del: ripe.del },
    ],
    carry_pending: false,
  };
}
...
function run_naive_tick(seam: ISqlSeam, arrivals: IArrivalBatch): Observable<ITickDeltas> {
  ...
  // module_path_in_body_refuses_by_name: no edge rules -- absorb arrivals, recompute levels, diff.
}
...
export const program: IGenProgramWithBoot = {
  name: "module_path_in_body_refuses_by_name",
  internMode: "dict",
  ddl,
  rel_columns,
  rel_column_types,
