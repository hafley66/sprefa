...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 18, parent_id: 8, ordinal: 0, local_name: "__txt_fragment_line", kind: "view", type_id: 0, arity: 3, module_id: 7, h_id: "ceb686f426c82fbf", h_schema: "02653488dcd5c6ed", h_rule: "" },
  { rel_id: 19, parent_id: 15, ordinal: 0, local_name: "__txt___delta_fragment_line", kind: "view", type_id: 0, arity: 5, module_id: 7, h_id: "bb61eef9a8505d15", h_schema: "02653488dcd5c6ed", h_rule: "" },
  ...
  { rel_id: 23, parent_id: 12, ordinal: 0, local_name: "__txt_fragment_text", kind: "view", type_id: 0, arity: 2, module_id: 7, h_id: "99a7e33f98be24e2", h_schema: "e50c9c5f140eebea", h_rule: "" },
  { rel_id: 24, parent_id: 20, ordinal: 0, local_name: "__txt___delta_fragment_text", kind: "view", type_id: 0, arity: 4, module_id: 7, h_id: "99dc723d50399bbf", h_schema: "e50c9c5f140eebea", h_rule: "" },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "fragment_text", kind: "set", table_name: "fragment_text", delta_table_name: "__delta_fragment_text", frontier_table_name: "__frontier_fragment_text", next_frontier_table_name: "__next_frontier_fragment_text", columns: ["fragment_name", "col2"], column_types: ["text", "text"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid(t."fragment_name") AND json_type(t."fragment_name") = 'object' AND json_type(t."fragment_name", '$.fn') = 'text' AND json_type(t."fragment_name", '$.args') = 'array' THEN json_extract(t."fragment_name", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."fragment_name", '$.args')), '') || ')' ELSE t."fragment_name" END AS "fragment_name", CASE WHEN json_valid(t."col2") AND json_type(t."col2") = 'object' AND json_type(t."col2", '$.fn') = 'text' AND json_type(t."col2", '$.args') = 'array' THEN json_extract(t."col2", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each(t."col2", '$.args')), '') || ')' ELSE t."col2" END AS "col2", t."_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_fragment_text" t WHERE t."_sign" IN (-1, 1) GROUP BY t."fragment_name", t."col2", t."_sign"`, rule_observers: [] },
];
