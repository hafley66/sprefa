...
function readSnapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    hook_window: selectRows(seam, `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", "since" FROM "hook_window"`, relColumns.hook_window!, relColumnTypes.hook_window!),
    lint_count: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count" FROM "lint_count"`, relColumns.lint_count!, relColumnTypes.lint_count!),
    ratchet: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "allowed" FROM "ratchet"`, relColumns.ratchet!, relColumnTypes.ratchet!),
    turn_diag: selectRows(seam, `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", CASE WHEN json_valid("path") AND json_type("path") = 'object' THEN json_extract("path", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("path", '$.args')) || ')' ELSE "path" END AS "path", "line", CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "opened_at" FROM "turn_diag"`, relColumns.turn_diag!, relColumnTypes.turn_diag!),
    unratcheted_lint: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count" FROM "unratcheted_lint"`, relColumns.unratcheted_lint!, relColumnTypes.unratcheted_lint!),
    violation: selectRows(seam, `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count", "allowed" FROM "violation"`, relColumns.violation!, relColumnTypes.violation!),
  });
}
...
const finalSelect: Record<string, string> = {
  ...
  hook_window: `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", "since" FROM "hook_window"`,
  lint_count: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count" FROM "lint_count"`,
  ratchet: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "allowed" FROM "ratchet"`,
  turn_diag: `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", CASE WHEN json_valid("path") AND json_type("path") = 'object' THEN json_extract("path", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("path", '$.args')) || ')' ELSE "path" END AS "path", "line", CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "opened_at" FROM "turn_diag"`,
  unratcheted_lint: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count" FROM "unratcheted_lint"`,
  violation: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count", "allowed" FROM "violation"`,
};
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "hook_window", kind: "set", tableName: "hook_window", deltaTableName: "__delta_hook_window", frontierTableName: "__frontier_hook_window", nextFrontierTableName: "__next_frontier_hook_window", columns: ["turn", "since"], columnTypes: ["text", "int"], keyIndices: [0], arrivalAddSql: `INSERT INTO "hook_window" ("turn", "since") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) WHERE true ON CONFLICT ("turn") DO UPDATE SET "since" = excluded."since" RETURNING "turn", "since"`, arrivalDelSql: `DELETE FROM "hook_window" WHERE ("turn", "since") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?)) RETURNING "turn", "since"`, boundarySql: `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", "since", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_hook_window" WHERE "_sign" IN (-1, 1) GROUP BY "turn", "since", "_sign"` },
  { rel: "lint_count", kind: "set", tableName: "lint_count", deltaTableName: "__delta_lint_count", frontierTableName: "__frontier_lint_count", nextFrontierTableName: "__next_frontier_lint_count", columns: ["code", "count"], columnTypes: ["text", "int"], keyIndices: [], arrivalAddSql: null, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_lint_count" WHERE "_sign" IN (-1, 1) GROUP BY "code", "count", "_sign"` },
  { rel: "ratchet", kind: "set", tableName: "ratchet", deltaTableName: "__delta_ratchet", frontierTableName: "__frontier_ratchet", nextFrontierTableName: "__next_frontier_ratchet", columns: ["code", "allowed"], columnTypes: ["text", "int"], keyIndices: [0], arrivalAddSql: `INSERT INTO "ratchet" ("code", "allowed") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) WHERE true ON CONFLICT ("code") DO UPDATE SET "allowed" = excluded."allowed" RETURNING "code", "allowed"`, arrivalDelSql: `DELETE FROM "ratchet" WHERE ("code", "allowed") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?)) RETURNING "code", "allowed"`, boundarySql: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "allowed", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_ratchet" WHERE "_sign" IN (-1, 1) GROUP BY "code", "allowed", "_sign"` },
  { rel: "turn_diag", kind: "set", tableName: "turn_diag", deltaTableName: "__delta_turn_diag", frontierTableName: "__frontier_turn_diag", nextFrontierTableName: "__next_frontier_turn_diag", columns: ["turn", "path", "line", "code", "opened_at"], columnTypes: ["text", "text", "int", "text", "int"], keyIndices: [], arrivalAddSql: null, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("turn") AND json_type("turn") = 'object' THEN json_extract("turn", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("turn", '$.args')) || ')' ELSE "turn" END AS "turn", CASE WHEN json_valid("path") AND json_type("path") = 'object' THEN json_extract("path", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("path", '$.args')) || ')' ELSE "path" END AS "path", "line", CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "opened_at", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_turn_diag" WHERE "_sign" IN (-1, 1) GROUP BY "turn", "path", "line", "code", "opened_at", "_sign"` },
  { rel: "unratcheted_lint", kind: "set", tableName: "unratcheted_lint", deltaTableName: "__delta_unratcheted_lint", frontierTableName: "__frontier_unratcheted_lint", nextFrontierTableName: "__next_frontier_unratcheted_lint", columns: ["code", "count"], columnTypes: ["text", "int"], keyIndices: [], arrivalAddSql: null, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_unratcheted_lint" WHERE "_sign" IN (-1, 1) GROUP BY "code", "count", "_sign"` },
  { rel: "violation", kind: "set", tableName: "violation", deltaTableName: "__delta_violation", frontierTableName: "__frontier_violation", nextFrontierTableName: "__next_frontier_violation", columns: ["code", "count", "allowed"], columnTypes: ["text", "int", "int"], keyIndices: [], arrivalAddSql: null, arrivalDelSql: null, boundarySql: `SELECT CASE WHEN json_valid("code") AND json_type("code") = 'object' THEN json_extract("code", '$.fn') || '(' || (SELECT group_concat(value, ',') FROM json_each("code", '$.args')) || ')' ELSE "code" END AS "code", "count", "allowed", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_violation" WHERE "_sign" IN (-1, 1) GROUP BY "code", "count", "allowed", "_sign"` },
];
