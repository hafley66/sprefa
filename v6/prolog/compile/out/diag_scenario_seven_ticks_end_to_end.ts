...
const ARRIVAL_STATEMENTS: Record<string, { kind: "log" | "set"; addSql: string; delSql: string | null }> = {
  ...
  hook_window: { kind: "set", addSql: `INSERT OR REPLACE INTO "hook_window" ("turn", "since") VALUES (?, ?)`, delSql: `DELETE FROM "hook_window" WHERE "turn" = ? AND "since" = ?` },
  ratchet: { kind: "set", addSql: `INSERT OR REPLACE INTO "ratchet" ("code", "allowed") VALUES (?, ?)`, delSql: `DELETE FROM "ratchet" WHERE "code" = ? AND "allowed" = ?` },
};
