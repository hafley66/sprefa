...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__frontier_ordered_json_group_array_integer_values_integer_sorted" ("_phase" INTEGER NOT NULL, "_sequence" INTEGER NOT NULL, "group" INTEGER NOT NULL, "col2" TEXT NOT NULL CHECK (json_valid("col2")))`,
