...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "cache_row" ("target" INTEGER NOT NULL, "body" INTEGER NOT NULL, PRIMARY KEY ("target")) WITHOUT ROWID`,
  ...
  `CREATE TABLE "feed_view" ("target" INTEGER NOT NULL, "body" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("target", "body")) WITHOUT ROWID`,
