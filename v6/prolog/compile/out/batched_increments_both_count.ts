...
export const demandedRels: readonly string[] = ["counter/2", "increment/2"];
...
const INCREMENTAL_EDGE_STATEMENTS: readonly IIncrementalEdgeStatement[] = [
  { headRel: "counter", ruleId: "batched_increments_both_count:counter/2#1", headKind: "set", headTableName: "counter", headDeltaTableName: "__delta_counter", headColumns: ["name", "next"], keyIndices: [0], projectSql: `SELECT d0."name" AS "name", (b0."next" + 1) AS "next" FROM "__frontier_increment" d0, "__pre_counter" b0 WHERE d0."_phase" >= 0 AND b0."name" = d0."name" ORDER BY d0."_phase", d0."_sequence"` },
];
