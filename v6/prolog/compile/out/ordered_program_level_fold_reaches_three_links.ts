...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "ping" ("partition" INTEGER NOT NULL, PRIMARY KEY ("partition")) WITHOUT ROWID`,
  ...
  `CREATE TABLE "seq_ping_ordinal_2" ("partition" INTEGER NOT NULL, "at" INTEGER NOT NULL, PRIMARY KEY ("partition")) WITHOUT ROWID`,
