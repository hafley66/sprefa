...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    ...
    ping: select_rows(seam, `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition" FROM "__txt_ping" t`, rel_columns.ping!, rel_column_types.ping!),
    ping_ordinal: select_rows(seam, `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "col2" FROM "__txt_ping_ordinal" t`, rel_columns.ping_ordinal!, rel_column_types.ping_ordinal!),
    seq_ping_ordinal_2: select_rows(seam, `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "at" FROM "__txt_seq_ping_ordinal_2" t`, rel_columns.seq_ping_ordinal_2!, rel_column_types.seq_ping_ordinal_2!),
  });
}
...
const final_select: Record<string, string> = {
  ...
  ping: `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition" FROM "__txt_ping" t`,
  ping_ordinal: `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "col2" FROM "__txt_ping_ordinal" t`,
  seq_ping_ordinal_2: `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "at" FROM "__txt_seq_ping_ordinal_2" t`,
};
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "ping", kind: "set", table_name: "ping", delta_table_name: "__delta_ping", frontier_table_name: "__frontier_ping", next_frontier_table_name: "__next_frontier_ping", columns: ["partition"], column_types: ["text"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "ping" ("partition") SELECT json_extract(value, '$[0]') FROM json_each(?) RETURNING "partition"`, arrival_del_sql: `DELETE FROM "ping" WHERE ("partition") IN (SELECT json_extract(value, '$[0]') FROM json_each(?)) RETURNING "partition"`, boundary_sql: `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_ping" t WHERE "_sign" IN (-1, 1) GROUP BY "partition", "_sign"`, rule_observers: ["ping_ordinal/2", "seq_ping_ordinal_2/2"] },
  { rel: "ping_ordinal", kind: "log", table_name: "ping_ordinal", delta_table_name: "__delta_ping_ordinal", frontier_table_name: "__frontier_ping_ordinal", next_frontier_table_name: "__next_frontier_ping_ordinal", columns: ["partition", "col2"], column_types: ["text", "int"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "col2", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_ping_ordinal" t WHERE "_sign" IN (-1, 1) GROUP BY "partition", "col2", "_sign"`, rule_observers: [] },
  { rel: "seq_ping_ordinal_2", kind: "set", table_name: "seq_ping_ordinal_2", delta_table_name: "__delta_seq_ping_ordinal_2", frontier_table_name: "__frontier_seq_ping_ordinal_2", next_frontier_table_name: "__next_frontier_seq_ping_ordinal_2", columns: ["partition", "at"], column_types: ["text", "int"], key_indices: [0], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid("partition") AND json_type("partition") = 'object' AND json_type("partition", '$.fn') = 'text' AND json_type("partition", '$.args') = 'array' THEN json_extract("partition", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("partition", '$.args')), '') || ')' ELSE "partition" END AS "partition", "at", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_seq_ping_ordinal_2" t WHERE "_sign" IN (-1, 1) GROUP BY "partition", "at", "_sign"`, rule_observers: [] },
];
