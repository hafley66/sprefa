...
const ddl: readonly string[] = [
  ...
  `CREATE TABLE "leg_total" ("leg_id" INTEGER NOT NULL, "dispatch_id" INTEGER NOT NULL, "kilos" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL DEFAULT 1, PRIMARY KEY ("leg_id", "dispatch_id", "kilos")) WITHOUT ROWID`,
  ...
  `CREATE TEMP TABLE "__support_next_leg_total" ("leg_id" INTEGER NOT NULL, "dispatch_id" INTEGER NOT NULL, "kilos" INTEGER NOT NULL, "__support_count" INTEGER NOT NULL, PRIMARY KEY ("leg_id", "dispatch_id", "kilos")) WITHOUT ROWID`,
