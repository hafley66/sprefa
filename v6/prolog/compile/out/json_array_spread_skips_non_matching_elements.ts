...
const boot: readonly IBootStatement[] = [
  { sql: `INSERT OR IGNORE INTO "resp" ("body") VALUES (?)`, params: ["[{\"number\":1},{\"title\":\"no_number\"},{\"number\":3}]"] },
  { sql: `DELETE FROM "numbered"`, params: [] },
  { sql: `INSERT OR IGNORE INTO "numbered" ("number") SELECT json_extract(j0.value, '$."number"') FROM "resp" b0, json_each(b0."body") j0 WHERE json_type(b0."body", '$') = 'array' AND j0.type = 'object' AND json_extract(j0.value, '$."number"') IS NOT NULL`, params: [] },
];
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { headRel: "numbered", headDeltaTableName: "__delta_numbered", headColumns: ["number"], insertSql: `INSERT OR IGNORE INTO "numbered" ("number") SELECT DISTINCT json_extract(j0.value, '$."number"') FROM "__frontier_resp" d0, json_each(d0."body") j0 WHERE d0."_phase" >= 0 AND json_type(d0."body", '$') = 'array' AND j0.type = 'object' AND json_extract(j0.value, '$."number"') IS NOT NULL RETURNING "number"`, selectSql: `SELECT "number" FROM "numbered"`, recomputeSql: `DELETE FROM "numbered";
