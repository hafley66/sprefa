...
const ddl: readonly string[] = [
  ...
  `CREATE INDEX "__next_frontier_dir_file_phase" ON "__next_frontier_dir_file" ("_phase")`,
  ...
  `CREATE INDEX "__next_frontier_dir_size_phase" ON "__next_frontier_dir_size" ("_phase")`,
  ...
  `CREATE INDEX "__next_frontier_files_resp_phase" ON "__next_frontier_files_resp" ("_phase")`,
  ...
  `CREATE INDEX "__next_frontier_in_dir_phase" ON "__next_frontier_in_dir" ("_phase")`,
  ...
  `CREATE INDEX "__next_frontier_pr_file_phase" ON "__next_frontier_pr_file" ("_phase")`,
...
INSERT OR IGNORE INTO "dir_file" ("dir", "path", "adds", "dels") SELECT b1."dir", b0."path", b0."adds", b0."dels" FROM "pr_file" b0, "in_dir" b1 WHERE b1."path" = b0."path"`, supportSql: [`DELETE FROM "__support_next_dir_file"`, `INSERT INTO "__support_next_dir_file" ("dir", "path", "adds", "dels", "__refcount") SELECT "dir", "path", "adds", "dels", sum("__refcount") FROM (SELECT b1."dir" AS "dir", b0."path" AS "path", b0."adds" AS "adds", b0."dels" AS "dels", count(*) AS "__refcount" FROM "pr_file" b0, "in_dir" b1 WHERE b1."path" = b0."path" GROUP BY b1."dir", b0."path", b0."adds", b0."dels") GROUP BY "dir", "path", "adds", "dels"`, `UPDATE "dir_file" AS h SET "__refcount" = "__refcount" - ("__refcount" - COALESCE((SELECT n."__refcount" FROM "__support_next_dir_file" n WHERE n."dir" = h."dir" AND n."path" = h."path" AND n."adds" = h."adds" AND n."dels" = h."dels"), 0))`, `DELETE FROM "dir_file" WHERE "__refcount" <= 0 RETURNING "dir", "path", "adds", "dels"`, `INSERT INTO "dir_file" ("dir", "path", "adds", "dels", "__refcount") SELECT "dir", "path", "adds", "dels", n."__refcount" FROM "__support_next_dir_file" n WHERE NOT EXISTS (SELECT 1 FROM "dir_file" h WHERE n."dir" = h."dir" AND n."path" = h."path" AND n."adds" = h."adds" AND n."dels" = h."dels") RETURNING "dir", "path", "adds", "dels"`], aggregateSql: null },
