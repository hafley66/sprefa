...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    body_page: select_rows(seam, `SELECT "id", "view" FROM "body_page" t`, rel_columns.body_page!, rel_column_types.body_page!),
    body_redirect: select_rows(seam, `SELECT "id", CASE WHEN json_valid("to") AND json_type("to") = 'object' AND json_type("to", '$.fn') = 'text' AND json_type("to", '$.args') = 'array' THEN json_extract("to", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("to", '$.args')), '') || ')' ELSE "to" END AS "to" FROM "__txt_body_redirect" t`, rel_columns.body_redirect!, rel_column_types.body_redirect!),
    body_tag: select_rows(seam, `SELECT "id", CASE WHEN json_valid("tag") AND json_type("tag") = 'object' AND json_type("tag", '$.fn') = 'text' AND json_type("tag", '$.args') = 'array' THEN json_extract("tag", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("tag", '$.args')), '') || ')' ELSE "tag" END AS "tag" FROM "__txt_body_tag" t`, rel_columns.body_tag!, rel_column_types.body_tag!),
  });
}
...
const final_select: Record<string, string> = {
  body_page: `SELECT "id", "view" FROM "body_page" t`,
  body_redirect: `SELECT "id", CASE WHEN json_valid("to") AND json_type("to") = 'object' AND json_type("to", '$.fn') = 'text' AND json_type("to", '$.args') = 'array' THEN json_extract("to", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("to", '$.args')), '') || ')' ELSE "to" END AS "to" FROM "__txt_body_redirect" t`,
  body_tag: `SELECT "id", CASE WHEN json_valid("tag") AND json_type("tag") = 'object' AND json_type("tag", '$.fn') = 'text' AND json_type("tag", '$.args') = 'array' THEN json_extract("tag", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("tag", '$.args')), '') || ')' ELSE "tag" END AS "tag" FROM "__txt_body_tag" t`,
};
