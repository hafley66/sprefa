...
const rel_catalog: readonly IRelCatalogRow[] = [
  ...
  { rel_id: 11, parent_id: 6, ordinal: 0, local_name: "dirty", kind: "rel", type_id: 0, arity: 1, module_id: 6, h_id: "758d4d10842c7ac3", h_schema: "8596fa45d0ad8be0", h_rule: "e2fb162c1088fc1f" },
  ...
  { rel_id: 13, parent_id: 6, ordinal: 0, local_name: "head", kind: "rel", type_id: 0, arity: 2, module_id: 6, h_id: "bac55cb00d583a84", h_schema: "8cb497737c5383d9", h_rule: "e22432c07cde4945" },
  ...
  { rel_id: 19, parent_id: 6, ordinal: 0, local_name: "tree_file", kind: "rel", type_id: 0, arity: 3, module_id: 6, h_id: "1d4d6fdbea803389", h_schema: "06bf0b6575bf507c", h_rule: "f6000d08510bc9e0" },
  ...
  { rel_id: 26, parent_id: 6, ordinal: 0, local_name: "worktree_file", kind: "rel", type_id: 0, arity: 2, module_id: 6, h_id: "7b37abea33a30151", h_schema: "51a74f217d2cad97", h_rule: "2681cc8b3640c8ce" },
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "commit_arrival", kind: "log", table_name: "commit_arrival", delta_table_name: "__delta_commit_arrival", frontier_table_name: "__frontier_commit_arrival", next_frontier_table_name: "__next_frontier_commit_arrival", columns: ["rev_id", "path", "digest"], column_types: ["int", "text", "text"], key_indices: [], arrival_add_sql: `INSERT INTO "commit_arrival" ("rev_id", "path", "digest") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]'), json_extract(value, '$[2]') FROM json_each(?) RETURNING "rev_id", "path", "digest"`, arrival_del_sql: null, boundary_sql: `SELECT "rev_id", CASE WHEN json_valid("path") AND json_type("path") = 'object' AND json_type("path", '$.fn') = 'text' AND json_type("path", '$.args') = 'array' THEN json_extract("path", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path", '$.args')), '') || ')' ELSE "path" END AS "path", CASE WHEN json_valid("digest") AND json_type("digest") = 'object' AND json_type("digest", '$.fn') = 'text' AND json_type("digest", '$.args') = 'array' THEN json_extract("digest", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("digest", '$.args')), '') || ')' ELSE "digest" END AS "digest", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_commit_arrival" WHERE "_sign" IN (-1, 1) GROUP BY "rev_id", "path", "digest", "_sign"`, rule_observers: ["tree_file/3"] },
  ...
  { rel: "tree_file", kind: "set", table_name: "tree_file", delta_table_name: "__delta_tree_file", frontier_table_name: "__frontier_tree_file", next_frontier_table_name: "__next_frontier_tree_file", columns: ["rev_id", "path", "digest"], column_types: ["int", "text", "text"], key_indices: [0, 1], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT "rev_id", CASE WHEN json_valid("path") AND json_type("path") = 'object' AND json_type("path", '$.fn') = 'text' AND json_type("path", '$.args') = 'array' THEN json_extract("path", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("path", '$.args')), '') || ')' ELSE "path" END AS "path", CASE WHEN json_valid("digest") AND json_type("digest") = 'object' AND json_type("digest", '$.fn') = 'text' AND json_type("digest", '$.args') = 'array' THEN json_extract("digest", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("digest", '$.args')), '') || ')' ELSE "digest" END AS "digest", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_tree_file" WHERE "_sign" IN (-1, 1) GROUP BY "rev_id", "path", "digest", "_sign"`, rule_observers: ["dirty/1"] },
...
const INCREMENTAL_LEVEL_STATEMENTS: readonly IIncrementalLevelStatement[] = [
  { head_rel: "dirty", rule_id: "dirty_retracts_on_matching_commit:dirty/1#1", head_delta_table_name: "__delta_dirty", head_columns: ["path"], insert_sql: `INSERT OR IGNORE INTO "dirty" ("path") SELECT DISTINCT d0."path" FROM "__frontier_worktree_file" d0, "head" b0, "tree_file" b1 WHERE d0."_phase" >= 0 AND b1."rev_id" = b0."rev_id" AND b1."path" = d0."path" AND (d0."digest" <> b1."digest") UNION ALL SELECT DISTINCT b0."path" FROM "__frontier_head" d0, "worktree_file" b0, "tree_file" b1 WHERE d0."_phase" >= 0 AND b1."rev_id" = d0."rev_id" AND b1."path" = b0."path" AND (b0."digest" <> b1."digest") UNION ALL SELECT DISTINCT d0."path" FROM "__frontier_tree_file" d0, "worktree_file" b0, "head" b1 WHERE d0."_phase" >= 0 AND b0."path" = d0."path" AND b1."rev_id" = d0."rev_id" AND (b0."digest" <> d0."digest") RETURNING "path"`, select_sql: `SELECT "path" FROM "dirty"`, recompute_sql: `DELETE FROM "dirty";
INSERT OR IGNORE INTO "dirty" ("path") SELECT b0."path" FROM "worktree_file" b0, "head" b1, "tree_file" b2 WHERE b2."rev_id" = b1."rev_id" AND b2."path" = b0."path" AND (b0."digest" <> b2."digest")`, support_sql: [`DELETE FROM "__support_next_dirty"`, `INSERT INTO "__support_next_dirty" ("path", "__refcount") SELECT "path", sum("__refcount") FROM (SELECT b0."path" AS "path", count(*) AS "__refcount" FROM "worktree_file" b0, "head" b1, "tree_file" b2 WHERE b2."rev_id" = b1."rev_id" AND b2."path" = b0."path" AND (b0."digest" <> b2."digest") GROUP BY b0."path") GROUP BY "path"`, `UPDATE "dirty" AS h SET "__refcount" = COALESCE((SELECT n."__refcount" FROM "__support_next_dirty" n WHERE n."path" = h."path"), 0)`, `INSERT INTO "__delta_dirty" ("_sign", "_sequence", "path") SELECT -1, row_number() OVER () - 1, "path" FROM "dirty" WHERE "__refcount" <= 0`, `DELETE FROM "dirty" WHERE "__refcount" <= 0`, `DELETE FROM "__new_dirty"`, `INSERT INTO "__new_dirty" ("path", "__refcount") SELECT n."path", n."__refcount" FROM "__support_next_dirty" n LEFT JOIN "dirty" h ON n."path" = h."path" WHERE h."path" IS NULL`, `INSERT INTO "__delta_dirty" ("_sign", "_sequence", "path") SELECT 1, "rowid" - 1, "path" FROM "__new_dirty"`, `INSERT INTO "__frontier_dirty" ("_phase", "_sequence", "path") SELECT ?, "rowid" - 1, "path" FROM "__new_dirty"`, `INSERT INTO "__next_frontier_dirty" ("_phase", "_sequence", "path") SELECT ?, "rowid" - 1, "path" FROM "__new_dirty"`, `INSERT OR IGNORE INTO "dirty" ("path", "__refcount") SELECT n."path", n."__refcount" FROM "__support_next_dirty" n`], expand_sql: null, dred_sql: null, fixpoint_ir: null, aggregate_sql: null },
];
