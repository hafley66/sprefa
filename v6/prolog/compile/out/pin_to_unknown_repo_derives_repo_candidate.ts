...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    known_repo: select_rows(seam, `SELECT "to_repo_id" FROM "known_repo" t`, rel_columns.known_repo!, rel_column_types.known_repo!),
    ...
    repo_candidate: select_rows(seam, `SELECT "to_repo_id" FROM "repo_candidate" t`, rel_columns.repo_candidate!, rel_column_types.repo_candidate!),
...
const final_select: Record<string, string> = {
  known_repo: `SELECT "to_repo_id" FROM "known_repo" t`,
  ...
  repo_candidate: `SELECT "to_repo_id" FROM "repo_candidate" t`,
