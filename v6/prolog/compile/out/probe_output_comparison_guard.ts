...
const ddl: readonly string[] = [
  ...
  `CREATE TEMP TABLE "__new___host_demand_score" ("identity_digest" TEXT NOT NULL, "witness_digest" TEXT NOT NULL, "path" TEXT NOT NULL, "__refcount" INTEGER NOT NULL)`,
  ...
  `CREATE TEMP TABLE "__new_accepted" ("path" TEXT NOT NULL, "score" INTEGER NOT NULL, "__refcount" INTEGER NOT NULL)`,
