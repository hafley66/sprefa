...
const relCatalog: readonly IRelCatalogRow[] = [
  ...
  { relId: 6, parentId: 0, ordinal: 0, localName: "stale_keyed_retraction_keeps_replacement", kind: "module", typeId: 0, arity: 0, moduleId: 6, hId: "d5065f49636b137d", hSchema: "", hRule: "" },
  { relId: 7, parentId: 6, ordinal: 0, localName: "current_value", kind: "rel", typeId: 0, arity: 2, moduleId: 6, hId: "d74c50bb63d8f3e0", hSchema: "4c81a386b815cc34", hRule: "" },
  { relId: 8, parentId: 7, ordinal: 1, localName: "col1", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "2287835ef982fb9a", hSchema: "", hRule: "" },
  { relId: 9, parentId: 7, ordinal: 2, localName: "col2", kind: "column", typeId: 1, arity: 0, moduleId: 6, hId: "7562ab42a31e5168", hSchema: "", hRule: "" },
];
...
function readSnapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    current_value: selectRows(seam, `SELECT CASE WHEN json_valid("col1") AND json_type("col1") = 'object' AND json_type("col1", '$.fn') = 'text' AND json_type("col1", '$.args') = 'array' THEN json_extract("col1", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("col1", '$.args')), '') || ')' ELSE "col1" END AS "col1", CASE WHEN json_valid("col2") AND json_type("col2") = 'object' AND json_type("col2", '$.fn') = 'text' AND json_type("col2", '$.args') = 'array' THEN json_extract("col2", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("col2", '$.args')), '') || ')' ELSE "col2" END AS "col2" FROM "current_value"`, relColumns.current_value!, relColumnTypes.current_value!),
  });
}
