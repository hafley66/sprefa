...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    audit_trail: select_rows(seam, `SELECT "value" FROM "audit_trail" t`, rel_columns.audit_trail!, rel_column_types.audit_trail!),
    audited: select_rows(seam, `SELECT "value" FROM "audited" t`, rel_columns.audited!, rel_column_types.audited!),
    reading: select_rows(seam, `SELECT CASE WHEN json_valid("sensor") AND json_type("sensor") = 'object' AND json_type("sensor", '$.fn') = 'text' AND json_type("sensor", '$.args') = 'array' THEN json_extract("sensor", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("sensor", '$.args')), '') || ')' ELSE "sensor" END AS "sensor", "value" FROM "__txt_reading" t`, rel_columns.reading!, rel_column_types.reading!),
    watched: select_rows(seam, `SELECT CASE WHEN json_valid("sensor") AND json_type("sensor") = 'object' AND json_type("sensor", '$.fn') = 'text' AND json_type("sensor", '$.args') = 'array' THEN json_extract("sensor", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("sensor", '$.args')), '') || ')' ELSE "sensor" END AS "sensor" FROM "__txt_watched" t`, rel_columns.watched!, rel_column_types.watched!),
  });
}
...
const final_select: Record<string, string> = {
  audit_trail: `SELECT "value" FROM "audit_trail" t`,
  audited: `SELECT "value" FROM "audited" t`,
  reading: `SELECT CASE WHEN json_valid("sensor") AND json_type("sensor") = 'object' AND json_type("sensor", '$.fn') = 'text' AND json_type("sensor", '$.args') = 'array' THEN json_extract("sensor", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("sensor", '$.args')), '') || ')' ELSE "sensor" END AS "sensor", "value" FROM "__txt_reading" t`,
  watched: `SELECT CASE WHEN json_valid("sensor") AND json_type("sensor") = 'object' AND json_type("sensor", '$.fn') = 'text' AND json_type("sensor", '$.args') = 'array' THEN json_extract("sensor", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("sensor", '$.args')), '') || ')' ELSE "sensor" END AS "sensor" FROM "__txt_watched" t`,
};
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  ...
  { rel: "watched", kind: "set", table_name: "watched", delta_table_name: "__delta_watched", frontier_table_name: "__frontier_watched", next_frontier_table_name: "__next_frontier_watched", columns: ["sensor"], column_types: ["text"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT CASE WHEN json_valid("sensor") AND json_type("sensor") = 'object' AND json_type("sensor", '$.fn') = 'text' AND json_type("sensor", '$.args') = 'array' THEN json_extract("sensor", '$.fn') || '(' || coalesce((SELECT group_concat(value, ',') FROM json_each("sensor", '$.args')), '') || ')' ELSE "sensor" END AS "sensor", "_sign" AS "__sign", count(*) AS "__count" FROM "__txt___delta_watched" t WHERE "_sign" IN (-1, 1) GROUP BY "sensor", "_sign"`, rule_observers: [] },
];
