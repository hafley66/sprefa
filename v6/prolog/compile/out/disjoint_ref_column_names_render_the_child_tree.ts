...
function read_snapshot(seam: ISqlSeam): Observable<Snapshot> {
  return forkJoin({
    carrier: select_rows(seam, `SELECT "id", (SELECT d."__rendered" FROM "__ref_shell_pair" d WHERE d."__id" = t."nested") AS "nested" FROM "carrier" t`, rel_columns.carrier!, rel_column_types.carrier!),
    leaf_pair: select_rows(seam, `SELECT "left", "right" FROM "leaf_pair" t`, rel_columns.leaf_pair!, rel_column_types.leaf_pair!),
    seen: select_rows(seam, `SELECT "id" FROM "seen" t`, rel_columns.seen!, rel_column_types.seen!),
...
const final_select: Record<string, string> = {
  carrier: `SELECT "id", (SELECT d."__rendered" FROM "__ref_shell_pair" d WHERE d."__id" = t."nested") AS "nested" FROM "carrier" t`,
  leaf_pair: `SELECT "left", "right" FROM "leaf_pair" t`,
  seen: `SELECT "id" FROM "seen" t`,
...
const INCREMENTAL_RELATIONS: readonly IIncrementalRelationPlan[] = [
  { rel: "carrier", kind: "set", table_name: "carrier", delta_table_name: "__delta_carrier", frontier_table_name: "__frontier_carrier", next_frontier_table_name: "__next_frontier_carrier", columns: ["id", "nested"], column_types: ["int", "ref"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "carrier" ("id", "nested") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "id", "nested"`, arrival_del_sql: `DELETE FROM "carrier" WHERE ("id", "nested") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?)) RETURNING "id", "nested"`, boundary_sql: `SELECT "id", (SELECT d."__rendered" FROM "__ref_shell_pair" d WHERE d."__id" = t."nested") AS "nested", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_carrier" t WHERE "_sign" IN (-1, 1) GROUP BY "id", "nested", "_sign"`, rule_observers: ["seen/1"] },
  { rel: "leaf_pair", kind: "set", table_name: "leaf_pair", delta_table_name: "__delta_leaf_pair", frontier_table_name: "__frontier_leaf_pair", next_frontier_table_name: "__next_frontier_leaf_pair", columns: ["left", "right"], column_types: ["int", "int"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "leaf_pair" ("left", "right") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "left", "right"`, arrival_del_sql: `DELETE FROM "leaf_pair" WHERE ("left", "right") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?)) RETURNING "left", "right"`, boundary_sql: `SELECT "left", "right", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_leaf_pair" t WHERE "_sign" IN (-1, 1) GROUP BY "left", "right", "_sign"`, rule_observers: [] },
  { rel: "seen", kind: "set", table_name: "seen", delta_table_name: "__delta_seen", frontier_table_name: "__frontier_seen", next_frontier_table_name: "__next_frontier_seen", columns: ["id"], column_types: ["int"], key_indices: [], arrival_add_sql: null, arrival_del_sql: null, boundary_sql: `SELECT "id", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_seen" t WHERE "_sign" IN (-1, 1) GROUP BY "id", "_sign"`, rule_observers: [] },
  { rel: "shell_pair", kind: "set", table_name: "shell_pair", delta_table_name: "__delta_shell_pair", frontier_table_name: "__frontier_shell_pair", next_frontier_table_name: "__next_frontier_shell_pair", columns: ["head", "tail"], column_types: ["ref", "ref"], key_indices: [], arrival_add_sql: `INSERT OR IGNORE INTO "shell_pair" ("head", "tail") SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?) RETURNING "head", "tail"`, arrival_del_sql: `DELETE FROM "shell_pair" WHERE ("head", "tail") IN (SELECT json_extract(value, '$[0]'), json_extract(value, '$[1]') FROM json_each(?)) RETURNING "head", "tail"`, boundary_sql: `SELECT (SELECT d."__rendered" FROM "__ref_leaf_pair" d WHERE d."__id" = t."head") AS "head", (SELECT d."__rendered" FROM "__ref_leaf_pair" d WHERE d."__id" = t."tail") AS "tail", "_sign" AS "__sign", count(*) AS "__count" FROM "__delta_shell_pair" t WHERE "_sign" IN (-1, 1) GROUP BY "head", "tail", "_sign"`, rule_observers: [] },
];
