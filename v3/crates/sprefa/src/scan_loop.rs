...
//! (`scan_check`) flips them to `Verified` or `Missing` against the
...
use crate::diagnostic::{Diagnostic, ScanPointerDepthExhausted};
use crate::config::Config;
use crate::result_store::ResultStore;
use crate::scan_check::check_scan_pointers;
use crate::types::{ParseSeg, ParseSite};
use std::path::Path;
...
mod tests {
    ...
    use crate::result_store::CaptureMap;
