...
use super::locator::CheckoutLocator;
use super::worktree_provisioner::WorktreeProvisioner;
...
mod tests {
    ...
    use crate::pattern::CompiledPattern;
    use crate::config::Config;
    use super::super::locator::InMemoryLocator;
    use super::super::path_index::SqlxPathIndex;
