...
use super::run::{run_pipeline, RunRequest};
...
fn build_router(state: Arc<ServerState>) -> Router {
    Router::new()
        ...
        .route("/lsp",      get(super::transport_lsp::lsp_ws_handler))
...
impl crate::diagnostic::Renderer for CollectRenderer {
    fn header(&mut self, _code: &str, _sev: crate::types::Severity, msg: &str) {
        self.header = msg.to_string();
    }
    fn primary(&mut self, _site: &crate::types::ParseSite) {}
    fn related(&mut self, _site: &crate::types::ParseSite, msg: &str) {
