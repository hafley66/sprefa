...
pub mod sh;
pub mod str_op;
/// Alias shim — re-exports from `fact`. Kept for the alias period.
pub mod tag;
pub mod void;
...
pub use fact::{FactArg, FactOp, FactPredicateOp};
...
pub use sh::{ShOp, ShSeg};
pub use str_op::{StrOp, StrValue};
/// Alias re-exports: TagOp/TagPredicateOp/TagArg → Fact* during alias period.
