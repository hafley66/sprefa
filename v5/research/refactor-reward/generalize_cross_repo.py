#!/usr/bin/env python3
"""refactor-reward v5 (broad verbs, cross-repo) — cross-type method dup (text-approx of scip_callee_type).
...
HARD_DOWN = re.compile(r"\b(simplif|cleanup|clean up|dedup|deduplic|consolidat|collapse|merge|unif|coalesc|prune|trim|streamlin)\b", re.I)
