...
Source ops (extract facts from files), body constructs (derived rules), and sinks. The `kind` column groups them. Generated from the engine's `op_catalog` by examples/gen-reference.dl. Do not hand-edit.

| op | kind | syntax | semantics |
|---|---|---|---|
