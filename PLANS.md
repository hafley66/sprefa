...
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:443 — Approve generated-Markdown provenance and synchronization policy: source link shape, content identity, generated-file ownership, drift behavior, and whether any reverse synchronization is permitted.
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:474 — Decide the user-authored DL7 vocabulary for choosing structural, nominal, or declared-plus-witness conformance before adding a checker rule.
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:513 — Approve the artifact and mutation data model before connecting shell, filesystem, Git, or network writes.
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:539 — Define the bootstrap equivalence projection and the stage-zero removal criteria before generated declarations become authoritative.
...
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:413 — Implement and measure the approved source/content/span/located-occurrence fact boundary through Soopy, Extract, and DL7 using one representative golden.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:553 — Language kernel section: prove one compiler observation through existing calls, values, and relations, then present any concrete representation failure before proposing a kernel change.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:571 — Compiler-time section: implement the grounded-operation loop, stable operation identity, one-dispatch-per-generation, observation injection, convergence, diagnostics, tracing, and measured transport selection.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:605 — Source-intelligence section: host both code-query engines, project semantic Markdown facts, approve and emit common occurrence/match/capture facts, join syntax captures to semantic identities, derive live task rows, render provenance-carrying Markdown, stage fixes, and batch source parsing.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:624 — Common-type-graph section: approve conformance policy vocabulary, add nominal reachability and witness validation, then add Go and selected Kotlin semantic adapters with cross-language projection receipts.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:638 — Relational-program section: define target-neutral layout and representation rows, emit the first DBSP-style plan, feed SQL and Rust emitters, and prove equal checked programs for authored and generated declarations.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:655 — Output-time section: approve intention data, validate and order mutations, connect Soopy staging, add bounded shell and HTTP adapters, and record applied-output identity.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:669 — Bootstrap section: approve the equivalence projection, generate and compile DL7 declarations from Rust implementation types, compare them with stage zero, and decide the authoritative bootstrap source.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:684 — Delivery and verification section: land boundary-sized slices with deterministic receipts, focused tests, full V7 gates, dispatch and parse counts, fixpoint metrics, wall time, and peak memory.
...
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:413 `feature` — Implement and measure the approved source/content/span/located-occurrence fact boundary through Soopy, Extract, and DL7 using one representative golden.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:443 `decision` — Approve generated-Markdown provenance and synchronization policy: source link shape, content identity, generated-file ownership, drift behavior, and whether any reverse synchronization is permitted.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:474 `decision` — Decide the user-authored DL7 vocabulary for choosing structural, nominal, or declared-plus-witness conformance before adding a checker rule.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:513 `decision` — Approve the artifact and mutation data model before connecting shell, filesystem, Git, or network writes.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:539 `decision` — Define the bootstrap equivalence projection and the stage-zero removal criteria before generated declarations become authoritative.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:553 `feature` — Language kernel section: prove one compiler observation through existing calls, values, and relations, then present any concrete representation failure before proposing a kernel change.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:571 `feature` — Compiler-time section: implement the grounded-operation loop, stable operation identity, one-dispatch-per-generation, observation injection, convergence, diagnostics, tracing, and measured transport selection.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:605 `feature` — Source-intelligence section: host both code-query engines, project semantic Markdown facts, approve and emit common occurrence/match/capture facts, join syntax captures to semantic identities, derive live task rows, render provenance-carrying Markdown, stage fixes, and batch source parsing.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:624 `feature` — Common-type-graph section: approve conformance policy vocabulary, add nominal reachability and witness validation, then add Go and selected Kotlin semantic adapters with cross-language projection receipts.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:638 `feature` — Relational-program section: define target-neutral layout and representation rows, emit the first DBSP-style plan, feed SQL and Rust emitters, and prove equal checked programs for authored and generated declarations.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:655 `feature` — Output-time section: approve intention data, validate and order mutations, connect Soopy staging, add bounded shell and HTTP adapters, and record applied-output identity.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:669 `feature` — Bootstrap section: approve the equivalence projection, generate and compile DL7 declarations from Rust implementation types, compare them with stage zero, and decide the authoritative bootstrap source.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:684 `feature` — Delivery and verification section: land boundary-sized slices with deterministic receipts, focused tests, full V7 gates, dispatch and parse counts, fixpoint metrics, wall time, and peak memory.
