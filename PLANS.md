...
- `refactor` plans/2026-09-01-dl7-application-edge-kernel.md:114 — Represent generated rule heads and body goals as application nodes and remove head_arg and body_arg from the assembler protocol.
- `refactor` plans/2026-09-01-dl7-application-edge-kernel.md:115 — Replace structural application(Constructor, Arguments) identities with opaque interned node identities plus Apply and argument edges.
...
- plans/2026-09-01-dl7-application-edge-kernel.md:114 `refactor` — Represent generated rule heads and body goals as application nodes and remove head_arg and body_arg from the assembler protocol.
- plans/2026-09-01-dl7-application-edge-kernel.md:115 `refactor` — Replace structural application(Constructor, Arguments) identities with opaque interned node identities plus Apply and argument edges.
