...
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:493 — Approve generated-Markdown provenance and synchronization policy: source link shape, content identity, generated-file ownership, drift behavior, and whether any reverse synchronization is permitted.
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:524 — Decide the user-authored DL7 vocabulary for choosing structural, nominal, or declared-plus-witness conformance before adding a checker rule.
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:563 — Approve the artifact and mutation data model before connecting shell, filesystem, Git, or network writes.
- `decision` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:589 — Define the bootstrap equivalence projection and the stage-zero removal criteria before generated declarations become authoritative.
...
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:463 — Complete the source/content/span/located-occurrence vertical by feeding loaded observations through the compiler loop, joining syntax and semantic rows, and refreshing one owned DL7 marker region from an extracted Rust type graph through Soopy.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:603 — Language kernel section: prove one compiler observation through existing calls, values, and relations, then present any concrete representation failure before proposing a kernel change.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:621 — Compiler-time section: implement the grounded-operation loop, stable operation identity, one-dispatch-per-generation, observation injection, convergence, diagnostics, tracing, and measured transport selection.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:662 — Source-intelligence section: connect loaded source facts to the compiler observation loop, project semantic Markdown facts, join syntax captures to semantic identities, derive live task rows, render provenance-carrying Markdown, stage fixes, and batch source parsing.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:681 — Common-type-graph section: approve conformance policy vocabulary, add nominal reachability and witness validation, then add Go and selected Kotlin semantic adapters with cross-language projection receipts.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:695 — Relational-program section: define target-neutral layout and representation rows, emit the first DBSP-style plan, feed SQL and Rust emitters, and prove equal checked programs for authored and generated declarations.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:714 — Output-time section: approve intention data, validate and order mutations, connect Soopy staging, add bounded shell and HTTP adapters, and record applied-output identity.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:728 — Bootstrap section: approve the equivalence projection, generate and compile DL7 declarations from Rust implementation types, compare them with stage zero, and decide the authoritative bootstrap source.
- `feature` plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:743 — Delivery and verification section: land boundary-sized slices with deterministic receipts, focused tests, full V7 gates, dispatch and parse counts, fixpoint metrics, wall time, and peak memory.
...
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:463 `feature` — Complete the source/content/span/located-occurrence vertical by feeding loaded observations through the compiler loop, joining syntax and semantic rows, and refreshing one owned DL7 marker region from an extracted Rust type graph through Soopy.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:493 `decision` — Approve generated-Markdown provenance and synchronization policy: source link shape, content identity, generated-file ownership, drift behavior, and whether any reverse synchronization is permitted.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:524 `decision` — Decide the user-authored DL7 vocabulary for choosing structural, nominal, or declared-plus-witness conformance before adding a checker rule.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:563 `decision` — Approve the artifact and mutation data model before connecting shell, filesystem, Git, or network writes.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:589 `decision` — Define the bootstrap equivalence projection and the stage-zero removal criteria before generated declarations become authoritative.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:603 `feature` — Language kernel section: prove one compiler observation through existing calls, values, and relations, then present any concrete representation failure before proposing a kernel change.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:621 `feature` — Compiler-time section: implement the grounded-operation loop, stable operation identity, one-dispatch-per-generation, observation injection, convergence, diagnostics, tracing, and measured transport selection.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:662 `feature` — Source-intelligence section: connect loaded source facts to the compiler observation loop, project semantic Markdown facts, join syntax captures to semantic identities, derive live task rows, render provenance-carrying Markdown, stage fixes, and batch source parsing.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:681 `feature` — Common-type-graph section: approve conformance policy vocabulary, add nominal reachability and witness validation, then add Go and selected Kotlin semantic adapters with cross-language projection receipts.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:695 `feature` — Relational-program section: define target-neutral layout and representation rows, emit the first DBSP-style plan, feed SQL and Rust emitters, and prove equal checked programs for authored and generated declarations.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:714 `feature` — Output-time section: approve intention data, validate and order mutations, connect Soopy staging, add bounded shell and HTTP adapters, and record applied-output identity.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:728 `feature` — Bootstrap section: approve the equivalence projection, generate and compile DL7 declarations from Rust implementation types, compare them with stage zero, and decide the authoritative bootstrap source.
- plans/2026-09-02-dl7-programmable-source-intelligence-vision.md:743 `feature` — Delivery and verification section: land boundary-sized slices with deterministic receipts, focused tests, full V7 gates, dispatch and parse counts, fixpoint metrics, wall time, and peak memory.
