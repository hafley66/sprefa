...
- `feature` plans/2026-09-01-dl7-application-edge-kernel.md:81 — Box compiler variables and primitive literals as value nodes so generated argument carriers no longer store a separate kind string.
...
- `refactor` plans/2026-09-01-dl7-application-edge-kernel.md:80 — Derive Curry specialization and bound-slot views from application nodes and edges, then remove lowerer-authored curry_specialization and curry_bound rows.
- `refactor` plans/2026-09-01-dl7-application-edge-kernel.md:82 — Represent generated rule heads and body goals as application nodes and remove head_arg and body_arg from the assembler protocol.
- `refactor` plans/2026-09-01-dl7-application-edge-kernel.md:83 — Replace structural application(Constructor, Arguments) identities with opaque interned node identities plus Apply and argument edges.
...
- plans/2026-09-01-dl7-application-edge-kernel.md:80 `refactor` — Derive Curry specialization and bound-slot views from application nodes and edges, then remove lowerer-authored curry_specialization and curry_bound rows.
- plans/2026-09-01-dl7-application-edge-kernel.md:81 `feature` — Box compiler variables and primitive literals as value nodes so generated argument carriers no longer store a separate kind string.
- plans/2026-09-01-dl7-application-edge-kernel.md:82 `refactor` — Represent generated rule heads and body goals as application nodes and remove head_arg and body_arg from the assembler protocol.
- plans/2026-09-01-dl7-application-edge-kernel.md:83 `refactor` — Replace structural application(Constructor, Arguments) identities with opaque interned node identities plus Apply and argument edges.
