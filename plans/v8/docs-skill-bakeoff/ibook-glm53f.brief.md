# Lane brief: rewrite v8/book/src/10_effects.md under the "ibook" documentation skill, model glm53f
...
Read `/Users/chrishafley/projects/sprefa/plans/v8/docs-skill-bakeoff/README.md` (absolute path; it is not on your branch). You are one cell of that grid: skill `ibook`, model `glm53f`.
...
```
/Users/chrishafley/projects/claude-research/skills_archive/vendor-ibook-skills/skills/chapter-content-generator/SKILL.md
```

Only this one skill of the fourteen. It targets mkdocs; the book is mdbook. Write plain markdown plus mermaid; skip MicroSims, admonition syntax mkdocs-only, and any mkdocs.yml edits, and record each skip in NOTES.md.
...
Output file: `v8/book/src/lab/docs-skill-bakeoff/ibook/glm53f/10_effects.md`
...
File: `v8/book/src/lab/docs-skill-bakeoff/ibook/glm53f/NOTES.md`

Sections, in this order:

1. `# ibook x glm53f` and one line: which skill file and which model.
...
You own only `v8/book/src/lab/docs-skill-bakeoff/ibook/glm53f/`. Forbidden: `v8/book/src/10_effects.md`, `v8/book/src/SUMMARY.md`, anything under `v8/src`, `v8/fixtures`, `plans/`. Never spawn subagents.
...
```
lab(docs-skill): ibook x glm53f rewrite of 10_effects
```
...
```bash
boop beep --no-wait --as lab-docs-skill-ibook-glm53f sprefa-coordinator "done: ibook x glm53f, commit $(git rev-parse --short HEAD), output lines $(wc -l < v8/book/src/lab/docs-skill-bakeoff/ibook/glm53f/10_effects.md)"
```
