# Lane brief: rewrite v8/book/src/10_effects.md under the "xamfonos" documentation skill, model f41
...
Read `/Users/chrishafley/projects/sprefa/plans/v8/docs-skill-bakeoff/README.md` (absolute path; it is not on your branch). You are one cell of that grid: skill `xamfonos`, model `f41`.
...
Output file: `v8/book/src/lab/docs-skill-bakeoff/xamfonos/f41/10_effects.md`
...
File: `v8/book/src/lab/docs-skill-bakeoff/xamfonos/f41/NOTES.md`

Sections, in this order:

1. `# xamfonos x f41` and one line: which skill file and which model.
...
You own only `v8/book/src/lab/docs-skill-bakeoff/xamfonos/f41/`. Forbidden: `v8/book/src/10_effects.md`, `v8/book/src/SUMMARY.md`, anything under `v8/src`, `v8/fixtures`, `plans/`. Never spawn subagents.
...
```
lab(docs-skill): xamfonos x f41 rewrite of 10_effects
```
...
```bash
boop beep --no-wait --as lab-docs-skill-xamfonos-f41 sprefa-coordinator "done: xamfonos x f41, commit $(git rev-parse --short HEAD), output lines $(wc -l < v8/book/src/lab/docs-skill-bakeoff/xamfonos/f41/10_effects.md)"
```
