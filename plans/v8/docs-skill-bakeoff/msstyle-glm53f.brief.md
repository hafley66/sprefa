# Lane brief: rewrite v8/book/src/10_effects.md under the "msstyle" documentation skill, model glm53f
...
Read `/Users/chrishafley/projects/sprefa/plans/v8/docs-skill-bakeoff/README.md` (absolute path; it is not on your branch). You are one cell of that grid: skill `msstyle`, model `glm53f`.
...
Output file: `v8/book/src/lab/docs-skill-bakeoff/msstyle/glm53f/10_effects.md`
...
File: `v8/book/src/lab/docs-skill-bakeoff/msstyle/glm53f/NOTES.md`

Sections, in this order:

1. `# msstyle x glm53f` and one line: which skill file and which model.
...
You own only `v8/book/src/lab/docs-skill-bakeoff/msstyle/glm53f/`. Forbidden: `v8/book/src/10_effects.md`, `v8/book/src/SUMMARY.md`, anything under `v8/src`, `v8/fixtures`, `plans/`. Never spawn subagents.
...
```
lab(docs-skill): msstyle x glm53f rewrite of 10_effects
```
...
```bash
boop beep --no-wait --as lab-docs-skill-msstyle-glm53f sprefa-coordinator "done: msstyle x glm53f, commit $(git rev-parse --short HEAD), output lines $(wc -l < v8/book/src/lab/docs-skill-bakeoff/msstyle/glm53f/10_effects.md)"
```
