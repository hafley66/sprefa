...
| comptime | none | rounds, `Sources::refreeze` is the callback seam | `fx(Round)`; 32 rounds on `5_curry` |
...
| thing | v7 source | who |
|---|---|---|
| live `Sources` behind the rounds; `Replay` ships tonight | `2_compiler.pl:929-1000` | driver lane |
| `emit_compiled(prolog(Callable))` arm | `1_artifact_emitter.pl:49-59` | host-Prolog callable, no Rust shape, exit 3 |
| the driver: `lib.rs compile()`, `dl8 compile f.dl7` | `2_compiler.pl:75-700`, `0a_module_lowerer.pl` | opus lane running |
