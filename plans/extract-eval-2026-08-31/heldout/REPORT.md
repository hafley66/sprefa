...
| rust.call.checker.scip | 90.06% / 67.64% | 86.79% / 49.89% | -3.27 pt / -17.75 pt | 3 |
...
| measure id | repo | class | files | recall | precision | oracle calls / refs | tuning recall | gap pt | reference-graph recall | tier decline |
|---|---|---|---|---|---|---|---|---|---|---|
| rust.call.checker.scip | rust-analyzer | tuning | 873 | 90.06% | 67.64% | 52081 / 149045 | 90.06% | - | 33.13% | tier.rust-analyzer: the rust checker tier needs --features rust-checker; falling back to the syntax leg |
| rust.call.checker.scip | BigPizzaV3/CodexPlusPlus | heldout | 121 | 86.79% | 71.30% | 6920 / 18647 | 90.06% | -3.27 | 36.54% | tier.rust-analyzer: the rust checker tier needs --features rust-checker; falling back to the syntax leg |
| rust.call.checker.scip | rust-lang/rust-clippy | heldout | 2345 | 91.64% | 45.03% | 7680 / 18579 | 90.06% | +1.58 | 41.24% | tier.rust-analyzer: the rust checker tier needs --features rust-checker; falling back to the syntax leg |
| rust.call.checker.scip | web-infra-dev/rspack | heldout | 1367 | 63.29% | 49.89% | 25604 / 94058 | 90.06% | -26.77 | 25.89% | tier.rust-analyzer: the rust checker tier needs --features rust-checker; falling back to the syntax leg |
